...
#define PK11_SETATTRS(_attr, _idx, _type, _val, _len) do { CK_ATTRIBUTE *ptr = (_attr) + ((_idx)++); ptr->type = (_type); ptr->pValue = (_val); ptr->ulValueLen = (_len); } while(0)
...
#if defined(TLS_RSA_WITH_NULL_SHA256)
...
#endif
#if defined(TLS_RSA_WITH_AES_128_GCM_SHA256)
...
#endif
#if defined(TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384)
...
#endif
#if defined(TLS_DHE_RSA_WITH_CHACHA20_POLY1305_SHA256)
...
#endif
#if defined(TLS_AES_256_GCM_SHA384)
...
#if defined(SSL_LIBRARY_VERSION_TLS_1_1)
case SSL_LIBRARY_VERSION_TLS_1_1:
return strdup("TLSv1.1");
#endif
#if defined(SSL_LIBRARY_VERSION_TLS_1_2)
case SSL_LIBRARY_VERSION_TLS_1_2:
return strdup("TLSv1.2");
#endif
#if defined(SSL_LIBRARY_VERSION_TLS_1_3)
...
obj =
#if defined(HAVE_PK11_CREATEMANAGEDGENERICOBJECT)
...
static ssize_t nss_send(struct connectdata *conn, 
int sockindex, 
const void *mem, 
size_t len, 
CURLcode *curlcode)
...
static CURLcode Curl_nss_md5sum(unsigned char *tmp, 
size_t tmplen,
...
static CURLcode Curl_nss_sha256sum(const unsigned char *tmp, 
size_t tmplen,
...
Curl_nss_connect, 
Curl_nss_connect_nonblocking, 
Curl_nss_get_internals, 
Curl_nss_close, 
Curl_none_close_all, 
