...
#if !defined(USE_GNUTLS_PRIORITY_SET_DIRECT)
static CURLcode
...
static CURLcode Curl_gtls_md5sum(unsigned char *tmp, 
size_t tmplen,
...
static CURLcode Curl_gtls_sha256sum(const unsigned char *tmp, 
size_t tmplen,
...
Curl_none_check_cxn, 
Curl_gtls_shutdown, 
Curl_gtls_data_pending, 
Curl_gtls_random, 
Curl_gtls_cert_status_request, 
Curl_gtls_connect, 
Curl_gtls_connect_nonblocking, 
Curl_gtls_get_internals, 
Curl_gtls_close, 
Curl_none_close_all, 
Curl_gtls_session_free, 
