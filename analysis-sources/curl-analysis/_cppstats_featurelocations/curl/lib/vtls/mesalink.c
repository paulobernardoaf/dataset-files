...
if(ciphers) {
#if defined(MESALINK_HAVE_CIPHER)
...
#if defined(MESALINK_HAVE_SESSION)
...
conn, our_ssl_sessionid, 0 , sockindex);
if(result) {
Curl_ssl_sessionid_unlock(conn);
...
{ CURLSSLBACKEND_MESALINK, "MesaLink" }, 
...
Curl_mesalink_init, 
Curl_none_cleanup, 
Curl_mesalink_version, 
Curl_none_check_cxn, 
Curl_mesalink_shutdown, 
Curl_none_data_pending, 
Curl_none_random, 
Curl_none_cert_status_request, 
Curl_mesalink_connect, 
Curl_mesalink_connect_nonblocking, 
Curl_mesalink_get_internals, 
Curl_mesalink_close, 
Curl_none_close_all, 
