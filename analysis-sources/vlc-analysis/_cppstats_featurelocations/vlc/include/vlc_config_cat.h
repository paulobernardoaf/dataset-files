...
#define SUBPIC_HELP N_( "Settings related to On-Screen-Display,"" subtitles and \"overlay subpictures\"")
...
#define INPUT_HELP N_( "Settings for input, demultiplexing, " "decoding and encoding")


#define ACCESS_TITLE N_( "Access modules" )
#define ACCESS_HELP N_( "Settings related to the various access methods. " "Common settings you may want to alter are HTTP proxy or " "caching settings." )




#define STREAM_FILTER_TITLE N_( "Stream filters" )
#define STREAM_FILTER_HELP N_( "Stream filters are special modules that allow advanced operations on " "the input side of VLC. Use with care..." )
...
#define SOUT_HELP N_( "Stream output settings are used when acting as a streaming server " "or when saving incoming streams.\n" "Streams are first muxed and then sent through an \"access output\" ""module that can either save the stream to a file, or stream " "it (UDP, HTTP, RTP/RTSP).\n" "Sout streams modules allow advanced stream processing (transcoding, ""duplicating...).")
...
#define SOUT_MUX_HELP N_( "Muxers create the encapsulation formats that are used to " "put all the elementary streams (video, audio, ...) " "together. This setting allows you to always force a specific muxer. " "You should probably not do that.\n" "You can also set default parameters for each muxer." )
...
#define SOUT_ACO_HELP N_( "Access output modules control the ways the muxed streams are sent. " "This setting allows you to always force a specific access output method. " "You should probably not do that.\n" "You can also set default parameters for each access output.")
...
#define SOUT_PACKET_HELP N_( "Packetizers are used to \"preprocess\" the elementary ""streams before muxing. " "This setting allows you to always force a packetizer. " "You should probably not do that.\n" "You can also set default parameters for each packetizer." )
...
#define SOUT_STREAM_HELP N_( "Sout stream modules allow to build a sout " "processing chain. Please refer to the Streaming Howto for " "more information. You can configure default options for " "each sout stream module here.")
