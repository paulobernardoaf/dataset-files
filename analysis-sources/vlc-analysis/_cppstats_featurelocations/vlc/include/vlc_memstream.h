...
#define vlc_memstream_puts(ms,s) (__builtin_constant_p(__builtin_strlen(s)) ? vlc_memstream_puts_len(ms,s,__builtin_strlen(s)) : vlc_memstream_puts(ms,s))
