...
#define I_OP_OPDIR I_DIR_OR_FOLDER( N_("Open D&irectory..."), N_("Open &Folder...") )
...
#define I_POP_NEWFOLDER I_DIR_OR_FOLDER( N_("Create Directory..."), N_("Create Folder...") )

#define I_POP_RENAMEFOLDER I_DIR_OR_FOLDER( N_("Rename Directory..."), N_("Rename Folder...") )

#define I_POP_EXPLORE I_DIR_OR_FOLDER( N_("Show Containing Directory..."), N_("Show Containing Folder...") )
...
#define I_PL_ADDDIR I_DIR_OR_FOLDER( N_("Add Directory..."), N_("Add Folder...") )
