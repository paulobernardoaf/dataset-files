...
#define DEF_STARTER(name, worker) static int Start ##name( void* fetcher_, void* req_, void** out ) { input_fetcher_t* fetcher = fetcher_; return StartWorker( fetcher, name, worker, req_, out ); }
