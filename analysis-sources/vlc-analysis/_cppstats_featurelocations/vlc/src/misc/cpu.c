...
#if defined (__i386__) || defined (__x86_64__) || defined (__powerpc__) || defined (__ppc__) || defined (__ppc64__) || defined (__powerpc64__)
...
#define cpuid(reg) asm volatile ("xchgl %%ebx,%1\n\t" "cpuid\n\t" "xchgl %%ebx,%1\n\t" : "=a" (i_eax), "=r" (i_ebx), "=c" (i_ecx), "=d" (i_edx) : "a" (reg) : "cc");
...
#else
#define cpuid(reg) asm volatile ("cpuid\n\t" : "=a" (i_eax), "=b" (i_ebx), "=c" (i_ecx), "=d" (i_edx) : "a" (reg) : "cc");
...
#if defined (__i386__) && !defined (__i486__) && !defined (__i586__) && !defined (__i686__) && !defined (__pentium4__) && !defined (__k6__) && !defined (__athlon__) && !defined (__k8__)
...
#if defined (__i386__) && !defined (__i586__) && !defined (__i686__) && !defined (__pentium4__) && !defined (__k6__) && !defined (__athlon__) && !defined (__k8__)
