...
#define dialog_FatalWait( p_obj, psz_title, psz_fmt, ... ) vlc_dialog_wait_question( p_obj, VLC_DIALOG_QUESTION_CRITICAL, "OK", NULL, NULL, psz_title, psz_fmt, ##__VA_ARGS__ );
