...
#define ACCOUNT_LONGTEXT N_("Account that will be " "used for the connection.")


#define LOGIN_DIALOG_TITLE _("FTP authentication")
#define LOGIN_DIALOG_TEXT _("Please enter a valid login and password for " "the ftp connexion to %s")
