...
#define AUTO_GUID_LONGTEXT N_("If uid/gid are not specified in " "the url, VLC will automatically set a uid/gid.")
...
#define NFS_CHECK_STATUS(p_access, i_status, p_data) nfs_check_status(p_access, i_status, (const char *)p_data, __func__)
