...
#if !defined(VLC_GST_PICTURE_PLANE_ALLOCATOR_H_)
...
#define GST_TYPE_VLC_PICTURE_PLANE_ALLOCATOR (gst_vlc_picture_plane_allocator_get_type())

#define GST_IS_VLC_PICTURE_PLANE_ALLOCATOR(obj) (G_TYPE_CHECK_INSTANCE_TYPE ((obj), GST_TYPE_VLC_PICTURE_PLANE_ALLOCATOR))

#define GST_VLC_PICTURE_PLANE_ALLOCATOR(obj) (G_TYPE_CHECK_INSTANCE_CAST ((obj), GST_TYPE_VLC_PICTURE_PLANE_ALLOCATOR, GstVlcPicturePlaneAllocator))


#define GST_VLC_PICTURE_PLANE_ALLOCATOR_CAST(obj) ((GstVlcPicturePlaneAllocator*)(obj))
