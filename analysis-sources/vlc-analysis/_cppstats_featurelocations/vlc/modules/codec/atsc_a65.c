...
enum
{
ATSC_A65_MODE_UNICODE_RANGE_START = 0x00, 
...
if( i_mode <= ATSC_A65_MODE_UNICODE_RANGE_END ) 
{
if( !p_handle->iconv_u16be )
{
...
else if ( VLC_ICONV_ERR == vlc_iconv( p_handle->iconv_u16be, NULL, NULL, NULL, NULL ) ) 
{
return false;
}

char *psz16 = enlarge_to16( p_src, i_src, i_mode ); 
if( psz16 )
{
