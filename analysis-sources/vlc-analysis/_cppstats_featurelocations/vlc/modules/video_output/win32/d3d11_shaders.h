...
#if !defined(VLC_D3D11_SHADERS_H)
...
bool src_full_range,
d3d_quad_t *);
#define D3D11_CompilePixelShader(a,b,c,d,e,f,g,h,i) D3D11_CompilePixelShader(VLC_OBJECT(a),b,c,d,e,f,g,h,i)
