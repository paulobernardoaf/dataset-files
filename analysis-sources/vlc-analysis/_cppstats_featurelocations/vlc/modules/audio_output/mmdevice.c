...
#define MM_PASSTHROUGH_TEXT N_( "HDMI/SPDIF audio passthrough")

#define MM_PASSTHROUGH_LONGTEXT N_( "Change this value if you have issue with HD codecs when using a HDMI receiver.")
