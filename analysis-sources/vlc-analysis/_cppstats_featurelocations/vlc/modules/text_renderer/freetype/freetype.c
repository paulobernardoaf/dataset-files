...
#define OPACITY_LONGTEXT N_("The opacity (inverse of transparency) of the " "text that will be rendered on the video. 0 = transparent, " "255 = totally opaque." )


#define COLOR_TEXT N_("Text default color")
#define COLOR_LONGTEXT N_("The color of the text that will be rendered on ""the video. This must be an hexadecimal (like HTML colors). The first two ""chars are for red, then green, then blue. #000000 = black, #FF0000 = red,"" #00FF00 = green, #FFFF00 = yellow (red + green), #FFFFFF = white" )
...
#define YUVP_LONGTEXT N_("This renders the font using \"paletized YUV\". " "This option is only needed if you want to encode into DVB subtitles" )
...
#if defined(HAVE_GET_FONT_BY_FAMILY_NAME)
...
(p_textbbox->xMin - p_paddedbbox->xMin);
}
...
if( i_seg_end == p_line->i_last_visible_char_index ) 
