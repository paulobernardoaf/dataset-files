...
#define DST_PREFIX_LONGTEXT N_( "Prefix of the destination file automatically generated" )
...
p_sys->i_max_size = 1*1024*1024; 
#else
p_sys->i_max_wait = VLC_TICK_FROM_SEC(30);
p_sys->i_max_size = 20*1024*1024; 
#endif
p_sys->b_drop = false;
p_sys->i_dts_start = 0;
...
M( "ps", "mpg", 16, VLC_CODEC_MPGV, VLC_CODEC_MP2V, VLC_CODEC_MP1V,
