...
#define LT_VIDEO_PRERENDER_CALLBACK N_( "Address of the video prerender callback function. " "This function will set the buffer where render will be done." )


#define T_AUDIO_PRERENDER_CALLBACK N_( "Audio prerender callback" )
#define LT_AUDIO_PRERENDER_CALLBACK N_( "Address of the audio prerender callback function. " "This function will set the buffer where render will be done." )


#define T_VIDEO_POSTRENDER_CALLBACK N_( "Video postrender callback" )
#define LT_VIDEO_POSTRENDER_CALLBACK N_( "Address of the video postrender callback function. " "This function will be called when the render is into the buffer." )


#define T_AUDIO_POSTRENDER_CALLBACK N_( "Audio postrender callback" )
#define LT_AUDIO_POSTRENDER_CALLBACK N_( "Address of the audio postrender callback function. " "This function will be called when the render is into the buffer." )
...
#define LT_TIME_SYNC N_( "Time Synchronisation option for output. " "If true, stream will render as usual, else " "it will be rendered as fast as possible.")
