...
#define BANDS_LONGTEXT N_( "Don't use presets, but manually specified bands. You need to " "provide 10 values between -20dB and 20dB, separated by spaces, " "e.g. \"0 2 4 2 0 -2 -4 -2 0 2\"." )




#define VLC_BANDS_TEXT N_( "Use VLC frequency bands" )
#define VLC_BANDS_LONGTEXT N_( "Use the VLC frequency bands. Otherwise, use the ISO Standard " "frequency bands." )



#define TWOPASS_TEXT N_( "Two pass" )
#define TWOPASS_LONGTEXT N_( "Filter the audio twice. This provides a more " "intense effect.")
