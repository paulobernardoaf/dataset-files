...
#define INSTALL_LONGTEXT N_( "Install the Service and exit." )

#define UNINSTALL_TEXT N_( "Uninstall Windows Service" )
#define UNINSTALL_LONGTEXT N_( "Uninstall the Service and exit." )

#define NAME_TEXT N_( "Display name of the Service" )
#define NAME_LONGTEXT N_( "Change the display name of the Service." )

#define OPTIONS_TEXT N_("Configuration options")
#define OPTIONS_LONGTEXT N_( "Configuration options that will be " "used by the Service (eg. --foo=bar --no-foobar). It should be specified ""at install time so the Service is properly configured.")



#define EXTRAINTF_TEXT N_("Extra interface modules")
#define EXTRAINTF_LONGTEXT N_( "Additional interfaces spawned by the " "Service. It should be specified at install time so the Service is " "properly configured. Use a comma separated list of interface modules. " "(common values are: logger, sap, rc, http)")
