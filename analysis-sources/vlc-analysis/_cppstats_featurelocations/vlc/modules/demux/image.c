...
#define DECODE_LONGTEXT N_( "Decode at the demuxer stage")


#define CHROMA_TEXT N_("Forced chroma")
#define CHROMA_LONGTEXT N_( "If non empty and image-decode is true, the image will be " "converted to the specified chroma.")



#define DURATION_TEXT N_("Duration in seconds")
#define DURATION_LONGTEXT N_( "Duration in seconds before simulating an end of file. " "A negative value means an unlimited play time.")



#define FPS_TEXT N_("Frame rate")
#define FPS_LONGTEXT N_( "Frame rate of the elementary stream produced.")


#define RT_TEXT N_("Real-time")
#define RT_LONGTEXT N_( "Use real-time mode suitable for being used as a master input and " "real-time input slaves.")
