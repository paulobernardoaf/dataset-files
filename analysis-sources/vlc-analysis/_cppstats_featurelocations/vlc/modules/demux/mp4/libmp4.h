...
#define BRAND_f4v VLC_FOURCC( 'f', '4', 'v', ' ' ) 
#define BRAND_dash VLC_FOURCC( 'd', 'a', 's', 'h' )
#define BRAND_smoo VLC_FOURCC( 's', 'm', 'o', 'o' ) 
...
#define BRAND_mif1 VLC_FOURCC( 'm', 'i', 'f', '1' ) 
#define BRAND_msf1 VLC_FOURCC( 'm', 's', 'f', '1' ) 
#define BRAND_heic VLC_FOURCC( 'h', 'e', 'i', 'c' ) 
#define BRAND_heix VLC_FOURCC( 'h', 'e', 'i', 'x' ) 
#define BRAND_hevc VLC_FOURCC( 'h', 'e', 'v', 'c' ) 
#define BRAND_hevx VLC_FOURCC( 'h', 'e', 'v', 'x' ) 
#define BRAND_jpeg VLC_FOURCC( 'j', 'p', 'e', 'g' ) 
#define BRAND_jpgs VLC_FOURCC( 'j', 'p', 'g', 's' ) 
#define BRAND_avci VLC_FOURCC( 'a', 'v', 'c', 'i' ) 
#define BRAND_avcs VLC_FOURCC( 'a', 'v', 'c', 's' ) 
#define BRAND_avif VLC_FOURCC( 'a', 'v', 'i', 'f' ) 
#define BRAND_avis VLC_FOURCC( 'a', 'v', 'i', 's' ) 
...
#define ATOM_ddts VLC_FOURCC( 'd', 'd', 't', 's' ) 
...
uint32_t i_constbitsperchannel; 
...
MP4_Box_data_WMA2_t *p_WMA2; 
MP4_Box_data_strf_t *p_strf; 
MP4_Box_data_ASF_t *p_asf; 
...
MP4_Box_data_ispe_t *p_ispe; 
MP4_Box_data_ipma_t *p_ipma; 
