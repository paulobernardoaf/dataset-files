...
static void test_iterators( const uint8_t *p_ab, size_t i_ab, 
...
#define runtest(number, name, testfunction) printf("\nTEST %d %s\n", number, name);p_res[0] = test##number##_avcdata1; rgi_res[0] = sizeof(test##number##_avcdata1);p_res[1] = test##number##_avcdata2; rgi_res[1] = sizeof(test##number##_avcdata2);p_res[2] = test##number##_avcdata4; rgi_res[2] = sizeof(test##number##_avcdata4);testfunction( test##number##_annexbdata, sizeof(test##number##_annexbdata), p_res, rgi_res )
