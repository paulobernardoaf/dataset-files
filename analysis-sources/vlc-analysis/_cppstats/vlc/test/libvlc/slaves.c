...
libvlc_media_slave_t p_expected_slaves[] = {
{ NULL, libvlc_media_slave_type_audio, 3 },
{ NULL, libvlc_media_slave_type_subtitle, 2 },
{ NULL, libvlc_media_slave_type_subtitle, 1 },
{ NULL, libvlc_media_slave_type_subtitle, 0 },
};
