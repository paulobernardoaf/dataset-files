...
#define NETSYNC_LONGTEXT N_("When set, " "this VLC instance will act as the master clock for synchronization " "for clients listening")
#define MIP_TEXT N_("Master server IP address")
#define MIP_LONGTEXT N_("The IP address of " "the network master clock to use for clock synchronization.")
#define NETSYNC_TIMEOUT_TEXT N_("UDP timeout (in ms)")
#define NETSYNC_TIMEOUT_LONGTEXT N_("Length of time (in ms) " "until aborting data reception.")
vlc_module_begin()
