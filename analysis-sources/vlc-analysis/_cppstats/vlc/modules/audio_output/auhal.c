...
change_private()
add_obsolete_integer("macosx-audio-device") 
vlc_module_end ()
#pragma mark -
...
#define AO_GETPROP(id, type, p_out_nb_elms, pp_out_data, a1, a2) AoGetProperty(p_aout, (id), &(AudioObjectPropertyAddress) {(a1), (a2), 0}, sizeof(type), -1, (p_out_nb_elms), (void **)(pp_out_data), NULL)
#define AO_GET1PROP(id, type, p_out_data, a1, a2) AoGetProperty(p_aout, (id), &(AudioObjectPropertyAddress) {(a1), (a2), 0}, sizeof(type), 1, NULL, NULL, (p_out_data))
static bool
...
#define AO_ISPROPSETTABLE(id, a1, a2) AoIsPropertySettable(p_aout, (id), &(AudioObjectPropertyAddress) { (a1), (a2), 0})
#define AO_HASPROP(id, a1, a2) AudioObjectHasProperty((id), &(AudioObjectPropertyAddress) { (a1), (a2), 0})
static int
...
#define AO_SETPROP(id, i_data, p_data, a1, a2) AoSetProperty(p_aout, (id), &(AudioObjectPropertyAddress) { (a1), (a2), 0}, (i_data), (p_data));
static int
...
#define AO_UPDATELISTENER(id, add, listener, data, a1, a2) AoUpdateListener(p_aout, add, (id), &(AudioObjectPropertyAddress) { (a1), (a2), 0}, (listener), (data))
#pragma mark -
