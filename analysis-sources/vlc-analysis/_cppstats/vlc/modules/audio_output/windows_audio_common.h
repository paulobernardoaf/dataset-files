...
#if !defined(DSSPEAKER_DSSPEAKER_DIRECTOUT)
#define DSSPEAKER_DSSPEAKER_DIRECTOUT 0x00000000
#endif
#if !defined(DSSPEAKER_HEADPHONE)
#define DSSPEAKER_HEADPHONE 0x00000001
#endif
#if !defined(DSSPEAKER_MONO)
#define DSSPEAKER_MONO 0x00000002
#endif
#if !defined(DSSPEAKER_QUAD)
#define DSSPEAKER_QUAD 0x00000003
#endif
#if !defined(DSSPEAKER_STEREO)
#define DSSPEAKER_STEREO 0x00000004
#endif
#if !defined(DSSPEAKER_SURROUND)
#define DSSPEAKER_SURROUND 0x00000005
#endif
#if !defined(DSSPEAKER_5POINT1)
#define DSSPEAKER_5POINT1 0x00000006
#endif
#if !defined(DSSPEAKER_5POINT1_BACK)
#define DSSPEAKER_5POINT1_BACK DSSPEAKER_5POINT1
#endif
#if !defined(DSSPEAKER_7POINT1)
#define DSSPEAKER_7POINT1 0x00000007
#endif
#if !defined(DSSPEAKER_7POINT1_SURROUND)
#define DSSPEAKER_7POINT1_SURROUND 0x00000008
#endif
#if !defined(DSSPEAKER_5POINT1_SURROUND)
#define DSSPEAKER_5POINT1_SURROUND 0x00000009
#endif
#if !defined(DSSPEAKER_7POINT1_WIDE)
...
#define FLOAT_LONGTEXT N_( "The option allows you to enable or disable the high-quality float32 " "audio output mode (which is not well supported by some soundcards)." )
