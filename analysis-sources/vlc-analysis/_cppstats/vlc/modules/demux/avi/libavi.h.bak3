...
#define AVI_CHUNK_COMMON vlc_fourcc_t i_chunk_fourcc; uint64_t i_chunk_size; uint64_t i_chunk_pos; union avi_chunk_u *p_next; union avi_chunk_u *p_father; union avi_chunk_u *p_first;
...
#define AVI_ChunkCount( p_chk, i_fourcc, b_list ) AVI_ChunkCount_( AVI_CHUNK(p_chk), i_fourcc, b_list )

#define AVI_ChunkFind( p_chk, i_fourcc, i_number, b_list ) AVI_ChunkFind_( AVI_CHUNK(p_chk), i_fourcc, i_number, b_list )
