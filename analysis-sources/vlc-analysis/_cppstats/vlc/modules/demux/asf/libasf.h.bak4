...
#define ASF_OBJECT_COMMON int i_type; vlc_guid_t i_object_id; uint64_t i_object_size; uint64_t i_object_pos; union asf_object_u *p_father; union asf_object_u *p_first; union asf_object_u *p_last; union asf_object_u *p_next;
