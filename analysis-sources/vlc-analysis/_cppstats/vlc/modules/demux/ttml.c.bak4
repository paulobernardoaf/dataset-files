...
case UINT64_C(0xFFFE3C003F007800): 
case UINT64_C(0xFFFE3C003F007400): 
case UINT64_C(0xFEFF003C003F0078): 
case UINT64_C(0xFEFF003C003F0074): 
psz_alloc = FromCharset( "UTF-16", p_peek, i_peek );
break;
case UINT64_C(0x3C003F0078006D00): 
case UINT64_C(0x3C003F0074007400): 
psz_alloc = FromCharset( "UTF-16LE", p_peek, i_peek );
break;
case UINT64_C(0x003C003F0078006D): 
case UINT64_C(0x003C003F00740074): 
psz_alloc = FromCharset( "UTF-16BE", p_peek, i_peek );
break;
case UINT64_C(0xEFBBBF3C3F786D6C): 
case UINT64_C(0x3C3F786D6C207665): 
case UINT64_C(0xEFBBBF3C74742078): 
break;
default:
if(GetDWBE(p_peek) != UINT32_C(0x3C747420)) 
return VLC_EGENERIC;
}
...
tt_time_t t;
tt_time_Init( &t );
tt_node_ToText( &stream, (tt_basenode_t*)p_sys->p_rootnode, &t );
