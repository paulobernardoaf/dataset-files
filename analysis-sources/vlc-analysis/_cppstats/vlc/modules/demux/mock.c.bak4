...
#define LIST_OPTIONS X(length, vlc_tick_t, add_integer, var_InheritInteger, VLC_TICK_FROM_MS(5000)) X(audio_track_count, ssize_t, add_integer, var_InheritSsize, 0) X(audio_channels, unsigned, add_integer, var_InheritUnsigned, 2) X(audio_format, vlc_fourcc_t, add_string, var_InheritFourcc, "u8") X(audio_rate, unsigned, add_integer, var_InheritUnsigned, 44100) X(audio_packetized, bool, add_bool, var_InheritBool, true) X(audio_sample_length, vlc_tick_t, add_integer, var_InheritInteger, VLC_TICK_FROM_MS(40) ) X(video_track_count, ssize_t, add_integer, var_InheritSsize, 0) X(video_chroma, vlc_fourcc_t, add_string, var_InheritFourcc, "I420") X(video_width, unsigned, add_integer, var_InheritUnsigned, 640) X(video_height, unsigned, add_integer, var_InheritUnsigned, 480) X(video_frame_rate, unsigned, add_integer, var_InheritUnsigned, 25) X(video_frame_rate_base, unsigned, add_integer, var_InheritUnsigned, 1) X(video_packetized, bool, add_bool, var_InheritBool, true) X(input_sample_length, vlc_tick_t, add_integer, var_InheritInteger, VLC_TICK_FROM_MS(40) ) X(sub_track_count, ssize_t, add_integer, var_InheritSsize, 0) X(sub_packetized, bool, add_bool, var_InheritBool, true) X(title_count, ssize_t, add_integer, var_InheritSsize, 0 ) X(chapter_count, ssize_t, add_integer, var_InheritSsize, 0) X(null_names, bool, add_bool, var_InheritBool, false) X(program_count, ssize_t, add_integer, var_InheritSsize, 0) X(can_seek, bool, add_bool, var_InheritBool, true) X(can_pause, bool, add_bool, var_InheritBool, true) X(can_control_pace, bool, add_bool, var_InheritBool, true) X(can_control_rate, bool, add_bool, var_InheritBool, true) X(can_record, bool, add_bool, var_InheritBool, true) X(error, bool, add_bool, var_InheritBool, false) X(pts_delay, unsigned, add_integer, var_InheritUnsigned, MS_FROM_VLC_TICK(DEFAULT_PTS_DELAY)) X(add_video_track_at, vlc_tick_t, add_integer, var_InheritInteger, VLC_TICK_INVALID ) X(add_audio_track_at, vlc_tick_t, add_integer, var_InheritInteger, VLC_TICK_INVALID ) X(add_spu_track_at, vlc_tick_t, add_integer, var_InheritInteger, VLC_TICK_INVALID ) 
...
#define X(var_name, type, module_header_type, getter, default_value) type var_name;
...
#define X(var_name, type, module_header_type, getter, default_value) sys->var_name = getter(obj, "mock-"#var_name);
...
#define X(var_name, type, module_header_type, getter, default_value) module_header_type("mock-"#var_name, default_value, NULL, NULL, true) change_volatile() change_safe()
