...
#define SUB_TYPE_LONGTEXT N_("Force the subtiles format. Selecting \"auto\" means autodetection and should always work.")
#define SUB_DESCRIPTION_LONGTEXT N_("Override the default track description.")
...
{
p_sys->props.i_type = SUB_TYPE_SUBVIEWER; 
break;
}
