...
case VLC_FOURCC( 'd', 'v', 'a', '1' ): 
case VLC_FOURCC( 'd', 'v', 'a', 'v' ): 
{
...
case VLC_FOURCC( 'd', 'v', 'h', 'e' ): 
case VLC_FOURCC( 'd', 'v', 'h', '1' ): 
{
...
if ( p_sample->data.p_sample_soun->i_compressionid == 0xFFFE )
{
...
case ATOM_XiVs:
{
const MP4_Box_t *p_vCtH = MP4_BoxGet( p_sample, "wave/vCtH" ); 
const MP4_Box_t *p_vCtd = MP4_BoxGet( p_sample, "wave/vCt#" ); 
const MP4_Box_t *p_vCtC = MP4_BoxGet( p_sample, "wave/vCtC" ); 
...
case ATOM_XiFL:
{
const MP4_Box_t *p_fCtS = MP4_BoxGet( p_sample, "wave/fCtS" ); 
...
SetDWBE( &p_extra[4], p_fCtS->data.p_binary->i_blob ); 
p_extra[4] = 0x80; 
...
GetDWBE(p_dfLa->data.p_binary->p_blob) == 0 ) 
{
