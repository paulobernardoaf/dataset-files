...
if ( p_pes[i_pesextoffset] & 0x80 ) 
i_extension2_offset += 16;
if ( p_pes[i_pesextoffset] & 0x40 ) 
i_extension2_offset += 1;
if ( p_pes[i_pesextoffset] & 0x20 ) 
i_extension2_offset += 2;
if ( p_pes[i_pesextoffset] & 0x10 ) 
i_extension2_offset += 2;
if ( p_pes[i_pesextoffset] & 0x01 ) 
{
...
{
pid->probed.i_fourcc = VLC_CODEC_MP4A; 
