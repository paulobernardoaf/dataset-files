...
#define TIME_LONGTEXT N_("Normally we use the timestamps of the MPEG files " "to calculate position and duration. However sometimes this might not " "be usable. Disable this option to calculate from the bitrate instead." )
...
vlc_tick_t i_pack_scr; 
vlc_tick_t i_first_scr; 
vlc_tick_t i_scr; 
...
return true;
if( p_sys->i_length == VLC_TICK_INVALID ) 
{
