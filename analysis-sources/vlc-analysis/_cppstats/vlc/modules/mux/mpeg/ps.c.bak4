...
#define DTS_LONGTEXT N_("Delay the DTS (decoding time " "stamps) and PTS (presentation timestamps) of the data in the " "stream, compared to the SCRs. This allows for some buffering inside " "the client decoder.")




#define PES_SIZE_TEXT N_("PES maximum size")
#define PES_SIZE_LONGTEXT N_("Set the maximum allowed PES ""size when producing the MPEG PS streams.")
...
{
p_sys->i_video_bound++;
p_stream->i_max_buff_size = 400 * 1024; 
