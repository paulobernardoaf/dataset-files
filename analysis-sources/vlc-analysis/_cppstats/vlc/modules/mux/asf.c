...
bo_addle_u16( &bo, 1 ); 
bo_addle_u32( &bo, 2 ); 
bo_addle_u16( &bo, 1152 ); 
bo_addle_u16( &bo, 1 ); 
bo_addle_u16( &bo, 1393 ); 
}
...
bo_addle_u64( &bo, MSFTIME_FROM_VLC_TICK(i_duration) ); 
bo_addle_u64( &bo, MSFTIME_FROM_VLC_TICK(i_duration) ); 
bo_addle_u64( &bo, p_sys->i_preroll_time ); 
bo_addle_u32( &bo, b_broadcast ? 0x01 : 0x02 ); 
bo_addle_u32( &bo, p_sys->i_packet_size ); 
bo_addle_u32( &bo, p_sys->i_packet_size ); 
...
bo_addle_u64( &bo, 0 );
bo_addle_u64( &bo, 0 );
bo_addle_u32( &bo, p_fmt->i_bitrate ); 
bo_addle_u32( &bo, p_sys->i_preroll_time ); 
bo_addle_u32( &bo, 0 ); 
bo_addle_u32( &bo, p_fmt->i_bitrate ); 
bo_addle_u32( &bo, 0 ); 
bo_addle_u32( &bo, 0 ); 
bo_addle_u32( &bo, 0 ); 
bo_addle_u32( &bo, 0x02 ); 
bo_addle_u16( &bo, p_track->i_id ); 
bo_addle_u16( &bo, 0 ); 
bo_addle_u64( &bo, i_avg_duration ); 
bo_addle_u16( &bo, 0 ); 
bo_addle_u16( &bo, 0 ); 
}
if( i_cm_size )
...
bo_addle_u16( &bo, 2 * sizeof("AspectRatioX") ); 
bo_addle_u16( &bo, 0x3 ); 
bo_addle_u32( &bo, 4 ); 
bo_addle_str16_nosize( &bo, "AspectRatioX" );
bo_addle_u32( &bo, i_dst_num ); 
bo_addle_u16( &bo, 0 ); 
bo_addle_u16( &bo, tk->i_id ); 
bo_addle_u16( &bo, 2 * sizeof("AspectRatioY") ); 
bo_addle_u16( &bo, 0x3 ); 
bo_addle_u32( &bo, 4 ); 
bo_addle_str16_nosize( &bo, "AspectRatioY" );
bo_addle_u32( &bo, i_dst_den ); 
}
if( i_cd_size > 0 )
{
...
{
bo_add_u8( &bo, 0x1 ); 
bo_addle_u16( &bo, tk->i_blockalign ); 
bo_addle_u16( &bo, tk->i_blockalign ); 
bo_addle_u16( &bo, 1 ); 
bo_add_u8( &bo, 0x0 ); 
}
...
{
asf_track_t *tk = vlc_array_item_at_index( &p_sys->tracks ,i);
if( tk->i_cat == VIDEO_ES ) bo_addle_u16( &bo, 1 );
else if( tk->i_cat == AUDIO_ES ) bo_addle_u16( &bo, 2 );
else bo_addle_u16( &bo, 0xFFFF );
