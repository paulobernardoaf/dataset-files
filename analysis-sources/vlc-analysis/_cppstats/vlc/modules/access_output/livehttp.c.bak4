...
#define SPLITANYWHERE_LONGTEXT N_("Don't require a keyframe before splitting ""a segment. Needed for audio only.")
...
#define INDEXURL_LONGTEXT N_("Full URL to put in index file. ""Use #'s to represent segment number")
...
#define KEYLOADFILE_LONGTEXT N_("File is read when segment starts and is assumed to be in format: ""key-uri\\nkey-file. File is read on the segment opening and ""values are used on that segment.")
