...
#define CACHING_LONGTEXT N_( "Default caching value for outbound UDP streams. This " "value should be set in milliseconds." )



#define GROUP_TEXT N_("Group packets")
#define GROUP_LONGTEXT N_("Packets can be sent one by one at the right time " "or by groups. You can choose the number " "of packets that will be sent at a time. It " "helps reducing the scheduling load on " "heavily-loaded systems." )
