...
#define DESKTOP_LONGTEXT N_("The desktop mode allows you to display the video on the desktop.")
#define HW_BLENDING_TEXT N_("Use hardware blending support")
#define HW_BLENDING_LONGTEXT N_("Try to use hardware acceleration for subtitle/OSD blending.")
#define HW_YUV_TEXT N_("Use hardware YUV->RGB conversions")
#define HW_YUV_LONGTEXT N_("Try to use hardware acceleration for YUV->RGB conversions. " "This option doesn't have any effect when using overlays.")
#define PIXEL_SHADER_TEXT N_("Pixel Shader")
#define PIXEL_SHADER_LONGTEXT N_("Choose a pixel shader to apply.")
...
const d3d9_format_t *sw_texture_fmt; 
