...
#define MATRIX_YUV_TO_RGB(KR, KB) MATRIX_YUV_TO_RGB_(KR, (1-(KR)-(KB)), KB)
#define MATRIX_YUV_TO_RGB_(KR, KG, KB) { 1, 0, 2*(1.0-(KR)), 1, -2*(1.0-(KB))*((KB)/(KG)), -2*(1.0-(KR))*((KR)/(KG)), 1, 2*(1.0-(KB)), 0, }
