...
#define xdg_toplevel_set_fullscreen(s, o) wl_shell_surface_set_fullscreen(s, 1, 0, o)
...
#define DISPLAY_LONGTEXT N_( "Video will be rendered with this Wayland display. " "If empty, the default display will be used.")



#define OUTPUT_TEXT N_("Fullscreen output")
#define OUTPUT_LONGTEXT N_( "Fullscreen mode with use the output with this name by default.")
