...
#define LT_CHROMA N_("Output chroma for the memory image as a 4-character " "string, eg. \"RV32\".")
...
change_private()
add_obsolete_string("vmem-lock") 
add_obsolete_string("vmem-unlock") 
add_obsolete_string("vmem-data") 
