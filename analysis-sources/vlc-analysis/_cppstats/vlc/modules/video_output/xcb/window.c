...
#define STATE_PARTS XCB_XKB_STATE_PART_MODIFIER_BASE | XCB_XKB_STATE_PART_MODIFIER_LATCH | XCB_XKB_STATE_PART_MODIFIER_LOCK | XCB_XKB_STATE_PART_GROUP_BASE | XCB_XKB_STATE_PART_GROUP_LATCH | XCB_XKB_STATE_PART_GROUP_LOCK
...
xcb_cursor_t cursor = CursorCreate(conn, p_sys->root); 
...
#define DISPLAY_LONGTEXT N_( "Video will be rendered with this X11 display. " "If empty, the default display will be used.")
#define XID_TEXT N_("X11 window ID")
#define XID_LONGTEXT N_( "Video will be embedded in this pre-existing window. " "If zero, a new window will be created.")
vlc_module_begin ()
