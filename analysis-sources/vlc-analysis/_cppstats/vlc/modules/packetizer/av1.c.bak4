...
#define PUSHQ(name,b) {block_ChainLastAppend(&p_sys->name.pp_chain_last, b);if(p_sys->tu.dts == VLC_TICK_INVALID)p_sys->tu.dts = b->i_dts; p_sys->tu.pts = b->i_pts;}
...
if(p_outputchain)
{
#if defined(DEBUG_AV1_PACKETIZER)
