...
#define MMX_CALL(MMX_INSTRUCTIONS) do { __m64 mm0, mm1, mm2, mm3, mm4; MMX_INSTRUCTIONS p_line1 += 16; p_line2 += 16; p_y1 += 8; p_y2 += 8; p_u += 4; p_v += 4; } while(0)
...
#define MMX_YUV420_YUYV mm1 = _mm_cvtsi32_si64(*(int*)p_u); mm2 = _mm_cvtsi32_si64(*(int*)p_v); mm0 = (__m64)*(uint64_t*)p_y1; mm3 = (__m64)*(uint64_t*)p_y2; mm1 = _mm_unpacklo_pi8(mm1, mm2); mm2 = mm0; mm2 = _mm_unpacklo_pi8(mm2, mm1); *(uint64_t*)p_line1 = (uint64_t)mm2; mm0 = _mm_unpackhi_pi8(mm0, mm1); *(uint64_t*)(p_line1+8) = (uint64_t)mm0;mm4 = mm3; mm4 = _mm_unpacklo_pi8(mm4, mm1); *(uint64_t*)p_line2 = (uint64_t)mm4; mm3 = _mm_unpackhi_pi8(mm3, mm1); *(uint64_t*)(p_line2+8) = (uint64_t)mm3;
...
#define MMX_YUV420_YVYU mm2 = _mm_cvtsi32_si64(*(int*)p_u); mm1 = _mm_cvtsi32_si64(*(int*)p_v); mm0 = (__m64)*(uint64_t*)p_y1; mm3 = (__m64)*(uint64_t*)p_y2; mm1 = _mm_unpacklo_pi8(mm1, mm2); mm2 = mm0; mm2 = _mm_unpacklo_pi8(mm2, mm1); *(uint64_t*)p_line1 = (uint64_t)mm2; mm0 = _mm_unpackhi_pi8(mm0, mm1); *(uint64_t*)(p_line1+8) = (uint64_t)mm0;mm4 = mm3; mm4 = _mm_unpacklo_pi8(mm4, mm1); *(uint64_t*)p_line2 = (uint64_t)mm4; mm3 = _mm_unpackhi_pi8(mm3, mm1); *(uint64_t*)(p_line2+8) = (uint64_t)mm3;
...
#define MMX_YUV420_UYVY mm1 = _mm_cvtsi32_si64(*(int*)p_u); mm2 = _mm_cvtsi32_si64(*(int*)p_v); mm0 = (__m64)*(uint64_t*)p_y1; mm3 = (__m64)*(uint64_t*)p_y2; mm1 = _mm_unpacklo_pi8(mm1, mm2); mm2 = mm1; mm2 = _mm_unpacklo_pi8(mm2, mm0); *(uint64_t*)p_line1 = (uint64_t)mm2; mm2 = mm1; mm2 = _mm_unpackhi_pi8(mm2, mm0); *(uint64_t*)(p_line1+8) = (uint64_t)mm2;mm4 = mm1; mm4 = _mm_unpacklo_pi8(mm4, mm3); *(uint64_t*)p_line2 = (uint64_t)mm4; mm1 = _mm_unpackhi_pi8(mm1, mm3); *(uint64_t*)(p_line2+8) = (uint64_t)mm1;
...
#define SSE2_CALL(SSE2_INSTRUCTIONS) do { __asm__ __volatile__( ".p2align 3 \n\t movq (%0), %%xmm1 #Load 8 Cb 00 00 00 ... u2 u1 u0 \nmovq (%1), %%xmm2 #Load 8 Cr 00 00 00 ... v2 v1 v0 \n" : : "r" (p_u), "r" (p_v) : "xmm1", "xmm2"); __asm__ __volatile__( ".p2align 3 \n\t" SSE2_INSTRUCTIONS : : "r" (p_line1), "r" (p_line2), "r" (p_y1), "r" (p_y2) : "xmm0", "xmm1", "xmm2", "xmm3", "xmm4"); p_line1 += 32; p_line2 += 32; p_y1 += 16; p_y2 += 16; p_u += 8; p_v += 8; } while(0)
...
#define SSE2_CALL(SSE2_INSTRUCTIONS) do { __m128i xmm0, xmm1, xmm2, xmm3, xmm4; SSE2_INSTRUCTIONS p_line1 += 32; p_line2 += 32; p_y1 += 16; p_y2 += 16; p_u += 8; p_v += 8; } while(0)
...
#define SSE2_YUV420_YUYV_UNALIGNED xmm1 = _mm_loadl_epi64((__m128i *)p_u); xmm2 = _mm_loadl_epi64((__m128i *)p_v); xmm0 = _mm_loadu_si128((__m128i *)p_y1); xmm3 = _mm_loadu_si128((__m128i *)p_y2); _mm_prefetch(p_line1, _MM_HINT_NTA); _mm_prefetch(p_line2, _MM_HINT_NTA); xmm1 = _mm_unpacklo_epi8(xmm1, xmm2); xmm2 = xmm0; xmm2 = _mm_unpacklo_epi8(xmm2, xmm1); _mm_storeu_si128((__m128i*)(p_line1), xmm2); xmm0 = _mm_unpackhi_epi8(xmm0, xmm1); _mm_storeu_si128((__m128i*)(p_line1+16), xmm0); xmm4 = xmm3; xmm4 = _mm_unpacklo_epi8(xmm4, xmm1); _mm_storeu_si128((__m128i*)(p_line2), xmm4); xmm3 = _mm_unpackhi_epi8(xmm3, xmm1); _mm_storeu_si128((__m128i*)(p_line1+16), xmm3);
...
#define SSE2_YUV420_YVYU_ALIGNED xmm1 = _mm_loadl_epi64((__m128i *)p_v); xmm2 = _mm_loadl_epi64((__m128i *)p_u); xmm0 = _mm_load_si128((__m128i *)p_y1); xmm3 = _mm_load_si128((__m128i *)p_y2); xmm1 = _mm_unpacklo_epi8(xmm1, xmm2); xmm2 = xmm0; xmm2 = _mm_unpacklo_epi8(xmm2, xmm1); _mm_stream_si128((__m128i*)(p_line1), xmm2); xmm0 = _mm_unpackhi_epi8(xmm0, xmm1); _mm_stream_si128((__m128i*)(p_line1+16), xmm0); xmm4 = xmm3; xmm4 = _mm_unpacklo_epi8(xmm4, xmm1); _mm_stream_si128((__m128i*)(p_line2), xmm4); xmm3 = _mm_unpackhi_epi8(xmm3, xmm1); _mm_stream_si128((__m128i*)(p_line1+16), xmm3);
...
#define SSE2_YUV420_YVYU_UNALIGNED xmm1 = _mm_loadl_epi64((__m128i *)p_v); xmm2 = _mm_loadl_epi64((__m128i *)p_u); xmm0 = _mm_loadu_si128((__m128i *)p_y1); xmm3 = _mm_loadu_si128((__m128i *)p_y2); _mm_prefetch(p_line1, _MM_HINT_NTA); _mm_prefetch(p_line2, _MM_HINT_NTA); xmm1 = _mm_unpacklo_epi8(xmm1, xmm2); xmm2 = xmm0; xmm2 = _mm_unpacklo_epi8(xmm2, xmm1); _mm_storeu_si128((__m128i*)(p_line1), xmm2); xmm0 = _mm_unpackhi_epi8(xmm0, xmm1); _mm_storeu_si128((__m128i*)(p_line1+16), xmm0); xmm4 = xmm3; xmm4 = _mm_unpacklo_epi8(xmm4, xmm1); _mm_storeu_si128((__m128i*)(p_line2), xmm4); xmm3 = _mm_unpackhi_epi8(xmm3, xmm1); _mm_storeu_si128((__m128i*)(p_line1+16), xmm3);
...
#define SSE2_YUV420_UYVY_ALIGNED xmm1 = _mm_loadl_epi64((__m128i *)p_u); xmm2 = _mm_loadl_epi64((__m128i *)p_v); xmm0 = _mm_load_si128((__m128i *)p_y1); xmm3 = _mm_load_si128((__m128i *)p_y2); xmm1 = _mm_unpacklo_epi8(xmm1, xmm2); xmm2 = xmm1; xmm2 = _mm_unpacklo_epi8(xmm2, xmm0); _mm_stream_si128((__m128i*)(p_line1), xmm2); xmm2 = xmm1; xmm2 = _mm_unpackhi_epi8(xmm2, xmm0); _mm_stream_si128((__m128i*)(p_line1+16), xmm2); xmm4 = xmm1; xmm4 = _mm_unpacklo_epi8(xmm4, xmm3); _mm_stream_si128((__m128i*)(p_line2), xmm4); xmm1 = _mm_unpackhi_epi8(xmm1, xmm3); _mm_stream_si128((__m128i*)(p_line1+16), xmm1);
...
#define SSE2_YUV420_UYVY_UNALIGNED xmm1 = _mm_loadl_epi64((__m128i *)p_u); xmm2 = _mm_loadl_epi64((__m128i *)p_v); xmm0 = _mm_loadu_si128((__m128i *)p_y1); xmm3 = _mm_loadu_si128((__m128i *)p_y2); _mm_prefetch(p_line1, _MM_HINT_NTA); _mm_prefetch(p_line2, _MM_HINT_NTA); xmm1 = _mm_unpacklo_epi8(xmm1, xmm2); xmm2 = xmm1; xmm2 = _mm_unpacklo_epi8(xmm2, xmm0); _mm_storeu_si128((__m128i*)(p_line1), xmm2); xmm2 = xmm1; xmm2 = _mm_unpackhi_epi8(xmm2, xmm0); _mm_storeu_si128((__m128i*)(p_line1+16), xmm2); xmm4 = xmm1; xmm4 = _mm_unpacklo_epi8(xmm4, xmm3); _mm_storeu_si128((__m128i*)(p_line2), xmm4); xmm1 = _mm_unpackhi_epi8(xmm1, xmm3); _mm_storeu_si128((__m128i*)(p_line1+16), xmm1);
...
#define C_YUV420_YVYU( ) *(p_line1)++ = *(p_y1)++; *(p_line2)++ = *(p_y2)++; *(p_line1)++ = *(p_line2)++ = *(p_v)++; *(p_line1)++ = *(p_y1)++; *(p_line2)++ = *(p_y2)++; *(p_line1)++ = *(p_line2)++ = *(p_u)++; 





#define C_YUV420_Y211( ) *(p_line1)++ = *(p_y1); p_y1 += 2; *(p_line2)++ = *(p_y2); p_y2 += 2; *(p_line1)++ = *(p_line2)++ = *(p_u) - 0x80; p_u += 2; *(p_line1)++ = *(p_y1); p_y1 += 2; *(p_line2)++ = *(p_y2); p_y2 += 2; *(p_line1)++ = *(p_line2)++ = *(p_v) - 0x80; p_v += 2; 
...
#define C_YUV420_YUYV( ) *(p_line1)++ = *(p_y1)++; *(p_line2)++ = *(p_y2)++; *(p_line1)++ = *(p_line2)++ = *(p_u)++; *(p_line1)++ = *(p_y1)++; *(p_line2)++ = *(p_y2)++; *(p_line1)++ = *(p_line2)++ = *(p_v)++; 





#define C_YUV420_UYVY( ) *(p_line1)++ = *(p_line2)++ = *(p_u)++; *(p_line1)++ = *(p_y1)++; *(p_line2)++ = *(p_y2)++; *(p_line1)++ = *(p_line2)++ = *(p_v)++; *(p_line1)++ = *(p_y1)++; *(p_line2)++ = *(p_y2)++; 
