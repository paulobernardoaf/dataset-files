...
#define MONO_DOWNMIX_LONGTEXT N_("This option selects a stereo to mono " "downmix algorithm that is used in the headphone channel mixer. It " "gives the effect of standing in a room full of speakers." )



#define MONO_CHANNEL_TEXT N_("Select channel to keep")
#define MONO_CHANNEL_LONGTEXT N_("This option silences all other channels " "except the selected channel.")
