...
set_shortname( "Remap" )
#define CHANNEL( idx ) add_integer( channel_name[idx], idx, channel_desc[idx], channel_desc[idx], false) change_integer_list( channel_idx, channel_desc )
...
int8_t pi_map_ch[ AOUT_CHAN_MAX ] = { 0 }; 
