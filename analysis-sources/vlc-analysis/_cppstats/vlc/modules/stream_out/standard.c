...
#define ACCESS_LONGTEXT N_( "Output method to use for the stream." )
#define MUX_TEXT N_("Output muxer")
#define MUX_LONGTEXT N_( "Muxer to use for the stream." )
#define DEST_TEXT N_("Output destination")
#define DEST_LONGTEXT N_( "Destination (URL) to use for the stream. Overrides path and bind parameters" )
#define BIND_TEXT N_("Address to bind to (helper setting for dst)")
#define BIND_LONGTEXT N_( "address:port to bind vlc to listening incoming streams. ""Helper setting for dst, dst=bind+'/'+path. dst-parameter overrides this." )
#define PATH_TEXT N_("Filename for stream (helper setting for dst)")
#define PATH_LONGTEXT N_( "Filename for stream. ""Helper setting for dst, dst=bind+'/'+path. dst-parameter overrides this." )
...
add_obsolete_string( SOUT_CFG_PREFIX "group" ) 
