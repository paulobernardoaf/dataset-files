...
#define COLOR_LONGTEXT N_("Colors similar to this will be kept, others will be ""grayscaled. This must be an hexadecimal (like HTML colors). The first two ""chars are for red, then green, then blue. #000000 = black, #FF0000 = red,"" #00FF00 = green, #FFFF00 = yellow (red + green), #FFFFFF = white" )
