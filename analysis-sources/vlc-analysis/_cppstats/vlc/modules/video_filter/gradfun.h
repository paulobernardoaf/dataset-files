...
#define BLURV(load)intptr_t x = -2*width;__asm__ volatile("movdqa %6, %%xmm7 \n""1: \n"load" (%4,%0), %%xmm0 \n"load" (%5,%0), %%xmm1 \n""movdqa %%xmm0, %%xmm2 \n""movdqa %%xmm1, %%xmm3 \n""psrlw $8, %%xmm0 \n""psrlw $8, %%xmm1 \n""pand %%xmm7, %%xmm2 \n""pand %%xmm7, %%xmm3 \n""paddw %%xmm1, %%xmm0 \n""paddw %%xmm3, %%xmm2 \n""paddw %%xmm2, %%xmm0 \n""paddw (%2,%0), %%xmm0 \n""movdqa (%1,%0), %%xmm1 \n""movdqa %%xmm0, (%1,%0) \n""psubw %%xmm1, %%xmm0 \n""movdqa %%xmm0, (%3,%0) \n""add $16, %0 \n""jl 1b \n":"+&r"(x):"r"(buf+width),"r"(buf1+width),"r"(dc+width),"r"(src+width*2),"r"(src+width*2+sstride),"m"(*pw_ff):"xmm0", "xmm1", "xmm2", "xmm3", "xmm7", "memory");
VLC_SSE
