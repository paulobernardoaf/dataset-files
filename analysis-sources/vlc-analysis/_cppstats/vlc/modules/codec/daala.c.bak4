...
#define ENC_QUALITY_LONGTEXT N_( "Enforce a quality between 0 (lossless) and 511 (worst)." )

#define ENC_KEYINT_TEXT N_("Keyframe interval")
#define ENC_KEYINT_LONGTEXT N_( "Enforce a keyframe interval between 1 and 1000." )
