...
#define CEA708_ROW_HEIGHT_STANDARD (CEA708_SAFE_AREA_REL / CEA708_WINDOW_MAX_ROWS)

#define CEA708_FONT_TO_LINE_HEIGHT_RATIO 1.06

#define CEA708_FONTRELSIZE_STANDARD (100.0 * CEA708_ROW_HEIGHT_STANDARD / CEA708_FONT_TO_LINE_HEIGHT_RATIO)
...
cea708_window_t *p_cw; 
vlc_tick_t suspended_deadline; 
vlc_tick_t i_clock;
bool b_text_waiting;
};
...
#define DEFAULT_NTSC_STYLE(font, edge, bgopacity ) {CEA708_PEN_SIZE_STANDARD,font,CEA708_TAG_DIALOG,CEA708_PEN_OFFSET_NORMAL,false,false,{ 0x2A, CEA708_OPACITY_SOLID, },{ 0x00, bgopacity, },0x00,edge,}
...
#define DEFAULT_NTSC_WA_STYLE(just, pd, scroll, wrap, opacity) {just,pd,scroll,CEA708_WA_DIRECTION_LTR,wrap,CEA708_WA_EFFECT_SNAP,1,0x00,opacity,CEA708_EDGE_NONE,0x00,}
...
#define REQUIRE_ARGS(n) if(cea708_input_buffer_size( ib ) < n + 1)return CEA708_STATUS_STARVING
