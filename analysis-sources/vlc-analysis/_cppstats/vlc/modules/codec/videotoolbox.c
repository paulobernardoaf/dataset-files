...
#define VT_FORCE_CVPX_CHROMA_LONG "Values can be 'BGRA', 'y420', '420f', '420v', '2vuy'. By Default, the best chroma is choosen by the VT decoder."
vlc_module_begin()
...
{
VLC_UNUSED(p_dec);
return ExtradataInfoCreate(NULL, NULL, 0); 
}
...
{
#define VTERRCASE(x) case x: msg_Warn(p_dec, "vt session error: '" #x "'"); break;
switch (status)
{
case noErr:
return VLC_SUCCESS;
