...
#define CH_ORDER_MPEG 0 
#define CH_ORDER_WAV 1 
#define CH_ORDER_WG4 2 
...
#define FDKENC_VER_AT_LEAST(vl0, vl1) (defined(AACENCODER_LIB_VL0) && ((AACENCODER_LIB_VL0 > vl0) || (AACENCODER_LIB_VL0 == vl0 && AACENCODER_LIB_VL1 >= vl1)))
...
#define SET_PARAM(P, V) do { AACENC_ERROR err = aacEncoder_SetParam(p_sys->handle, AACENC_ ##P, V); if (err != AACENC_OK) { msg_Err(p_enc, "Couldn't set " #P " to value %d: %s", V, fdkaac_error(err)); goto error; } } while(0)
