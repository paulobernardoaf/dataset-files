...
#define VLC_RGB_ES( fcc, leid, beid ) { fcc, beid, 0, 0, 0 },
...
#define VLC_RGB( fcc, leid, beid, rmask, gmask, bmask ) { fcc, leid, rmask, gmask, bmask }, { fcc, beid, bmask, gmask, rmask }, VLC_RGB_ES( fcc, leid, beid )
...
#if defined(AV_PIX_FMT_YUV420P12)
...
#if defined(AV_PIX_FMT_YUV422P12)
...
#if defined(AV_PIX_FMT_YUV444P12)
