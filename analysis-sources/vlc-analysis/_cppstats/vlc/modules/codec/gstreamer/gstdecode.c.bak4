...
#define MODULE_DESCRIPTION N_( "Uses GStreamer framework's plugins " "to decode the media codecs" )


#define USEDECODEBIN_TEXT N_( "Use DecodeBin" )
#define USEDECODEBIN_LONGTEXT N_( "DecodeBin is a container element, that can add and " "manage multiple elements. Apart from adding the decoders, " "decodebin also adds elementary stream parsers which can provide " "more info such as codec profile, level and other attributes, " "in the form of GstCaps (Stream Capabilities) to decoder." )
...
#define USEVLCPOOL_LONGTEXT "Allow the gstreamer decoders to directly decode (direct render) " "into the buffers provided and managed by the (downstream)VLC modules " "that follow. Note: Currently this feature is unstable, enable it at " "your own risk."
...
#define VLC_GST_CHECK( r, v, s, t ) { if( r == v ){ msg_Err( p_dec, s ); i_rval = t; goto fail; } }
