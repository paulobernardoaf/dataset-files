...
const char *psz_font = NULL; 
const char *psz_family = "Helvetica Neue"; 
#else
const char *psz_font = NULL; 
...
#endif
ass_set_fonts( p_renderer, psz_font, psz_family, ASS_FONTPROVIDER_AUTODETECT, NULL, 1 ); 
#if defined(_WIN32)
if( p_dialog_id != 0 )
