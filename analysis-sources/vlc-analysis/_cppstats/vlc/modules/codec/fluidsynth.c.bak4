...
#define SOUNDFONT_LONGTEXT N_( "SoundFont file to use for software synthesis." )


#define CHORUS_TEXT N_("Chorus")

#define GAIN_TEXT N_("Synthesis gain")
#define GAIN_LONGTEXT N_("This gain is applied to synthesis output. " "High values may cause saturation when many notes are played at a time." )


#define POLYPHONY_TEXT N_("Polyphony")
#define POLYPHONY_LONGTEXT N_( "The polyphony defines how many voices can be played at a time. " "Larger values require more processing power.")
