...
#define WRITE_WITH_ENTITIES( formatstring, varname ) if ( varname ) {psz_tempstring = vlc_xml_encode( varname );fprintf( p_catalog, formatstring, psz_tempstring );free( psz_tempstring );}
