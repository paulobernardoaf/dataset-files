...
#define GET_DRV_SIGMA(vlc_sigma, vlc_range, drv_range) ((vlc_sigma - (vlc_range).min_value) * ((drv_range).max_value - (drv_range).min_value) / ((vlc_range).max_value - (vlc_range).min_value) + (drv_range).min_value)
