...
mmal_buffer_header_acquire(buf); 




hw_mmal_port_pool_ref_recycle(ppr, buf);
hw_mmal_port_pool_ref_release(ppr, true); 
...
#define ENT_LIST_HDR_INIT (ent_list_hdr_t){ .ents = NULL, .tail = NULL, .n = 0 }
