...
#define HTML_HEADER "<!DOCTYPE html PUBLIC \"-//W3C//DTD HTML 4.01//EN\"\n" " \"http://www.w3.org/TR/html4/strict.dtd\">\n" "<html>\n" " <head>\n" " <title>vlc log</title>\n" " <meta http-equiv=\"Content-Type\"" " content=\"text/html; charset=UTF-8\">\n" " </head>\n" " <body style=\"background-color: #000000; color: #aaaaaa;\">\n" " <pre>\n" " <strong>-- logger module started --</strong>\n"
#define HTML_FOOTER " <strong>-- logger module stopped --</strong>\n" " </pre>\n" " </body>\n" "</html>\n"
...
#define LOGVERBOSE_LONGTEXT N_("Select the logging verbosity or " "default to use the same verbosity given by --verbose.")
vlc_module_begin()
