...
#define HELP_TEXT N_( "Pass alsa:// to open the default ALSA capture device, " "or alsa://SOURCE to open a specific device named SOURCE.")
...
set_help (HELP_TEXT)
add_obsolete_string ("alsa-format") 
...
[SND_PCM_FORMAT_U24_LE] = VLC_CODEC_U32L, 
...
[SND_PCM_FORMAT_S20_3LE] = VLC_CODEC_S24L, 
