...
#define ADAPTER_LONGTEXT N_( "If there is more than one digital broadcasting adapter, " "the adapter number must be selected. Numbering starts from zero.")



#define DEVICE_TEXT N_("DVB device")
#define DEVICE_LONGTEXT N_( "If the adapter provides multiple independent tuner devices, " "the device number must be selected. Numbering starts from zero.")


#define BUDGET_TEXT N_("Do not demultiplex")
#define BUDGET_LONGTEXT N_( "Only useful programs are normally demultiplexed from the transponder. " "This option will disable demultiplexing and receive all programs.")
...
#define FREQ_LONGTEXT N_( "TV channels are grouped by transponder (a.k.a. multiplex) " "on a given frequency. This is required to tune the receiver.")
...
#define MODULATION_LONGTEXT N_( "The digital signal can be modulated according with different " "constellations (depending on the delivery system). " "If the demodulator cannot detect the constellation automatically, " "it needs to be configured manually.")
...
#define SRATE_LONGTEXT N_( "The symbol rate must be specified manually for some systems, " "notably DVB-C, DVB-S and DVB-S2.")



#define INVERSION_TEXT N_("Spectrum inversion")
#define INVERSION_LONGTEXT N_( "If the demodulator cannot detect spectral inversion correctly, " "it needs to be configured manually.")
...
#define CODE_RATE_LONGTEXT N_( "The code rate for Forward Error Correction can be specified.")
...
#define POLARIZATION_LONGTEXT N_( "To select the polarization of the transponder, a different voltage " "is normally applied to the low noise block-downconverter (LNB).")
...
#define HIGH_VOLTAGE_LONGTEXT N_( "If the cables between the satellilte low noise block-downconverter and " "the receiver are long, higher voltage may be required.\n" "Not all receivers support this.")
...
#define LNB_LONGTEXT N_( "The downconverter (LNB) will subtract the local oscillator frequency " "from the satellite transmission frequency. " "The intermediate frequency (IF) on the RF cable is the result.")



#define LNB_SWITCH_TEXT N_("Universal LNB switch frequency (kHz)")
#define LNB_SWITCH_LONGTEXT N_( "If the satellite transmission frequency exceeds the switch frequency, " "the oscillator high frequency will be used as reference. " "Furthermore the automatic continuous 22kHz tone will be sent.")



#define TONE_TEXT N_("Continuous 22kHz tone")
#define TONE_LONGTEXT N_( "A continuous tone at 22kHz can be sent on the cable. " "This normally selects the higher frequency band from a universal LNB.")



#define SATNO_TEXT N_("DiSEqC LNB number")
#define SATNO_LONGTEXT N_( "If the satellite receiver is connected to multiple " "low noise block-downconverters (LNB) through a DiSEqC 1.0 switch, " "the correct LNB can be selected (1 to 4). " "If there is no switch, this parameter should be 0.")




#if defined(HAVE_LINUX_DVB)
...
#define UNCOMMITTED_LONGTEXT N_( "If the satellite receiver is connected to multiple " "low noise block-downconverters (LNB) through a cascade formed from " "DiSEqC 1.1 uncommitted switch and DiSEqC 1.0 committed switch, " "the correct uncommitted LNB can be selected (1 to 4). " "If there is no uncommitted switch, this parameter should be 0.")
...
#define LONGITUDE_LONGTEXT N_( "Satellite longitude in tenths of degree. West is negative.")


#define RANGE_TEXT N_("Satellite range code")
#define RANGE_LONGTEXT N_("Satellite range code as defined by manufacturer " "e.g. DISEqC switch code")
