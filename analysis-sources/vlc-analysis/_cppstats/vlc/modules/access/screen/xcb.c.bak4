...
#define WIDTH_LONGTEXT N_( "Pixel width of the capture region, or 0 for full width")


#define HEIGHT_TEXT N_("Capture region height")
#define HEIGHT_LONGTEXT N_( "Pixel height of the capture region, or 0 for full height")
...
{
xcb_free_pixmap (conn, sys->pixmap); 
...
xcb_shm_attach (conn, sys->segment, id, 0 );
