...
{ "bg-color", V4L2_CID_BG_COLOR }, 
{ "chroma-gain", V4L2_CID_CHROMA_GAIN },
{ "brightness-auto", V4L2_CID_AUTOBRIGHTNESS },
{ "band-stop-filter", V4L2_CID_BAND_STOP_FILTER },
{ "illuminators-1", V4L2_CID_ILLUMINATORS_1 }, 
{ "illuminators-2", V4L2_CID_ILLUMINATORS_2 },
#define CTRL_CID_KNOWN(cid) ((((uint32_t)cid) - V4L2_CID_BRIGHTNESS) <= (V4L2_CID_BAND_STOP_FILTER - V4L2_CID_BRIGHTNESS))
};
...
#define CTRL_FLAGS_IGNORE (V4L2_CTRL_FLAG_DISABLED |V4L2_CTRL_FLAG_READ_ONLY |V4L2_CTRL_FLAG_VOLATILE )
