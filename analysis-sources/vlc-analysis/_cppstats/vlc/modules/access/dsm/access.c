...
#define SMB_FORCE_V1_LONGTEXT N_("Enable it, at your own risk, if you can't connect to Windows shares. " "If this option is needed, you should consider updating your Windows / " "Samba server and disabling the SMBv1 protocol as using this protocol " "has security implications.")
