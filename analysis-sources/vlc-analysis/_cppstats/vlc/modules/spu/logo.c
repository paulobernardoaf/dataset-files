...
#define FILE_LONGTEXT N_("Full path of the image files to use. Format is " "<image>[,<delay in ms>[,<alpha>]][;<image>[,<delay>[,<alpha>]]][;...]. " "If you only have one file, simply enter its filename.")
#define REPEAT_TEXT N_("Logo animation #of loops")
#define REPEAT_LONGTEXT N_("Number of loops for the logo animation. " "-1 = continuous, 0 = disabled")
...
#define POSX_LONGTEXT N_("X coordinate of the logo. You can move the logo " "by left-clicking it." )
#define POSY_TEXT N_("Y coordinate")
#define POSY_LONGTEXT N_("Y coordinate of the logo. You can move the logo " "by left-clicking it." )
#define OPACITY_TEXT N_("Opacity of the logo")
#define OPACITY_LONGTEXT N_("Logo opacity value " "(from 0 for full transparency to 255 for full opacity)." )
#define POS_TEXT N_("Logo position")
#define POS_LONGTEXT N_( "Enforce the logo position on the video " "(0=center, 1=left, 2=right, 4=top, 8=bottom, you can " "also use combinations of these values, eg 6 = top-right).")
