...
#define VLC_CODEC_YUV_PLANAR_444_ALPHA VLC_CODEC_YUVA, VLC_CODEC_YUVA_444_10L, VLC_CODEC_YUVA_444_10B
#define VLC_CODEC_YUV_SEMIPLANAR_444 VLC_CODEC_NV24, VLC_CODEC_NV42
#define VLC_CODEC_YUV_PLANAR_444_16 VLC_CODEC_I444_10L, VLC_CODEC_I444_10B, VLC_CODEC_I444_9L, VLC_CODEC_I444_9B, VLC_CODEC_I444_16L, VLC_CODEC_I444_16B, VLC_CODEC_I444_12L, VLC_CODEC_I444_12B
#define VLC_CODEC_YUV_PACKED VLC_CODEC_YUYV, VLC_CODEC_YVYU, VLC_CODEC_UYVY, VLC_CODEC_VYUY, VLC_CODEC_VUYA, VLC_CODEC_Y210, VLC_CODEC_Y410
#define VLC_CODEC_FALLBACK_420 VLC_CODEC_YUV_PLANAR_422, VLC_CODEC_YUV_PACKED, VLC_CODEC_YUV_PLANAR_444, VLC_CODEC_YUV_PLANAR_440, VLC_CODEC_I411, VLC_CODEC_YUV_PLANAR_410, VLC_CODEC_Y211
...
#define VLC_CODEC_FALLBACK_422 VLC_CODEC_YUV_PACKED, VLC_CODEC_YUV_PLANAR_420, VLC_CODEC_YUV_PLANAR_444, VLC_CODEC_YUV_PLANAR_440, VLC_CODEC_I411, VLC_CODEC_YUV_PLANAR_410, VLC_CODEC_Y211
...
#define VLC_CODEC_FALLBACK_444 VLC_CODEC_YUV_PLANAR_422, VLC_CODEC_YUV_PACKED, VLC_CODEC_YUV_PLANAR_420, VLC_CODEC_YUV_PLANAR_440, VLC_CODEC_I411, VLC_CODEC_YUV_PLANAR_410, VLC_CODEC_Y211
...
#define VLC_CODEC_FALLBACK_PACKED VLC_CODEC_YUV_PLANAR_422, VLC_CODEC_YUV_PLANAR_420, VLC_CODEC_YUV_PLANAR_444, VLC_CODEC_YUV_PLANAR_440, VLC_CODEC_I411, VLC_CODEC_YUV_PLANAR_410, VLC_CODEC_Y211
...
#define PLANAR(n, w_den, h_den, size, bits) { .plane_count = n, .p = { {.w = {1, 1}, .h = {1, 1}}, {.w = {1,w_den}, .h = {1,h_den}}, {.w = {1,w_den}, .h = {1,h_den}}, {.w = {1, 1}, .h = {1, 1}} }, .pixel_size = size, .pixel_bits = bits }
#define PLANAR_8(n, w_den, h_den) PLANAR(n, w_den, h_den, 1, 8)
#define PLANAR_16(n, w_den, h_den, bits) PLANAR(n, w_den, h_den, 2, bits)
#define SEMIPLANAR(w_den, h_den, size, bits) { .plane_count = 2, .p = { {.w = {1, 1}, .h = {1, 1}}, {.w = {2,w_den}, .h = {1,h_den}} }, .pixel_size = size, .pixel_bits = bits }
#define PACKED_FMT(size, bits) { .plane_count = 1, .p = { {.w = {1,1}, .h = {1,1}} }, .pixel_size = size, .pixel_bits = bits }
#define FAKE_FMT() { .plane_count = 0, .p = { {.w = {1,1}, .h = {1,1}} }, .pixel_size = 0, .pixel_bits = 0 }
static const struct
{
