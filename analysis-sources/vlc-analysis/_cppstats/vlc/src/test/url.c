...
#define test_url_parse(in, protocol, user, pass, host, port, path, option) test_url_parse_internal(in, false, protocol, user, pass, host, port, path, option)
#define test_url_parse_fixup(in, protocol, user, pass, host, port, path, option) test_url_parse_internal(in, true, protocol, user, pass, host, port, path, option)
