...
#define decoder_Notify(decoder_priv, event, ...) if (decoder_priv->cbs && decoder_priv->cbs->event) decoder_priv->cbs->event(decoder_priv, __VA_ARGS__, decoder_priv->cbs_userdata);
