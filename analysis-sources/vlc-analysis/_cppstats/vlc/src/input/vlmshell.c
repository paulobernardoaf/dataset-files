...
#define MessageAdd( a ) vlm_MessageAdd( *pp_status, vlm_MessageSimpleNew( a ) );
#define MessageAddChild( a ) vlm_MessageAdd( message_child, vlm_MessageSimpleNew( a ) );
...
"stopped" ) );
#define APPEND_INPUT_INFO( key, format, value ) vlm_MessageAdd( p_msg_instance, vlm_MessageNew( key, format, value ) )
