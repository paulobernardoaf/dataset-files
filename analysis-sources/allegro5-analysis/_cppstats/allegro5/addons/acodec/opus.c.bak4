...
#if !defined(ALLEGRO_CFG_ACODEC_OPUS)
...
#if defined(ALLEGRO_CFG_ACODEC_OPUSFILE_DLL)
...
#define INITSYM(x) do { lib.x = _al_import_symbol(op_dll, #x); if (lib.x == 0) { ALLEGRO_ERROR("undefined symbol in lib structure: " #x "\n"); return false; } } while(0)
