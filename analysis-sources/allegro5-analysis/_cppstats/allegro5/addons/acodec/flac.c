...
#if defined(ALLEGRO_CFG_ACODEC_FLAC_DLL)
...
#define INITSYM(x) do { lib.x = _al_import_symbol(flac_dll, #x); if (lib.x == 0) { ALLEGRO_ERROR("undefined symbol in lib structure: " #x "\n"); return false; } } while(0)
#else
