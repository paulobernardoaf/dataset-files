...
uint32_t a = read_32le(buf + bi*4); 
uint32_t b = read_32le(buf + bi*4 + 4); 
uint32_t c = read_32le(buf + bi*4 + 8); 
uint32_t w = a;
uint32_t x = (a >> 24) | (b << 8);
...
al_set_errno(0);
al_fwrite16le(f, 0x4D42); 
al_fwrite32le(f, bfSize); 
al_fwrite16le(f, 0); 
al_fwrite16le(f, 0); 
al_fwrite32le(f, 14 + WININFOHEADERSIZE); 
al_fwrite32le(f, WININFOHEADERSIZE); 
al_fwrite32le(f, w); 
al_fwrite32le(f, h); 
al_fwrite16le(f, 1); 
al_fwrite16le(f, bpp); 
al_fwrite32le(f, BIT_RGB); 
al_fwrite32le(f, biSizeImage); 
al_fwrite32le(f, 0xB12); 
al_fwrite32le(f, 0xB12); 
al_fwrite32le(f, 0); 
al_fwrite32le(f, 0); 
lr = al_lock_bitmap(bmp, ALLEGRO_PIXEL_FORMAT_ABGR_8888_LE,
