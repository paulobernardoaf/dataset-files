...
#if defined(_ALLEGRO_GL_VERSION_1_2)
...
#if defined(_ALLEGRO_GL_ARB_multitexture)
...
#if defined(_ALLEGRO_GL_ARB_vertex_shader)
...
#if defined(AGK_IBM_vertex_array_lists)
