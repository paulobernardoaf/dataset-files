...
#endif
#define _AL_JOYSTICK_DRIVER_XINPUT { AL_JOY_TYPE_XINPUT, &_al_joydrv_xinput, true },
...
#endif
#define _AL_JOYSTICK_DRIVER_WINDOWS_ALL { AL_JOY_TYPE_WINDOWS_ALL, &_al_joydrv_windows_all, true },
...
#endif
#define _AL_HAPTIC_DRIVER_DIRECTX { AL_HAPTIC_TYPE_DIRECTX, &_al_hapdrv_directx, true },
...
#endif
#define _AL_HAPTIC_DRIVER_XINPUT { AL_HAPTIC_TYPE_XINPUT, &_al_hapdrv_xinput, true },
...
#endif
#define _AL_HAPTIC_DRIVER_WINDOWS_ALL { AL_HAPTIC_TYPE_WINDOWS_ALL, &_al_hapdrv_windows_all, true },
