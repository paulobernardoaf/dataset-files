...
#if !defined(_AL_BSTRLIB_INCLUDE)
...
#define _al_bvformata(ret, b, fmt, lastarg) { _al_bstring bstrtmp_b = (b); const char * bstrtmp_fmt = (fmt); int bstrtmp_r = _AL_BSTR_ERR, bstrtmp_sz = 16; for (;;) { va_list bstrtmp_arglist; va_start (bstrtmp_arglist, lastarg); bstrtmp_r = _al_bvcformata (bstrtmp_b, bstrtmp_sz, bstrtmp_fmt, bstrtmp_arglist); va_end (bstrtmp_arglist); if (bstrtmp_r >= 0) { bstrtmp_r = _AL_BSTR_OK; break; } else if (-bstrtmp_r <= bstrtmp_sz) { bstrtmp_r = _AL_BSTR_ERR; break; } bstrtmp_sz = -bstrtmp_r; } ret = bstrtmp_r; }
...
#if !defined(__al_tagbstring_defined)
...
#define _al_btfromblkltrimws(t,s,l) { int bstrtmp_idx = 0, bstrtmp_len = (l); unsigned char * bstrtmp_s = (s); if (bstrtmp_s && bstrtmp_len >= 0) { for (; bstrtmp_idx < bstrtmp_len; bstrtmp_idx++) { if (!isspace (bstrtmp_s[bstrtmp_idx])) break; } } (t).data = bstrtmp_s + bstrtmp_idx; (t).slen = bstrtmp_len - bstrtmp_idx; (t).mlen = -__LINE__; }
...
#define _al_btfromblkrtrimws(t,s,l) { int bstrtmp_len = (l) - 1; unsigned char * bstrtmp_s = (s); if (bstrtmp_s && bstrtmp_len >= 0) { for (; bstrtmp_len >= 0; bstrtmp_len--) { if (!isspace (bstrtmp_s[bstrtmp_len])) break; } } (t).data = bstrtmp_s; (t).slen = bstrtmp_len + 1; (t).mlen = -__LINE__; }
...
#define _al_btfromblktrimws(t,s,l) { int bstrtmp_idx = 0, bstrtmp_len = (l) - 1; unsigned char * bstrtmp_s = (s); if (bstrtmp_s && bstrtmp_len >= 0) { for (; bstrtmp_idx <= bstrtmp_len; bstrtmp_idx++) { if (!isspace (bstrtmp_s[bstrtmp_idx])) break; } for (; bstrtmp_len >= bstrtmp_idx; bstrtmp_len--) { if (!isspace (bstrtmp_s[bstrtmp_len])) break; } } (t).data = bstrtmp_s + bstrtmp_idx; (t).slen = bstrtmp_len + 1 - bstrtmp_idx; (t).mlen = -__LINE__; }
