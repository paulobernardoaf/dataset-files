...
#define SCAN0(fn) (sscanf(stmt, fn " %80[(]" " )", ARGS1) == 1)
#define SCAN(fn, arity) (sscanf(stmt, fn " (" PAT##arity " )", ARGS##arity) == arity)
#define SCANLVAL(fn, arity) (sscanf(stmt, PAT " = " fn " (" PAT##arity " )", lval, ARGS##arity) == 1 + arity)
