...
#define PLANE_DETS(var, u1, u2, u3) float var##_det = u1 * minor3 - u2 * minor2 + u3 * minor1; float var##_det_x = u1 * y32 - u2 * y31 + u3 * y21; float var##_det_y = u1 * x23 - u2 * x13 + u3 * x12;
