...
#define REGISTER(function) Handler *ent = find_handler(extension, function != NULL); if (!function) { if (!ent || !ent->function) { return false; } } ent->function = function; return true;
