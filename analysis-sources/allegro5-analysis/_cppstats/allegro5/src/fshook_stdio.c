...
#if defined(ALLEGRO_HAVE_SYS_STAT_H)
#include <sys/stat.h>
#endif
#if defined(ALLEGRO_HAVE_DIRENT_H)
#include <sys/types.h>
#include <dirent.h>
...
#if defined(ALLEGRO_HAVE_SYS_NDIR_H)
#include <sys/ndir.h>
#endif
#if defined(ALLEGRO_HAVE_SYS_DIR_H)
#include <sys/dir.h>
#endif
#if defined(ALLEGRO_HAVE_NDIR_H)
#include <ndir.h>
#endif
#endif
#if !defined(S_IRGRP)
...
#define S_IXGRP (0)
#endif
#if defined(ALLEGRO_HAVE_SYS_TIME)
#include <sys/time.h>
#endif
#if defined(ALLEGRO_HAVE_TIME_H)
#include <time.h>
#endif
