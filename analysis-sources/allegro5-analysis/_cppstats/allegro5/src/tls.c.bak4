...
#define SETTER(name, value) { thread_local_state *tls; if ((tls = tls_get()) == NULL) return; tls->name = value; }
...
#define GETTER(name, value) { thread_local_state *tls; if ((tls = tls_get()) == NULL) return value; return tls->name; }
