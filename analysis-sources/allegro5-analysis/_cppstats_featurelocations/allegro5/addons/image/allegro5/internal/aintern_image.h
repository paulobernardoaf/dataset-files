#if !defined(__al_included_allegro_aintern_image_h)
...
#if defined(ALLEGRO_CFG_WANT_NATIVE_IMAGE_LOADER)
...
#if defined(ALLEGRO_CFG_IIO_HAVE_FREEIMAGE)
...
#if defined(ALLEGRO_CFG_IIO_HAVE_GDIPLUS)
...
#if defined(ALLEGRO_CFG_IIO_HAVE_ANDROID)
...
#if defined(ALLEGRO_CFG_IIO_HAVE_PNG)
...
#if defined(ALLEGRO_CFG_IIO_HAVE_JPG)
...
#if defined(ALLEGRO_CFG_IIO_HAVE_WEBP)
