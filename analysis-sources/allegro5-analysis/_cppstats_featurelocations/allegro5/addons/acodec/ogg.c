...
#if defined(ALLEGRO_CFG_ACODEC_VORBISFILE_DLL)
...
#define INITSYM(x) do { lib.x = _al_import_symbol(ov_dll, #x); if (lib.x == 0) { ALLEGRO_ERROR("undefined symbol in lib structure: " #x "\n"); return false; } } while(0)
