#if !defined(__al_included_allegro5_aintern_haptic_h)
...
#define _AL_BEGIN_HAPTIC_DRIVER_LIST const _AL_DRIVER_INFO _al_haptic_driver_list[] = {


#define _AL_END_HAPTIC_DRIVER_LIST { 0, NULL, false } };
