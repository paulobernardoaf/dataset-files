...
#define GET_DBGHELP_IMPORT(target, str) do { data->target = get_proc(data->dbghelp, str); if (!data->target) return false; } while (false)
...
#if defined(_WIN64)
#define SUCCESS_FORMAT "%016I64X %016I64X %016I64X %016I64X " "%016I64X %016I64X %s!%s+0x%I64x\r\n"
#define FAIL_FORMAT "%016I64X %016I64X %016I64X %016I64X " "%016I64X %016I64X %s!0x%I64x\r\n"
#else
#define SUCCESS_FORMAT "%08.8I64X %08.8I64X %08.8I64X %08.8I64X " "%08.8I64X %08.8I64X %s!%s+0x%I64x\r\n"
...
#if defined(_WIN64)
#define TRACE_TOP "Stack EIP Arg0 " "Arg1 Arg2 Arg3 Address\r\n"
#else
#define TRACE_TOP "Stack EIP Arg0 " "Arg1 Arg2 Arg3 Address\r\n"
#endif
