...
#else
#define simde_assert(expr) do { if (!HEDLEY_LIKELY(expr)) { simde_error("assertion failed: " #expr "\n"); } SIMDE__PUSH_DISABLE_MSVC_C4127 } while (0) SIMDE__POP_DISABLE_MSVC_C4127
#define simde_assert_true(expr) do { if (!HEDLEY_LIKELY(expr)) { simde_error("assertion failed: " #expr " is not true\n"); } SIMDE__PUSH_DISABLE_MSVC_C4127 } while (0) SIMDE__POP_DISABLE_MSVC_C4127
#define simde_assert_false(expr) do { if (!HEDLEY_LIKELY(!(expr))) { simde_error("assertion failed: " #expr " is not false\n"); } SIMDE__PUSH_DISABLE_MSVC_C4127 } while (0) SIMDE__POP_DISABLE_MSVC_C4127
#define simde_assert_type_full(prefix, suffix, T, fmt, a, op, b) do { T simde_tmp_a_ = (a); T simde_tmp_b_ = (b); if (!(simde_tmp_a_ op simde_tmp_b_)) { simde_errorf("assertion failed: %s %s %s (" prefix "%" fmt suffix " %s " prefix "%" fmt suffix ")\n", #a, #op, #b, simde_tmp_a_, #op, simde_tmp_b_); } SIMDE__PUSH_DISABLE_MSVC_C4127 } while (0) SIMDE__POP_DISABLE_MSVC_C4127
#define simde_assert_double_equal(a, b, precision) do { const double simde_tmp_a_ = (a); const double simde_tmp_b_ = (b); const double simde_tmp_diff_ = ((simde_tmp_a_ - simde_tmp_b_) < 0) ? -(simde_tmp_a_ - simde_tmp_b_) : (simde_tmp_a_ - simde_tmp_b_); if (HEDLEY_UNLIKELY(simde_tmp_diff_ > 1e-##precision)) { simde_errorf( "assertion failed: %s == %s (%0." #precision "g == %0." #precision "g)\n", #a, #b, simde_tmp_a_, simde_tmp_b_); } SIMDE__PUSH_DISABLE_MSVC_C4127 } while (0) SIMDE__POP_DISABLE_MSVC_C4127
#include <string.h>
#define simde_assert_string_equal(a, b) do { const char *simde_tmp_a_ = a; const char *simde_tmp_b_ = b; if (HEDLEY_UNLIKELY(strcmp(simde_tmp_a_, simde_tmp_b_) != 0)) { simde_errorf( "assertion failed: string %s == %s (\"%s\" == \"%s\")\n", #a, #b, simde_tmp_a_, simde_tmp_b_); } SIMDE__PUSH_DISABLE_MSVC_C4127 } while (0) SIMDE__POP_DISABLE_MSVC_C4127
#define simde_assert_string_not_equal(a, b) do { const char *simde_tmp_a_ = a; const char *simde_tmp_b_ = b; if (HEDLEY_UNLIKELY(strcmp(simde_tmp_a_, simde_tmp_b_) == 0)) { simde_errorf( "assertion failed: string %s != %s (\"%s\" == \"%s\")\n", #a, #b, simde_tmp_a_, simde_tmp_b_); } SIMDE__PUSH_DISABLE_MSVC_C4127 } while (0) SIMDE__POP_DISABLE_MSVC_C4127
#define simde_assert_memory_equal(size, a, b) do { const unsigned char *simde_tmp_a_ = (const unsigned char *)(a); const unsigned char *simde_tmp_b_ = (const unsigned char *)(b); const size_t simde_tmp_size_ = (size); if (HEDLEY_UNLIKELY(memcmp(simde_tmp_a_, simde_tmp_b_, simde_tmp_size_)) != 0) { size_t simde_tmp_pos_; for (simde_tmp_pos_ = 0; simde_tmp_pos_ < simde_tmp_size_; simde_tmp_pos_++) { if (simde_tmp_a_[simde_tmp_pos_] != simde_tmp_b_[simde_tmp_pos_]) { simde_errorf( "assertion failed: memory %s == %s, at offset %" SIMDE_SIZE_MODIFIER "u\n", #a, #b, simde_tmp_pos_); break; } } } SIMDE__PUSH_DISABLE_MSVC_C4127 } while (0) SIMDE__POP_DISABLE_MSVC_C4127
#define simde_assert_memory_not_equal(size, a, b) do { const unsigned char *simde_tmp_a_ = (const unsigned char *)(a); const unsigned char *simde_tmp_b_ = (const unsigned char *)(b); const size_t simde_tmp_size_ = (size); if (HEDLEY_UNLIKELY(memcmp(simde_tmp_a_, simde_tmp_b_, simde_tmp_size_)) == 0) { simde_errorf( "assertion failed: memory %s != %s (%" SIMDE_SIZE_MODIFIER "u bytes)\n", #a, #b, simde_tmp_size_); } SIMDE__PUSH_DISABLE_MSVC_C4127 } while (0) SIMDE__POP_DISABLE_MSVC_C4127
#endif
#define simde_assert_type(T, fmt, a, op, b) simde_assert_type_full("", "", T, fmt, a, op, b)
#define simde_assert_char(a, op, b) simde_assert_type_full("'\\x", "'", char, "02" SIMDE_CHAR_MODIFIER "x", a, op, b)
#define simde_assert_uchar(a, op, b) simde_assert_type_full("'\\x", "'", unsigned char, "02" SIMDE_CHAR_MODIFIER "x", a, op, b)
