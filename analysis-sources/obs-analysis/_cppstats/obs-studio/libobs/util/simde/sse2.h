...
#elif defined(SIMDE_SSE2_NEON)
#define simde_mm_bslli_si128(a, imm8) SIMDE__M128I_NEON_C( i8, (((imm8) <= 0) ? ((a).neon_i8) : (((imm8) > 15) ? (vdupq_n_s8(0)) : (vextq_s8(vdupq_n_s8(0), (a).neon_i8, 16 - (imm8))))))
#endif
...
#elif defined(SIMDE_SSE2_NEON)
#define simde_mm_bsrli_si128(a, imm8) SIMDE__M128I_NEON_C( i8, ((imm8) <= 0) ? ((a).neon_i8) : (((imm8) > 15) ? (vdupq_n_s8(0)) : (vextq_s8((a).neon_i8, vdupq_n_s8(0), (imm8)))))
#endif
...
vaddq_f32(a.neon_f32, half)); 
int32x4_t r_trunc =
vcvtq_s32_f32(a.neon_f32); 
int32x4_t plusone = vshrq_n_s32(vnegq_s32(r_trunc), 31); 
...
#define simde_mm_shuffle_epi32(a, imm8) ({ const simde__m128i simde__tmp_a_ = a; (simde__m128i){.i32 = SIMDE__SHUFFLE_VECTOR( 32, 16, (simde__tmp_a_).i32, (simde__tmp_a_).i32, ((imm8)) & 3, ((imm8) >> 2) & 3, ((imm8) >> 4) & 3, ((imm8) >> 6) & 3)}; })
#endif
SIMDE__FUNCTION_ATTRIBUTES
...
#elif defined(SIMDE__SHUFFLE_VECTOR)
#define simde_mm_shuffle_pd(a, b, imm8) ({ (simde__m128d){.f64 = SIMDE__SHUFFLE_VECTOR( 64, 16, (a).f64, (b).f64, (((imm8)) & 1), (((imm8) >> 1) & 1) + 2)}; })
#endif
SIMDE__FUNCTION_ATTRIBUTES
...
#elif defined(SIMDE__SHUFFLE_VECTOR)
#define simde_mm_shufflehi_epi16(a, imm8) ({ const simde__m128i simde__tmp_a_ = a; (simde__m128i){.i16 = SIMDE__SHUFFLE_VECTOR( 16, 16, (simde__tmp_a_).i16, (simde__tmp_a_).i16, 0, 1, 2, 3, (((imm8)) & 3) + 4, (((imm8) >> 2) & 3) + 4, (((imm8) >> 4) & 3) + 4, (((imm8) >> 6) & 3) + 4)}; })
#endif
SIMDE__FUNCTION_ATTRIBUTES
...
#elif defined(SIMDE__SHUFFLE_VECTOR)
#define simde_mm_shufflelo_epi16(a, imm8) ({ const simde__m128i simde__tmp_a_ = a; (simde__m128i){.i16 = SIMDE__SHUFFLE_VECTOR( 16, 16, (simde__tmp_a_).i16, (simde__tmp_a_).i16, (((imm8)) & 3), (((imm8) >> 2) & 3), (((imm8) >> 4) & 3), (((imm8) >> 6) & 3), 4, 5, 6, 7)}; })
#endif
SIMDE__FUNCTION_ATTRIBUTES
...
#elif defined(SIMDE_SSE2_NEON)
#define simde_mm_slli_epi16(a, imm8) SIMDE__M128I_NEON_C( i16, ((imm8) <= 0) ? ((a).neon_i16) : (((imm8) > 31) ? (vdupq_n_s16(0)) : (vshlq_n_s16((a).neon_i16, (imm8)))))
#endif
SIMDE__FUNCTION_ATTRIBUTES
...
#elif defined(SIMDE_SSE2_NEON)
#define simde_mm_slli_epi32(a, imm8) SIMDE__M128I_NEON_C( i32, ((imm8) <= 0) ? ((a).neon_i32) : (((imm8) > 31) ? (vdupq_n_s32(0)) : (vshlq_n_s32((a).neon_i32, (imm8)))))
#endif
SIMDE__FUNCTION_ATTRIBUTES
...
#elif defined(SIMDE_SSE2_NEON)
#define simde_mm_srli_epi16(a, imm8) SIMDE__M128I_NEON_C( u16, ((imm8) <= 0) ? ((a).neon_u16) : (((imm8) > 31) ? (vdupq_n_u16(0)) : (vshrq_n_u16((a).neon_u16, (imm8)))))
#endif
SIMDE__FUNCTION_ATTRIBUTES
...
#elif defined(SIMDE_SSE2_NEON)
#define simde_mm_srli_epi32(a, imm8) SIMDE__M128I_NEON_C( u32, ((imm8) <= 0) ? ((a).neon_u32) : (((imm8) > 31) ? (vdupq_n_u32(0)) : (vshrq_n_u32((a).neon_u32, (imm8)))))
#endif
SIMDE__FUNCTION_ATTRIBUTES
...
#elif defined(SIMDE_SSE2_NEON)
#define simde_mm_srli_epi64(a, imm8) SIMDE__M128I_NEON_C( u64, (((imm8)&255) < 0 || ((imm8)&255) > 63) ? (vdupq_n_u64(0)) : ((((imm8)&255) == 0) ? (a.neon_u64) : (vshrq_n_u64((a).neon_u64, (imm8)&255))))
#endif
SIMDE__FUNCTION_ATTRIBUTES
