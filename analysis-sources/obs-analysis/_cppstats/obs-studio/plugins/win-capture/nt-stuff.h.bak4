...
#define init_named_attribs(o, name) do { (o)->Length = sizeof(*(o)); (o)->ObjectName = name; (o)->RootDirectory = NULL; (o)->Attributes = 0; (o)->SecurityDescriptor = NULL; (o)->SecurityQualityOfService = NULL; } while (false)
