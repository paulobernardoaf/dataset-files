...
enum _BMDPacketType {
bmdPacketTypeStreamInterruptedMarker = 'sint', 
bmdPacketTypeStreamData = 'sdat' 
};
...
bmdDeckLinkHDMIInputEDIDDynamicRange = 'HIDy' 
};
typedef uint32_t BMDDeckLinkFrameMetadataID;
enum _BMDDeckLinkFrameMetadataID {
bmdDeckLinkFrameMetadataColorspace = 'cspc', 
bmdDeckLinkFrameMetadataHDRElectroOpticalTransferFunc = 'eotf', 
bmdDeckLinkFrameMetadataCintelFilmType = 'cfty', 
bmdDeckLinkFrameMetadataCintelFilmGauge = 'cfga', 
bmdDeckLinkFrameMetadataCintelOffsetDetectedHorizontal = 'odfh', 
bmdDeckLinkFrameMetadataCintelOffsetDetectedVertical = 'odfv', 
bmdDeckLinkFrameMetadataCintelKeykodeLow = 'ckkl', 
bmdDeckLinkFrameMetadataCintelKeykodeHigh = 'ckkh', 
bmdDeckLinkFrameMetadataCintelTile1Size = 'ct1s', 
bmdDeckLinkFrameMetadataCintelTile2Size = 'ct2s', 
bmdDeckLinkFrameMetadataCintelTile3Size = 'ct3s', 
bmdDeckLinkFrameMetadataCintelTile4Size = 'ct4s', 
bmdDeckLinkFrameMetadataCintelImageWidth = 'IWPx', 
bmdDeckLinkFrameMetadataCintelImageHeight = 'IHPx', 
bmdDeckLinkFrameMetadataCintelLinearMaskingRedInRed = 'mrir', 
bmdDeckLinkFrameMetadataCintelLinearMaskingGreenInRed = 'mgir', 
bmdDeckLinkFrameMetadataCintelLinearMaskingBlueInRed = 'mbir', 
bmdDeckLinkFrameMetadataCintelLinearMaskingRedInGreen = 'mrig', 
bmdDeckLinkFrameMetadataCintelLinearMaskingGreenInGreen = 'mgig', 
bmdDeckLinkFrameMetadataCintelLinearMaskingBlueInGreen = 'mbig', 
bmdDeckLinkFrameMetadataCintelLinearMaskingRedInBlue = 'mrib', 
bmdDeckLinkFrameMetadataCintelLinearMaskingGreenInBlue = 'mgib', 
bmdDeckLinkFrameMetadataCintelLinearMaskingBlueInBlue = 'mbib', 
bmdDeckLinkFrameMetadataCintelLogMaskingRedInRed = 'mlrr', 
bmdDeckLinkFrameMetadataCintelLogMaskingGreenInRed = 'mlgr', 
bmdDeckLinkFrameMetadataCintelLogMaskingBlueInRed = 'mlbr', 
bmdDeckLinkFrameMetadataCintelLogMaskingRedInGreen = 'mlrg', 
bmdDeckLinkFrameMetadataCintelLogMaskingGreenInGreen = 'mlgg', 
bmdDeckLinkFrameMetadataCintelLogMaskingBlueInGreen = 'mlbg', 
bmdDeckLinkFrameMetadataCintelLogMaskingRedInBlue = 'mlrb', 
bmdDeckLinkFrameMetadataCintelLogMaskingGreenInBlue = 'mlgb', 
bmdDeckLinkFrameMetadataCintelLogMaskingBlueInBlue = 'mlbb', 
bmdDeckLinkFrameMetadataCintelFilmFrameRate = 'cffr', 
bmdDeckLinkFrameMetadataHDRDisplayPrimariesRedX = 'hdrx', 
bmdDeckLinkFrameMetadataHDRDisplayPrimariesRedY = 'hdry', 
bmdDeckLinkFrameMetadataHDRDisplayPrimariesGreenX = 'hdgx', 
bmdDeckLinkFrameMetadataHDRDisplayPrimariesGreenY = 'hdgy', 
bmdDeckLinkFrameMetadataHDRDisplayPrimariesBlueX = 'hdbx', 
bmdDeckLinkFrameMetadataHDRDisplayPrimariesBlueY = 'hdby', 
bmdDeckLinkFrameMetadataHDRWhitePointX = 'hdwx', 
bmdDeckLinkFrameMetadataHDRWhitePointY = 'hdwy', 
bmdDeckLinkFrameMetadataHDRMaxDisplayMasteringLuminance = 'hdml', 
bmdDeckLinkFrameMetadataHDRMinDisplayMasteringLuminance = 'hmil', 
bmdDeckLinkFrameMetadataHDRMaximumContentLightLevel = 'mcll', 
bmdDeckLinkFrameMetadataHDRMaximumFrameAverageLightLevel = 'fall', 
bmdDeckLinkFrameMetadataCintelOffsetToApplyHorizontal = 'otah', 
bmdDeckLinkFrameMetadataCintelOffsetToApplyVertical = 'otav', 
bmdDeckLinkFrameMetadataCintelGainRed = 'LfRd', 
bmdDeckLinkFrameMetadataCintelGainGreen = 'LfGr', 
bmdDeckLinkFrameMetadataCintelGainBlue = 'LfBl', 
bmdDeckLinkFrameMetadataCintelLiftRed = 'GnRd', 
bmdDeckLinkFrameMetadataCintelLiftGreen = 'GnGr', 
bmdDeckLinkFrameMetadataCintelLiftBlue = 'GnBl' 
};
...
BMDDeckLinkDeviceInterface = 'dbus', 
...
virtual HRESULT GetString ( BMDDeckLinkFrameMetadataID metadataID, CFStringRef *value) = 0;
protected:
...
virtual HRESULT GetString ( BMDDeckLinkStatusID statusID, CFStringRef *value) = 0;
...
IDeckLinkCocoaScreenPreviewCallback* BMD_PUBLIC CreateCocoaScreenPreview (void* parentView);
