...
{
#define LOAD_VLC_FUNC(func) do { func##_ = os_dlsym(libvlc_module, #func); if (!func##_) { blog(LOG_WARNING, "Could not func VLC function %s, " "VLC loading failed", #func); return false; } } while (false)
