...
#define fail(msg) do { failhdr; fprintf(stderr, "%s\n", msg); exit(1); } while(0)
...
#define check_error(text_, source_, line_, column_, position_) check_errors(&text_, 1, source_, line_, column_, position_)
