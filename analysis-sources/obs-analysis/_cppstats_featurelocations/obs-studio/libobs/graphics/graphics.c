...
#define gs_valid_p3(func, param1, param2, param3) (gs_valid(func) && ptr_valid(param1, func) && ptr_valid(param2, func) && ptr_valid(param3, func))
...
#define DUP_VAL(val) do { if (data->val) new_data->val = bmemdup( data->val, sizeof(*data->val) * data->num); } while (false)
