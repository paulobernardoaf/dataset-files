...
#define my_dhm_P "E4004C1F94182000103D883A448B3F80" "2CE4B44A83301270002C20D0321CFD00" "11CCEF784C26A400F43DFB901BCA7538" "F2C6B176001CF5A0FD16D2C48B1D0C1C" "F6AC8E1DA6BCC3B4E1F96B0564965300" "FFA1D0B601EB2800F489AA512C4B248C" "01F76949A60BB7F00A40B1EAB64BDD48" "E8A700D60B7F1200FA8E77B0A979DABF"
...
#define TLS_client(ctx,s) s = malloc(sizeof(ssl_context)); ssl_init(s);ssl_set_endpoint(s, SSL_IS_CLIENT); ssl_set_authmode(s, SSL_VERIFY_NONE);ssl_set_rng(s, havege_random, &ctx->hs);ssl_set_ciphersuites(s, ssl_default_ciphersuites);SSL_SET_SESSION(s, 1, 600, &ctx->ssn)
...
#define RTMP_PUB_NAME 0x0001 
#define RTMP_PUB_RESP 0x0002 
#define RTMP_PUB_ALLOC 0x0004 
#define RTMP_PUB_CLEAN 0x0008 
#define RTMP_PUB_CLATE 0x0010 
int pFlags;
