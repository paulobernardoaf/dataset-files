...
#include <stdio.h>
#define debug(format, ...) do { char str[256]; snprintf(str, sizeof(str) - 1, "%s " format "\n", "[OBS graphics-hook]", ##__VA_ARGS__); OutputDebugStringA(str); } while (false)
