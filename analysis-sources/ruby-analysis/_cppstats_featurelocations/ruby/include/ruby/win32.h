...
#if defined(RUBY_MINGW64_BROKEN_FREXP_MODF)


#define frexp(_X, _Y) __extension__ ({int intpart_frexp_bug = intpart_frexp_bug;double result_frexp_bug = frexp((_X), &intpart_frexp_bug);*(_Y) = intpart_frexp_bug;result_frexp_bug;})
