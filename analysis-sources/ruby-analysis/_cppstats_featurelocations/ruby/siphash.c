...
#define U8TO64_LE(p) ((uint64_t)U8TO32_LE(p) | ((uint64_t)U8TO32_LE((p) + 4)) << 32 )
...
#define ROTL64_TO(v, s) ((s) > 32 ? rotl64_swap(rotl64_to(&(v), (s) - 32)) : (s) == 32 ? rotl64_swap(&(v)) : rotl64_to(&(v), (s)))
