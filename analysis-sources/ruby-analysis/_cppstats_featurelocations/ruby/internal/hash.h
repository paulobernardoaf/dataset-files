...
RHASH_PASS_AS_KEYWORDS = FL_USER1, 
RHASH_PROC_DEFAULT = FL_USER2, 
...
RHASH_TRANSIENT_FLAG = FL_USER12, 
#endif
...
#if defined(RHASH_IFNONE)
#undef RHASH_IFNONE
#endif

#if defined(RHASH_SIZE)
#undef RHASH_SIZE
#endif
