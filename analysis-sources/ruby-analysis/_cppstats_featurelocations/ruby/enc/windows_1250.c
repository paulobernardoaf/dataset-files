...
#define ENC_IS_CP1250_CTYPE(code,ctype) ((EncCP1250_CtypeTable[code] & CTYPE_TO_BIT(ctype)) != 0)
...
0x0284, 0x01a0, 0x00a0, 0x34a2, 0x00a0, 0x34a2, 0x00a0, 0x00a0,
0x00a0, 0x00a0, 0x34a2, 0x01a0, 0x00a0, 0x01a0, 0x00a0, 0x34a2,
0x00a0, 0x00a0, 0x10a0, 0x30e2, 0x00a0, 0x30e2, 0x00a0, 0x01a0,
