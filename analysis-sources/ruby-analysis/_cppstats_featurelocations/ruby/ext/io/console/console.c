...
VALUE vopts = Qnil;
#if defined(RB_SCAN_ARGS_PASS_CALLED_KEYWORDS)
...
#if defined(USE_CONSOLE_GETSIZE)
...
#endif
#if !defined(CONSOLE_DEVICE_FOR_READING)
#define CONSOLE_DEVICE_FOR_READING CONSOLE_DEVICE
#endif
#if defined(CONSOLE_DEVICE_FOR_WRITING)
VALUE out;
rb_io_t *ofptr;
#endif
int fd;
