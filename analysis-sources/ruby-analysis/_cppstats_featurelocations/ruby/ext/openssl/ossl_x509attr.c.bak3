...
#define SetX509Attr(obj, attr) do { if (!(attr)) { ossl_raise(rb_eRuntimeError, "ATTR wasn't initialized!"); } RTYPEDDATA_DATA(obj) = (attr); } while (0)





#define GetX509Attr(obj, attr) do { TypedData_Get_Struct((obj), X509_ATTRIBUTE, &ossl_x509attr_type, (attr)); if (!(attr)) { ossl_raise(rb_eRuntimeError, "ATTR wasn't initialized!"); } } while (0)
