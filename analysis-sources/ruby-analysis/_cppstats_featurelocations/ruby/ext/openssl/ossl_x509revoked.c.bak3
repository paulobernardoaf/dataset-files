...
#define SetX509Rev(obj, rev) do { if (!(rev)) { ossl_raise(rb_eRuntimeError, "REV wasn't initialized!"); } RTYPEDDATA_DATA(obj) = (rev); } while (0)





#define GetX509Rev(obj, rev) do { TypedData_Get_Struct((obj), X509_REVOKED, &ossl_x509rev_type, (rev)); if (!(rev)) { ossl_raise(rb_eRuntimeError, "REV wasn't initialized!"); } } while (0)
