...
#define CVAR_FOREACH_ANCESTORS(klass, v, r) for (klass = cvar_front_klass(klass); klass; klass = RCLASS_SUPER(klass)) { if (cvar_lookup_at(klass, id, (v))) { r; } }
...
#define CVAR_LOOKUP(v,r) do {if (cvar_lookup_at(klass, id, (v))) {r;}CVAR_FOREACH_ANCESTORS(klass, v, r);} while(0)
