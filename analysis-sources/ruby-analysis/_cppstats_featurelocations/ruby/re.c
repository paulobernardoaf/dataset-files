...
#define NAME_TO_NUMBER(regs, re, name, name_ptr, name_end) (NIL_P(re) ? 0 : !rb_enc_compatible(RREGEXP_SRC(re), (name)) ? 0 : name_to_backref_number((regs), (re), (name_ptr), (name_end)))
