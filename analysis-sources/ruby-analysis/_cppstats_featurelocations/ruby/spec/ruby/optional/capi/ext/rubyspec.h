...
#define RUBY_VERSION_BEFORE(major,minor,teeny) ((RUBY_VERSION_MAJOR < (major)) || (RUBY_VERSION_MAJOR == (major) && RUBY_VERSION_MINOR < (minor)) || (RUBY_VERSION_MAJOR == (major) && RUBY_VERSION_MINOR == (minor) && RUBY_VERSION_TEENY < (teeny)))
