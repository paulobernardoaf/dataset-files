...
\tDirectory \"%.*s\"%s\n\tFile \"%.*s\"%s\n";
#define PATHNAME_TOO_LONG() dln_warning(dln_warning_arg pathname_too_long, ((bp - fbuf) > 100 ? 100 : (int)(bp - fbuf)), fbuf, ((bp - fbuf) > 100 ? "..." : ""), (fnlen > 100 ? 100 : (int)fnlen), fname, (fnlen > 100 ? "..." : ""))
