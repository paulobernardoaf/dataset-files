...
#define rb_id2sym(id) RB_GNUC_EXTENSION_BLOCK(__builtin_constant_p(id) && !DYNAMIC_ID_P(id) ? STATIC_ID2SYM(id) : rb_id2sym(id))
...
static const uint32_t RB_ID_SERIAL_MAX = 
UINT32_MAX >>
