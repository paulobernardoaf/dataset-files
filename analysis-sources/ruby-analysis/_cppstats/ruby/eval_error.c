...
#if defined(HAVE_BUILTIN___BUILTIN_CONSTANT_P)
#define warn_print(x) RB_GNUC_EXTENSION_BLOCK( (__builtin_constant_p(x)) ? rb_write_error2((x), (long)strlen(x)) : rb_write_error(x) )
#else
...
#define undef_mesg(v) ( is_mod ? undef_mesg_for(v, "module") : undef_mesg_for(v, "class"))
void
...
#define inaccessible_mesg(v) ( is_mod ? inaccessible_mesg_for(v, "module") : inaccessible_mesg_for(v, "class"))
void
