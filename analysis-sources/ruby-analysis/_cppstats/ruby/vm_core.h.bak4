...
#if !defined(VM_INSN_INFO_TABLE_IMPL)
...
#if !defined(VM_DEBUG_BP_CHECK)
#define VM_DEBUG_BP_CHECK 0
#endif

#if !defined(VM_DEBUG_VERIFY_METHOD_CACHE)
...
#if !defined(rb_execution_context_t)
