...
enum imemo_type cref_or_me_type = imemo_env; 
...
VM_ASSERT(vm_cc_cme(cc) == NULL || 
(vm_ci_flag(cd->ci) & VM_CALL_SUPER) || 
...
cd.ci = vm_ci_new_runtime(mid, new_flag, 0 , vm_ci_kwarg(orig_cd->ci));
struct rb_callcache cc_body;
