...
#if !defined(SIZEOF_ACTUAL_BDIGIT)
#define SIZEOF_ACTUAL_BDIGIT SIZEOF_BDIGIT
#endif

#if defined(PRI_BDIGIT_PREFIX)
...
#if defined(PRI_BDIGIT_DBL_PREFIX)
...
#if !defined(BIGNUM_EMBED_LEN_MAX)
