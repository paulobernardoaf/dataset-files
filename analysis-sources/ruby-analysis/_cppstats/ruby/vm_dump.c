...
#define VM_CFP_CNT(ec, cfp) ((rb_control_frame_t *)((ec)->vm_stack + (ec)->vm_stack_size) - (rb_control_frame_t *)(cfp))
...
#endif
#endif
#if defined(HAVE_PRINT_MACHINE_REGISTERS)
static int
