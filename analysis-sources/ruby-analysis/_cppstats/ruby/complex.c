...
#define fun1(n) inline static VALUE f_##n(VALUE x){return rb_funcall(x, id_##n, 0);}
#define fun2(n) inline static VALUE f_##n(VALUE x, VALUE y){return rb_funcall(x, id_##n, 1, y);}
...
#if defined(CANONICALIZATION_FOR_MATHN)
...
#define imp1(n) inline static VALUE m_##n##_bang(VALUE x){return rb_math_##n(x);}
imp1(cos)
imp1(cosh)
imp1(exp)
static VALUE
