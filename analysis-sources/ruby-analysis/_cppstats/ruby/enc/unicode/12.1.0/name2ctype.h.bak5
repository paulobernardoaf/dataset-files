...
#if defined(USE_UNICODE_AGE_PROPERTIES)
...
#if defined ONIG_UNICODE_VERSION_STRING && !( ONIG_UNICODE_VERSION_MAJOR == 12 && ONIG_UNICODE_VERSION_MINOR == 1 && ONIG_UNICODE_VERSION_TEENY == 0 && 1)
...
#if defined ONIG_UNICODE_EMOJI_VERSION_STRING && !( ONIG_UNICODE_EMOJI_VERSION_MAJOR == 12 && ONIG_UNICODE_EMOJI_VERSION_MINOR == 0 && 1)
