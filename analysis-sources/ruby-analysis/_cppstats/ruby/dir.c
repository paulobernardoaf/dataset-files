...
#define O_CLOEXEC 0
#endif
#if !defined(USE_OPENDIR_AT)
#if defined(HAVE_FDOPENDIR) && defined(HAVE_DIRFD) && defined(HAVE_OPENAT) && defined(HAVE_FSTATAT)
...
#include <sys/attr.h>
#endif
#define USE_NAME_ON_FS_REAL_BASENAME 1 
#define USE_NAME_ON_FS_BY_FNMATCH 2 
