...
#define X509_REVOKED_dup(rev) (X509_REVOKED *)ASN1_dup((i2d_of_void *)i2d_X509_REVOKED, (d2i_of_void *)d2i_X509_REVOKED, (char *)(rev))
#endif
...
#define TS_RESP_CTX_set_time_cb(ctx, callback, dta) do { (ctx)->time_cb = (callback); (ctx)->time_cb_data = (dta); } while (0)
#endif
