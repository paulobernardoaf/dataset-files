...
#define SetX509Req(obj, req) do { if (!(req)) { ossl_raise(rb_eRuntimeError, "Req wasn't initialized!"); } RTYPEDDATA_DATA(obj) = (req); } while (0)





#define GetX509Req(obj, req) do { TypedData_Get_Struct((obj), X509_REQ, &ossl_x509req_type, (req)); if (!(req)) { ossl_raise(rb_eRuntimeError, "Req wasn't initialized!"); } } while (0)
