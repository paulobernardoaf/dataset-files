...
#undef getnameinfo
#define getnameinfo(sa, salen, host, hostlen, serv, servlen, flags) ruby_getnameinfo__aix((sa), (salen), (host), (hostlen), (serv), (servlen), (flags))
...
rb_define_method(rb_cAddrinfo, "to_s", addrinfo_to_sockaddr, 0); 
