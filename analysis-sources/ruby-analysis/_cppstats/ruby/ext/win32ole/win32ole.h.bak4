#if !defined(WIN32OLE_H)
#define WIN32OLE_H 1
#include "ruby/ruby.h"
#include "ruby/st.h"
#include "ruby/encoding.h"

#define GNUC_OLDER_3_4_4 ((__GNUC__ < 3) || ((__GNUC__ <= 3) && (__GNUC_MINOR__ < 4)) || ((__GNUC__ <= 3) && (__GNUC_MINOR__ <= 4) && (__GNUC_PATCHLEVEL__ <= 4)))
...
#define OLE_FREE(x) {if(ole_initialized() == TRUE) {if(x) {OLE_RELEASE(x);(x) = 0;}}}
