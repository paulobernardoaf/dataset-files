...
#define REGCOMP(pat,opt) do { if (NIL_P(pat)) pat = regcomp(pat##_source, sizeof pat##_source - 1, opt); } while (0)
...
#define MATCH(s,p,c) do { return match(s, p, hash, c); } while (0)
...
#define SUBS(s,p,c) do { return subx(s, asp_string(), p, hash, c); } while (0)




#if defined(TIGHT_PARSER)
#define SUBA(s,p,c) do { return subx(s, asuba_string(), p, hash, c); } while (0)




#define SUBB(s,p,c) do { return subx(s, asubb_string(), p, hash, c); } while (0)




#define SUBW(s,p,c) do { return subx(s, asubw_string(), p, hash, c); } while (0)




#define SUBT(s,p,c) do { return subx(s, asubt_string(), p, hash, c); } while (0)
...
{
if (parse_era1(str, hash)) 
goto ok;
if (parse_era2(str, hash)) 
goto ok;
return 0;
ok:
return 1;
