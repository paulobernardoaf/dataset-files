...
#define fail() do { set_hash("_fail", Qtrue); return 0; } while (0)
...
#define READ_DIGITS(n,w) do { size_t l; l = read_digits(&str[si], &n, w); if (l == 0) fail(); si += l; } while (0)
...
#define recur(fmt) do { size_t l; l = date__strptime_internal(&str[si], slen - si, fmt, sizeof fmt - 1, hash); if (fail_p()) return 0; si += l; } while (0)
