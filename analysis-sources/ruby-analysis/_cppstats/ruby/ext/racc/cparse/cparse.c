...
#define REDUCE(v,act) do {switch (reduce(v,act)) { case 0: break; case 1: goto user_yyerror; case 2: D_puts("u accept"); goto accept; default: break; } } while (0)
static void
