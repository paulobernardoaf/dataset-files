...
#if !defined(COMPAT_ATOMICS_PTHREAD_STDATOMIC_H)
...
#define FETCH_MODIFY(opname, op) static inline intptr_t atomic_fetch_ ##opname(intptr_t *object, intptr_t operand) { intptr_t ret; avpriv_atomic_lock(); ret = *object; *object = *object op operand; avpriv_atomic_unlock(); return ret; }
