...
#define atomic_store(object, desired) do { *(object) = (desired); } while (0)
...
#define FETCH_MODIFY(opname, op) static inline intptr_t atomic_fetch_ ##opname(intptr_t *object, intptr_t operand) { intptr_t ret; ret = *object; *object = *object op operand; return ret; }
