...
#if defined(TEMPLATE_PP_C)
#define RENAME(a) a ##_C
#else
#define TEMPLATE_PP_C 0
#endif
#if defined(TEMPLATE_PP_ALTIVEC)
#define RENAME(a) a ##_altivec
#else
#define TEMPLATE_PP_ALTIVEC 0
#endif
#if defined(TEMPLATE_PP_MMX)
#define RENAME(a) a ##_MMX
#else
#define TEMPLATE_PP_MMX 0
#endif
#if defined(TEMPLATE_PP_MMXEXT)
...
#define PMINUB(b,a,t) "movq " #a ", " #t " \n\t""psubusb " #b ", " #t " \n\t""psubb " #t ", " #a " \n\t"
#endif
#if TEMPLATE_PP_MMXEXT
#define PMAXUB(a,b) "pmaxub " #a ", " #b " \n\t"
#elif TEMPLATE_PP_MMX
#define PMAXUB(a,b) "psubusb " #a ", " #b " \n\t""paddb " #a ", " #b " \n\t"
#endif
#if TEMPLATE_PP_MMX
...
#undef FIND_MIN_MAX
#if TEMPLATE_PP_MMXEXT
#define REAL_FIND_MIN_MAX(addr)"movq " #addr ", %%mm0 \n\t""pminub %%mm0, %%mm7 \n\t""pmaxub %%mm0, %%mm6 \n\t"
#else
#define REAL_FIND_MIN_MAX(addr)"movq " #addr ", %%mm0 \n\t""movq %%mm7, %%mm1 \n\t""psubusb %%mm0, %%mm6 \n\t""paddb %%mm0, %%mm6 \n\t""psubusb %%mm0, %%mm1 \n\t""psubb %%mm1, %%mm7 \n\t"
#endif
...
f= (f + 8)>>4;
#if defined(DEBUG_DERING_THRESHOLD)
...
int x,y;
#if defined(TEMPLATE_PP_TIME_MODE)
