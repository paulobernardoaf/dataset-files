...
#define DEFINE_SHA(bits) static av_cold void sha ##bits ##_init(void *ctx) { av_sha_init(ctx, bits); }
#define DEFINE_SHA512(bits) static av_cold void sha ##bits ##_init(void *ctx) { av_sha512_init(ctx, bits); }
DEFINE_SHA(160)
DEFINE_SHA(224)
DEFINE_SHA(256)
DEFINE_SHA512(384)
