...
#else
#define DSTEP(SUM, K0, K1) v1 -= (((v0 << 4) ^ (v0 >> 5)) + v0) ^ (SUM + K0); v0 -= (((v1 << 4) ^ (v1 >> 5)) + v1) ^ (SUM - 0x9E3779B9U + K1)
...
#else
#define ESTEP(SUM, K0, K1) v0 += (((v1 << 4) ^ (v1 >> 5)) + v1) ^ (SUM + K0);v1 += (((v0 << 4) ^ (v0 >> 5)) + v0) ^ (SUM + 0x9E3779B9U + K1)
