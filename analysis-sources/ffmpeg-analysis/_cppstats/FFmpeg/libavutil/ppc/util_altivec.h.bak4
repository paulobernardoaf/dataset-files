...
#if !defined(AVUTIL_PPC_UTIL_ALTIVEC_H)
...
#if HAVE_BIGENDIAN
#define VEC_LD(offset,b) vec_perm(vec_ld(offset, b), vec_ld((offset)+15, b), vec_lvsl(offset, b))

#else
#define VEC_LD(offset,b) vec_vsx_ld(offset, b)
...
#if HAVE_VSX
#if HAVE_BIGENDIAN
#define vsx_ld_u8_s16(off, p) ((vec_s16)vec_mergeh((vec_u8)vec_splat_u8(0), (vec_u8)vec_vsx_ld((off), (p))))


#else
#define vsx_ld_u8_s16(off, p) ((vec_s16)vec_mergeh((vec_u8)vec_vsx_ld((off), (p)), (vec_u8)vec_splat_u8(0)))
