...
#define MULTI_CAPS_FUNC(flag, cap) if (EXTERNAL_##flag(mm_flags)) {if( out_fmt == AV_SAMPLE_FMT_S32 && in_fmt == AV_SAMPLE_FMT_S16 || out_fmt == AV_SAMPLE_FMT_S32P && in_fmt == AV_SAMPLE_FMT_S16P)ac->simd_f = ff_int16_to_int32_a_ ##cap;if( out_fmt == AV_SAMPLE_FMT_S16 && in_fmt == AV_SAMPLE_FMT_S32 || out_fmt == AV_SAMPLE_FMT_S16P && in_fmt == AV_SAMPLE_FMT_S32P)ac->simd_f = ff_int32_to_int16_a_ ##cap;}
