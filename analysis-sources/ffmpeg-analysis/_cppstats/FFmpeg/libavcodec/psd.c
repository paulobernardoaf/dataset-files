...
return ret;
s->pixel_size = s->channel_depth >> 3;
...
if ((avctx->pix_fmt == AV_PIX_FMT_YA8)||(avctx->pix_fmt == AV_PIX_FMT_YA16BE)){
ptr = picture->data[0];
