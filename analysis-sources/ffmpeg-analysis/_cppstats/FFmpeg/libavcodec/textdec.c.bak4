...
#define DECLARE_CLASS(decname) static const AVClass decname ##_decoder_class = { .class_name = #decname " decoder", .item_name = av_default_item_name, .option = decname ##_options, .version = LIBAVUTIL_VERSION_INT, }
