...
#define profile_compatible(x) (current->general_profile_idc == (x) || current->general_profile_compatibility_flag[x])
...
#define profile_compatible(x) (current->sub_layer_profile_idc[i] == (x) || current->sub_layer_profile_compatibility_flag[i][x])
...
#define SEI_TYPE_N(type, prefix_valid, suffix_valid, name) case HEVC_SEI_TYPE_ ##type: SEI_TYPE_CHECK_VALID(name, prefix_valid, suffix_valid); CHECK(FUNC(sei_ ##name)(ctx, rw, &current->payload.name)); break




#define SEI_TYPE_S(type, prefix_valid, suffix_valid, name) case HEVC_SEI_TYPE_ ##type: SEI_TYPE_CHECK_VALID(name, prefix_valid, suffix_valid); CHECK(FUNC(sei_ ##name)(ctx, rw, &current->payload.name, &current->payload_size)); break
