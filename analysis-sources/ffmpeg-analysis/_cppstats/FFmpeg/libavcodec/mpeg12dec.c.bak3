...
#define check_scantable_index(ctx, x) do { if ((x) > MAX_INDEX) { av_log(ctx->avctx, AV_LOG_ERROR, "ac-tex damaged at %d %d\n", ctx->mb_x, ctx->mb_y); return AVERROR_INVALIDDATA; } } while (0)
