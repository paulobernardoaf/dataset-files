...
#define hadamard_func(cpu) int ff_hadamard8_diff_ ##cpu(MpegEncContext *s, uint8_t *src1, uint8_t *src2, ptrdiff_t stride, int h); int ff_hadamard8_diff16_ ##cpu(MpegEncContext *s, uint8_t *src1, uint8_t *src2, ptrdiff_t stride, int h);
...
#define SUM(in0, in1, out0, out1) "movq (%0), %%mm2\n" "movq 8(%0), %%mm3\n" "add %2,%0\n" "movq %%mm2, " #out0 "\n" "movq %%mm3, " #out1 "\n" "psubusb " #in0 ", %%mm2\n" "psubusb " #in1 ", %%mm3\n" "psubusb " #out0 ", " #in0 "\n" "psubusb " #out1 ", " #in1 "\n" "por %%mm2, " #in0 "\n" "por %%mm3, " #in1 "\n" "movq " #in0 ", %%mm2\n" "movq " #in1 ", %%mm3\n" "punpcklbw %%mm7, " #in0 "\n" "punpcklbw %%mm7, " #in1 "\n" "punpckhbw %%mm7, %%mm2\n" "punpckhbw %%mm7, %%mm3\n" "paddw " #in1 ", " #in0 "\n" "paddw %%mm3, %%mm2\n" "paddw %%mm2, " #in0 "\n" "paddw " #in0 ", %%mm6\n"
