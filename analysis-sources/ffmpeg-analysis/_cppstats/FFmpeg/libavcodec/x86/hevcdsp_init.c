...
#define LFC_FUNCS(type, depth, opt) LFC_FUNC(h, depth, opt) LFC_FUNC(v, depth, opt)
#define LFL_FUNCS(type, depth, opt) LFL_FUNC(h, depth, opt) LFL_FUNC(v, depth, opt)
...
#define IDCT_DC_FUNCS(W, opt) void ff_hevc_idct_ ##W ##_dc_8_ ##opt(int16_t *coeffs); void ff_hevc_idct_ ##W ##_dc_10_ ##opt(int16_t *coeffs); void ff_hevc_idct_ ##W ##_dc_12_ ##opt(int16_t *coeffs)
...
#define mc_rep_funcs(name, bitd, step, W, opt) mc_rep_func(name, bitd, step, W, opt) mc_rep_uni_func(name, bitd, step, W, opt) mc_rep_bi_func(name, bitd, step, W, opt)
#define mc_rep_func2(name, bitd, step1, step2, W, opt) void ff_hevc_put_hevc_##name##W##_##bitd##_##opt(int16_t *dst, uint8_t *src, ptrdiff_t _srcstride, int height, intptr_t mx, intptr_t my, int width) { ff_hevc_put_hevc_##name##step1##_##bitd##_##opt(dst, src, _srcstride, height, mx, my, width); ff_hevc_put_hevc_##name##step2##_##bitd##_##opt(dst + step1, src + (step1 * ((bitd + 7) / 8)), _srcstride, height, mx, my, width); }
#define mc_rep_uni_func2(name, bitd, step1, step2, W, opt) void ff_hevc_put_hevc_uni_##name##W##_##bitd##_##opt(uint8_t *dst, ptrdiff_t dststride, uint8_t *src, ptrdiff_t _srcstride, int height, intptr_t mx, intptr_t my, int width) { ff_hevc_put_hevc_uni_##name##step1##_##bitd##_##opt(dst, dststride, src, _srcstride, height, mx, my, width);ff_hevc_put_hevc_uni_##name##step2##_##bitd##_##opt(dst + (step1 * ((bitd + 7) / 8)), dststride, src + (step1 * ((bitd + 7) / 8)), _srcstride, height, mx, my, width); }
#define mc_rep_bi_func2(name, bitd, step1, step2, W, opt) void ff_hevc_put_hevc_bi_##name##W##_##bitd##_##opt(uint8_t *dst, ptrdiff_t dststride, uint8_t *src, ptrdiff_t _srcstride, int16_t* src2, int height, intptr_t mx, intptr_t my, int width) { ff_hevc_put_hevc_bi_##name##step1##_##bitd##_##opt(dst, dststride, src, _srcstride, src2, height, mx, my, width);ff_hevc_put_hevc_bi_##name##step2##_##bitd##_##opt(dst + (step1 * ((bitd + 7) / 8)), dststride, src + (step1 * ((bitd + 7) / 8)), _srcstride, src2 + step1, height, mx, my, width); }
#define mc_rep_funcs2(name, bitd, step1, step2, W, opt) mc_rep_func2(name, bitd, step1, step2, W, opt) mc_rep_uni_func2(name, bitd, step1, step2, W, opt) mc_rep_bi_func2(name, bitd, step1, step2, W, opt)
#if ARCH_X86_64 && HAVE_SSE4_EXTERNAL
#define mc_rep_mix_10(name, width1, width2, width3, opt1, opt2, width4) void ff_hevc_put_hevc_##name##width1##_10_##opt1(int16_t *dst, uint8_t *src, ptrdiff_t _srcstride, int height, intptr_t mx, intptr_t my, int width) { ff_hevc_put_hevc_##name##width2##_10_##opt1(dst, src, _srcstride, height, mx, my, width); ff_hevc_put_hevc_##name##width3##_10_##opt2(dst+ width2, src+ width4, _srcstride, height, mx, my, width); }
#define mc_bi_rep_mix_10(name, width1, width2, width3, opt1, opt2, width4) void ff_hevc_put_hevc_bi_##name##width1##_10_##opt1(uint8_t *dst, ptrdiff_t dststride, uint8_t *src, ptrdiff_t _srcstride, int16_t *src2, int height, intptr_t mx, intptr_t my, int width) { ff_hevc_put_hevc_bi_##name##width2##_10_##opt1(dst, dststride, src, _srcstride, src2, height, mx, my, width); ff_hevc_put_hevc_bi_##name##width3##_10_##opt2(dst+width4, dststride, src+width4, _srcstride, src2+width2,height, mx, my, width); }
#define mc_uni_rep_mix_10(name, width1, width2, width3, opt1, opt2, width4) void ff_hevc_put_hevc_uni_##name##width1##_10_##opt1(uint8_t *dst, ptrdiff_t dststride, uint8_t *src, ptrdiff_t _srcstride, int height, intptr_t mx, intptr_t my, int width) { ff_hevc_put_hevc_uni_##name##width2##_10_##opt1(dst, dststride, src, _srcstride, height, mx, my, width); ff_hevc_put_hevc_uni_##name##width3##_10_##opt2(dst+width4, dststride, src+width4, _srcstride, height, mx, my, width); }
#define mc_rep_mixs_10(name, width1, width2, width3, opt1, opt2, width4) mc_rep_mix_10(name, width1, width2, width3, opt1, opt2, width4) mc_bi_rep_mix_10(name, width1, width2, width3, opt1, opt2, width4) mc_uni_rep_mix_10(name, width1, width2, width3, opt1, opt2, width4)
#define mc_rep_mix_8(name, width1, width2, width3, opt1, opt2) void ff_hevc_put_hevc_##name##width1##_8_##opt1(int16_t *dst, uint8_t *src, ptrdiff_t _srcstride, int height, intptr_t mx, intptr_t my, int width) { ff_hevc_put_hevc_##name##width2##_8_##opt1(dst, src, _srcstride, height, mx, my, width); ff_hevc_put_hevc_##name##width3##_8_##opt2(dst+ width2, src+ width2, _srcstride, height, mx, my, width); }
#define mc_bi_rep_mix_8(name, width1, width2, width3, opt1, opt2) void ff_hevc_put_hevc_bi_##name##width1##_8_##opt1(uint8_t *dst, ptrdiff_t dststride, uint8_t *src, ptrdiff_t _srcstride, int16_t* src2, int height, intptr_t mx, intptr_t my, int width) { ff_hevc_put_hevc_bi_##name##width2##_8_##opt1(dst, dststride, src, _srcstride, src2, height, mx, my, width); ff_hevc_put_hevc_bi_##name##width3##_8_##opt2(dst+width2, dststride, src+width2, _srcstride, src2+width2, height, mx, my, width); }
#define mc_uni_rep_mix_8(name, width1, width2, width3, opt1, opt2) void ff_hevc_put_hevc_uni_##name##width1##_8_##opt1(uint8_t *dst, ptrdiff_t dststride, uint8_t *src, ptrdiff_t _srcstride, int height, intptr_t mx, intptr_t my, int width) { ff_hevc_put_hevc_uni_##name##width2##_8_##opt1(dst, dststride, src, _srcstride, height, mx, my, width); ff_hevc_put_hevc_uni_##name##width3##_8_##opt2(dst+width2, dststride, src+width2, _srcstride, height, mx, my, width); }
#define mc_rep_mixs_8(name, width1, width2, width3, opt1, opt2) mc_rep_mix_8(name, width1, width2, width3, opt1, opt2) mc_bi_rep_mix_8(name, width1, width2, width3, opt1, opt2) mc_uni_rep_mix_8(name, width1, width2, width3, opt1, opt2)
...
#define mc_uni_w_funcs(name, bitd, opt) mc_uni_w_func(name, bitd, 4, opt) mc_uni_w_func(name, bitd, 8, opt) mc_uni_w_func(name, bitd, 12, opt) mc_uni_w_func(name, bitd, 16, opt) mc_uni_w_func(name, bitd, 24, opt) mc_uni_w_func(name, bitd, 32, opt) mc_uni_w_func(name, bitd, 48, opt) mc_uni_w_func(name, bitd, 64, opt)
...
#define mc_bi_w_func(name, bitd, W, opt) void ff_hevc_put_hevc_bi_w_##name##W##_##bitd##_##opt(uint8_t *_dst, ptrdiff_t _dststride, uint8_t *_src, ptrdiff_t _srcstride, int16_t *_src2, int height, int denom, int _wx0, int _wx1, int _ox0, int _ox1, intptr_t mx, intptr_t my, int width) { LOCAL_ALIGNED_16(int16_t, temp, [71 * MAX_PB_SIZE]); ff_hevc_put_hevc_##name##W##_##bitd##_##opt(temp, _src, _srcstride, height, mx, my, width); ff_hevc_put_hevc_bi_w##W##_##bitd##_##opt(_dst, _dststride, temp, _src2, height, denom, _wx0, _wx1, _ox0, _ox1); }
#define mc_bi_w_funcs(name, bitd, opt) mc_bi_w_func(name, bitd, 4, opt) mc_bi_w_func(name, bitd, 8, opt) mc_bi_w_func(name, bitd, 12, opt) mc_bi_w_func(name, bitd, 16, opt) mc_bi_w_func(name, bitd, 24, opt) mc_bi_w_func(name, bitd, 32, opt) mc_bi_w_func(name, bitd, 48, opt) mc_bi_w_func(name, bitd, 64, opt)
...
#define SAO_EDGE_INIT(bitd, opt) do { c->sao_edge_filter[0] = ff_hevc_sao_edge_filter_8_##bitd##_##opt; c->sao_edge_filter[1] = ff_hevc_sao_edge_filter_16_##bitd##_##opt; c->sao_edge_filter[2] = ff_hevc_sao_edge_filter_32_##bitd##_##opt; c->sao_edge_filter[3] = ff_hevc_sao_edge_filter_48_##bitd##_##opt; c->sao_edge_filter[4] = ff_hevc_sao_edge_filter_64_##bitd##_##opt; } while (0)
#define EPEL_LINKS(pointer, my, mx, fname, bitd, opt ) PEL_LINK(pointer, 1, my , mx , fname##4 , bitd, opt ); PEL_LINK(pointer, 2, my , mx , fname##6 , bitd, opt ); PEL_LINK(pointer, 3, my , mx , fname##8 , bitd, opt ); PEL_LINK(pointer, 4, my , mx , fname##12, bitd, opt ); PEL_LINK(pointer, 5, my , mx , fname##16, bitd, opt ); PEL_LINK(pointer, 6, my , mx , fname##24, bitd, opt ); PEL_LINK(pointer, 7, my , mx , fname##32, bitd, opt ); PEL_LINK(pointer, 8, my , mx , fname##48, bitd, opt ); PEL_LINK(pointer, 9, my , mx , fname##64, bitd, opt )
#define QPEL_LINKS(pointer, my, mx, fname, bitd, opt) PEL_LINK(pointer, 1, my , mx , fname##4 , bitd, opt ); PEL_LINK(pointer, 3, my , mx , fname##8 , bitd, opt ); PEL_LINK(pointer, 4, my , mx , fname##12, bitd, opt ); PEL_LINK(pointer, 5, my , mx , fname##16, bitd, opt ); PEL_LINK(pointer, 6, my , mx , fname##24, bitd, opt ); PEL_LINK(pointer, 7, my , mx , fname##32, bitd, opt ); PEL_LINK(pointer, 8, my , mx , fname##48, bitd, opt ); PEL_LINK(pointer, 9, my , mx , fname##64, bitd, opt )
