...
#if !defined(AVCODEC_X86_HEVCDSP_H)
...
#define QPEL_PROTOTYPES(fname, bitd, opt) PEL_PROTOTYPE(fname##4, bitd, opt); PEL_PROTOTYPE(fname##8, bitd, opt); PEL_PROTOTYPE(fname##12, bitd, opt); PEL_PROTOTYPE(fname##16, bitd, opt); PEL_PROTOTYPE(fname##24, bitd, opt); PEL_PROTOTYPE(fname##32, bitd, opt); PEL_PROTOTYPE(fname##48, bitd, opt); PEL_PROTOTYPE(fname##64, bitd, opt)
...
#define WEIGHTING_PROTOTYPE(width, bitd, opt) void ff_hevc_put_hevc_uni_w##width##_##bitd##_##opt(uint8_t *dst, ptrdiff_t dststride, int16_t *_src, int height, int denom, int _wx, int _ox); void ff_hevc_put_hevc_bi_w##width##_##bitd##_##opt(uint8_t *dst, ptrdiff_t dststride, int16_t *_src, int16_t *_src2, int height, int denom, int _wx0, int _wx1, int _ox0, int _ox1)



#define WEIGHTING_PROTOTYPES(bitd, opt) WEIGHTING_PROTOTYPE(2, bitd, opt); WEIGHTING_PROTOTYPE(4, bitd, opt); WEIGHTING_PROTOTYPE(6, bitd, opt); WEIGHTING_PROTOTYPE(8, bitd, opt); WEIGHTING_PROTOTYPE(12, bitd, opt); WEIGHTING_PROTOTYPE(16, bitd, opt); WEIGHTING_PROTOTYPE(24, bitd, opt); WEIGHTING_PROTOTYPE(32, bitd, opt); WEIGHTING_PROTOTYPE(48, bitd, opt); WEIGHTING_PROTOTYPE(64, bitd, opt)
