...
#define MM "%%xmm"
#define MOVQ "movdqa"
#define SPREADW(a) "pshuflw $0, "a", "a" \n\t""punpcklwd "a", "a" \n\t"
...
#else
#define SPREADW(a) "punpcklwd "a", "a" \n\t""punpcklwd "a", "a" \n\t"
...
#define SAVE_SIGN(a,b) "movdqa "b", "a" \n\t""pabsw "b", "b" \n\t"


#define RESTORE_SIGN(a,b) "psignw "a", "b" \n\t"

#else
#define SAVE_SIGN(a,b) "pxor "a", "a" \n\t""pcmpgtw "b", "a" \n\t" /* block[i] <= 0 ? 0xFF : 0x00 */"pxor "a", "b" \n\t""psubw "a", "b" \n\t" /* ABS(block[i]) */




#define RESTORE_SIGN(a,b) "pxor "a", "b" \n\t""psubw "a", "b" \n\t" // out=((ABS(block[i])*qmat[0] - bias[0]*qmat[0])>>16)*sign(block[i])
