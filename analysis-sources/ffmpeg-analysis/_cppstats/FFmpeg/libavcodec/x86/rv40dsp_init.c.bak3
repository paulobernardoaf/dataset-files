...
#define DEFINE_FN(op, size, insn) static void op##_rv40_qpel##size##_mc33_##insn(uint8_t *dst, const uint8_t *src, ptrdiff_t stride) { ff_##op##_pixels##size##_xy2_##insn(dst, src, stride, size); }
...
#define DECLARE_WEIGHT(opt) void ff_rv40_weight_func_rnd_16_##opt(uint8_t *dst, uint8_t *src1, uint8_t *src2, int w1, int w2, ptrdiff_t stride); void ff_rv40_weight_func_rnd_8_##opt (uint8_t *dst, uint8_t *src1, uint8_t *src2, int w1, int w2, ptrdiff_t stride); void ff_rv40_weight_func_nornd_16_##opt(uint8_t *dst, uint8_t *src1, uint8_t *src2, int w1, int w2, ptrdiff_t stride); void ff_rv40_weight_func_nornd_8_##opt (uint8_t *dst, uint8_t *src1, uint8_t *src2, int w1, int w2, ptrdiff_t stride);
...
#define QPEL_FUNCS_SET(OP, PH, PV, OPT) QPEL_FUNC_SET(OP, 8, PH, PV, OPT) QPEL_FUNC_SET(OP, 16, PH, PV, OPT)




#define QPEL_MC_SET(OP, OPT) QPEL_FUNCS_SET (OP, 0, 1, OPT) QPEL_FUNCS_SET (OP, 0, 3, OPT) QPEL_FUNCS_SET (OP, 1, 0, OPT) QPEL_FUNCS_SET (OP, 1, 1, OPT) QPEL_FUNCS_SET (OP, 1, 2, OPT) QPEL_FUNCS_SET (OP, 1, 3, OPT) QPEL_FUNCS_SET (OP, 2, 1, OPT) QPEL_FUNCS_SET (OP, 2, 2, OPT) QPEL_FUNCS_SET (OP, 2, 3, OPT) QPEL_FUNCS_SET (OP, 3, 0, OPT) QPEL_FUNCS_SET (OP, 3, 1, OPT) QPEL_FUNCS_SET (OP, 3, 2, OPT)
