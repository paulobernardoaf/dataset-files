...
#define PUT_VC1_MSPEL(a, b) static void put_vc1_mspel_mc ##a ##b ##_c(uint8_t *dst, const uint8_t *src, ptrdiff_t stride, int rnd) { put_vc1_mspel_mc(dst, src, stride, a, b, rnd); } static void avg_vc1_mspel_mc ##a ##b ##_c(uint8_t *dst, const uint8_t *src, ptrdiff_t stride, int rnd) { avg_vc1_mspel_mc(dst, src, stride, a, b, rnd); } static void put_vc1_mspel_mc ##a ##b ##_16_c(uint8_t *dst, const uint8_t *src, ptrdiff_t stride, int rnd) { put_vc1_mspel_mc_16(dst, src, stride, a, b, rnd); } static void avg_vc1_mspel_mc ##a ##b ##_16_c(uint8_t *dst, const uint8_t *src, ptrdiff_t stride, int rnd) { avg_vc1_mspel_mc_16(dst, src, stride, a, b, rnd); }
PUT_VC1_MSPEL(1, 0)
PUT_VC1_MSPEL(2, 0)
PUT_VC1_MSPEL(3, 0)
PUT_VC1_MSPEL(0, 1)
...
PUT_VC1_MSPEL(2, 3)
PUT_VC1_MSPEL(3, 3)
#define chroma_mc(a) ((A * src[a] + B * src[a + 1] + C * src[stride + a] + D * src[stride + a + 1] + 32 - 4) >> 6)
...
#endif 
#define FN_ASSIGN(X, Y) dsp->put_vc1_mspel_pixels_tab[1][X+4*Y] = put_vc1_mspel_mc##X##Y##_c; dsp->put_vc1_mspel_pixels_tab[0][X+4*Y] = put_vc1_mspel_mc##X##Y##_16_c; dsp->avg_vc1_mspel_pixels_tab[1][X+4*Y] = avg_vc1_mspel_mc##X##Y##_c; dsp->avg_vc1_mspel_pixels_tab[0][X+4*Y] = avg_vc1_mspel_mc##X##Y##_16_c
