...
#define PS_INIT_VLC_STATIC(num, size) INIT_VLC_STATIC(&vlc_ps[num], 9, ps_tmp[num].table_size / ps_tmp[num].elem_size, ps_tmp[num].ps_bits, 1, 1, ps_tmp[num].ps_codes, ps_tmp[num].elem_size, ps_tmp[num].elem_size, size);
