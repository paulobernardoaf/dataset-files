...
#define DEF_OLD_QPEL(name) void ff_put_ ##name(uint8_t *dst , const uint8_t *src , ptrdiff_t stride); void ff_put_no_rnd_ ##name(uint8_t *dst , const uint8_t *src , ptrdiff_t stride); void ff_avg_ ##name(uint8_t *dst , const uint8_t *src , ptrdiff_t stride);
