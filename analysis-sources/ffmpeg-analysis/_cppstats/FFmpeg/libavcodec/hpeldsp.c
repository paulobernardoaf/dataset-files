...
{
#define hpel_funcs(prefix, idx, num) c->prefix ##_pixels_tab idx [0] = prefix ##_pixels ##num ##_8_c; c->prefix ##_pixels_tab idx [1] = prefix ##_pixels ##num ##_x2_8_c; c->prefix ##_pixels_tab idx [2] = prefix ##_pixels ##num ##_y2_8_c; c->prefix ##_pixels_tab idx [3] = prefix ##_pixels ##num ##_xy2_8_c
hpel_funcs(put, [0], 16);
hpel_funcs(put, [1], 8);
hpel_funcs(put, [2], 4);
hpel_funcs(put, [3], 2);
