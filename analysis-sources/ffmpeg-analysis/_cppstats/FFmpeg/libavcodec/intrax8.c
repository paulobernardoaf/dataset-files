...
#define init_ac_vlc(dst, src) do { dst.table = &table[offset]; dst.table_allocated = sizes[sizeidx]; offset += sizes[sizeidx++]; init_vlc(&dst, AC_VLC_BITS, 77, &src[1], 4, 2, &src[0], 4, 2, INIT_VLC_USE_NEW_STATIC); } while(0)
for (i = 0; i < 8; i++) {
...
#undef init_ac_vlc
#define init_dc_vlc(dst, src) do { dst.table = &table[offset]; dst.table_allocated = sizes[sizeidx]; offset += sizes[sizeidx++]; init_vlc(&dst, DC_VLC_BITS, 34, &src[1], 4, 2, &src[0], 4, 2, INIT_VLC_USE_NEW_STATIC); } while(0)
for (i = 0; i < 8; i++) {
init_dc_vlc(j_dc_vlc[0][i], x8_dc_highquant_table[i][0]);
init_dc_vlc(j_dc_vlc[1][i], x8_dc_lowquant_table[i][0]);
}
#undef init_dc_vlc
#define init_or_vlc(dst, src) do { dst.table = &table[offset]; dst.table_allocated = sizes[sizeidx]; offset += sizes[sizeidx++]; init_vlc(&dst, OR_VLC_BITS, 12, &src[1], 4, 2, &src[0], 4, 2, INIT_VLC_USE_NEW_STATIC); } while(0)
for (i = 0; i < 2; i++)
...
extra_bits(3) | extra_run | run_offset(16) | level_offset(0),
extra_bits(3) | extra_run | run_offset(24) | level_offset(0),
extra_bits(2) | extra_run | run_offset(4) | level_offset(1),
extra_bits(3) | extra_run | run_offset(8) | level_offset(1),
extra_bits(5) | extra_run | run_offset(32) | level_offset(0),
extra_bits(4) | extra_run | run_offset(16) | level_offset(1),
extra_bits(2) | extra_level | run_offset(0) | level_offset(4),
extra_bits(2) | extra_level | run_offset(0) | level_offset(8),
extra_bits(2) | extra_level | run_offset(0) | level_offset(12),
extra_bits(3) | extra_level | run_offset(0) | level_offset(16),
extra_bits(3) | extra_level | run_offset(0) | level_offset(24),
extra_bits(2) | extra_level | run_offset(1) | level_offset(3),
extra_bits(3) | extra_level | run_offset(1) | level_offset(7),
extra_bits(2) | extra_run | run_offset(16) | level_offset(0),
extra_bits(2) | extra_run | run_offset(20) | level_offset(0),
extra_bits(2) | extra_run | run_offset(24) | level_offset(0),
extra_bits(2) | extra_run | run_offset(28) | level_offset(0),
extra_bits(4) | extra_run | run_offset(32) | level_offset(0),
extra_bits(4) | extra_run | run_offset(48) | level_offset(0),
extra_bits(2) | extra_run | run_offset(4) | level_offset(1),
extra_bits(3) | extra_run | run_offset(8) | level_offset(1),
extra_bits(4) | extra_run | run_offset(16) | level_offset(1),
extra_bits(2) | extra_level | run_offset(0) | level_offset(4),
extra_bits(3) | extra_level | run_offset(0) | level_offset(8),
extra_bits(4) | extra_level | run_offset(0) | level_offset(16),
extra_bits(2) | extra_level | run_offset(1) | level_offset(3),
extra_bits(3) | extra_level | run_offset(1) | level_offset(7),
};
#undef extra_bits
