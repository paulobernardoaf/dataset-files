#if !defined(AVCODEC_PPC_FFT_VSX_H)
...
x29 = vec_perm(x19, x27, vcprm(0,2,s0,s2)); 
x30 = vec_perm(x19, x27, vcprm(1,3,s1,s3)); 
x31 = vec_perm(x20, x28, vcprm(0,2,s0,s2)); 
x32 = vec_perm(x20, x28, vcprm(1,3,s1,s3)); 
x33 = vec_perm(x30, x32, vcprm(0,1,s2,3)); 
x34 = vec_perm(x30, x32, vcprm(s0,s1,2,s3)); 
...
x79 = vec_perm(x46, x68, vcprm(0,1,s0,s1)); 
x80 = vec_perm(x77, x68, vcprm(0,1,s2,s3)); 
x81 = vec_perm(x46, x70, vcprm(2,3,s0,s1)); 
x82 = vec_perm(x71, x77, vcprm(s2,s3,2,3)); 
vec_st(x79, 0, &(out[0]));
vec_st(x80, byte_2complex, &(out[0]));
vec_st(x81, byte_4complex, &(out[0]));
vec_st(x82, byte_6complex, &(out[0]));
x83 = vec_perm(x47, x69, vcprm(0,1,s0,s1)); 
x84 = vec_perm(x78, x69, vcprm(0,1,s2,s3)); 
x85 = vec_perm(x47, x71, vcprm(2,3,s0,s1)); 
x86 = vec_perm(x70, x78, vcprm(s2,s3,2,3)); 
...
v0 = vec_ld(0, &(out[0])); 
v3 = vec_ld(i1+16, &(out[0])); 
v10 = vec_madd(v5, v9, v10); 
v11 = vec_nmsub(v4, v9, v11); 
v12 = vec_nmsub(v7, v9, v12); 
v13 = vec_madd(v6, v9, v13); 
...
vec_st(v0, 0, &(out[0])); 
vec_st(v3, i1+16, &(out[0])); 
vec_st(v4, i2, &(out[0])); 
vec_st(v7, i3+16, &(out[0]));
