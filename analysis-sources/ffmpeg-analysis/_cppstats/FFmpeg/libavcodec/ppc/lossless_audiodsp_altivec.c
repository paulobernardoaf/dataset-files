...
#if HAVE_BIGENDIAN
#define GET_T(tt0,tt1,src,a,b){ a = vec_ld(16, src); tt0 = vec_perm(b, a, align); b = vec_ld(32, src); tt1 = vec_perm(a, b, align); }
#else
#define GET_T(tt0,tt1,src,a,b){ tt0 = vec_vsx_ld(0, src); tt1 = vec_vsx_ld(16, src); }
#endif
#if HAVE_ALTIVEC
