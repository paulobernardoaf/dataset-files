...
#if HAVE_BIGENDIAN
#define load_alignment(s, ali, pm2, pm1, pp0, pp1, pp2, pp3){vec_u8 srcR1 = vec_ld(-2, s);vec_u8 srcR2 = vec_ld(14, s);switch (ali) {default: {srcM2 = vec_perm(srcR1, srcR2, pm2);srcM1 = vec_perm(srcR1, srcR2, pm1);srcP0 = vec_perm(srcR1, srcR2, pp0);srcP1 = vec_perm(srcR1, srcR2, pp1);srcP2 = vec_perm(srcR1, srcR2, pp2);srcP3 = vec_perm(srcR1, srcR2, pp3);} break;case 11: {srcM2 = vec_perm(srcR1, srcR2, pm2);srcM1 = vec_perm(srcR1, srcR2, pm1);srcP0 = vec_perm(srcR1, srcR2, pp0);srcP1 = vec_perm(srcR1, srcR2, pp1);srcP2 = vec_perm(srcR1, srcR2, pp2);srcP3 = srcR2;} break;case 12: {vec_u8 srcR3 = vec_ld(30, s);srcM2 = vec_perm(srcR1, srcR2, pm2);srcM1 = vec_perm(srcR1, srcR2, pm1);srcP0 = vec_perm(srcR1, srcR2, pp0);srcP1 = vec_perm(srcR1, srcR2, pp1);srcP2 = srcR2;srcP3 = vec_perm(srcR2, srcR3, pp3);} break;case 13: {vec_u8 srcR3 = vec_ld(30, s);srcM2 = vec_perm(srcR1, srcR2, pm2);srcM1 = vec_perm(srcR1, srcR2, pm1);srcP0 = vec_perm(srcR1, srcR2, pp0);srcP1 = srcR2;srcP2 = vec_perm(srcR2, srcR3, pp2);srcP3 = vec_perm(srcR2, srcR3, pp3);} break;case 14: {vec_u8 srcR3 = vec_ld(30, s);srcM2 = vec_perm(srcR1, srcR2, pm2);srcM1 = vec_perm(srcR1, srcR2, pm1);srcP0 = srcR2;srcP1 = vec_perm(srcR2, srcR3, pp1);srcP2 = vec_perm(srcR2, srcR3, pp2);srcP3 = vec_perm(srcR2, srcR3, pp3);} break;case 15: {vec_u8 srcR3 = vec_ld(30, s);srcM2 = vec_perm(srcR1, srcR2, pm2);srcM1 = srcR2;srcP0 = vec_perm(srcR2, srcR3, pp0);srcP1 = vec_perm(srcR2, srcR3, pp1);srcP2 = vec_perm(srcR2, srcR3, pp2);srcP3 = vec_perm(srcR2, srcR3, pp3);} break;}}
...
#else
#define load_alignment(s, ali, pm2, pm1, pp0, pp1, pp2, pp3){srcM2 = vec_vsx_ld(-2, s);srcM1 = vec_vsx_ld(-1, s);srcP0 = vec_vsx_ld(0, s);srcP1 = vec_vsx_ld(1, s);srcP2 = vec_vsx_ld(2, s);srcP3 = vec_vsx_ld(3, s);}
...
#if defined(PREFIX_h264_qpel16_h_lowpass_altivec)
...
#if defined(PREFIX_h264_qpel16_v_lowpass_altivec)
...
#if defined(PREFIX_h264_qpel16_hv_lowpass_altivec)
