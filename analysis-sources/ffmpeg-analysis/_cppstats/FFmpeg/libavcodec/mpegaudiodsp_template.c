...
#define SUM8P2(sum1, op1, sum2, op2, w1, w2, p) { INTFLOAT tmp;tmp = p[0 * 64];op1(sum1, (w1)[0 * 64], tmp);op2(sum2, (w2)[0 * 64], tmp);tmp = p[1 * 64];op1(sum1, (w1)[1 * 64], tmp);op2(sum2, (w2)[1 * 64], tmp);tmp = p[2 * 64];op1(sum1, (w1)[2 * 64], tmp);op2(sum2, (w2)[2 * 64], tmp);tmp = p[3 * 64];op1(sum1, (w1)[3 * 64], tmp);op2(sum2, (w2)[3 * 64], tmp);tmp = p[4 * 64];op1(sum1, (w1)[4 * 64], tmp);op2(sum2, (w2)[4 * 64], tmp);tmp = p[5 * 64];op1(sum1, (w1)[5 * 64], tmp);op2(sum2, (w2)[5 * 64], tmp);tmp = p[6 * 64];op1(sum1, (w1)[6 * 64], tmp);op2(sum2, (w2)[6 * 64], tmp);tmp = p[7 * 64];op1(sum1, (w1)[7 * 64], tmp);op2(sum2, (w2)[7 * 64], tmp);}
