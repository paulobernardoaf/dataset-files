...
#define OP_PUT(S, D)
#define OP_AVG(S, D) "ldc1 $f16, "#S" \n\t" "pavgb "#D", "#D", $f16 \n\t"




#define NORMALIZE_MMI(SHIFT) "paddh $f6, $f6, $f14 \n\t" "paddh $f8, $f8, $f14 \n\t" "psrah $f6, $f6, "SHIFT" \n\t" "psrah $f8, $f8, "SHIFT" \n\t"
...
#define LOAD_ROUNDER_MMI(ROUND) "lwc1 $f14, "ROUND" \n\t" "punpcklhw $f14, $f14, $f14 \n\t" "punpcklwd $f14, $f14, $f14 \n\t"
...
#define VC1_HOR_16B_SHIFT2(OP, OPNAME) static void OPNAME ##vc1_hor_16b_shift2_mmi(uint8_t *dst, mips_reg stride, const int16_t *src, int rnd) { int h = 8; DECLARE_VAR_ALL64; DECLARE_VAR_ADDRT; src -= 1; rnd -= (-1+9+9-1)*1024; __asm__ volatile( LOAD_ROUNDER_MMI("%[rnd]") "ldc1 $f12, %[ff_pw_128] \n\t" "ldc1 $f10, %[ff_pw_9] \n\t" "1: \n\t" MMI_ULDC1($f2, %[src], 0x00) MMI_ULDC1($f4, %[src], 0x08) MMI_ULDC1($f6, %[src], 0x02) MMI_ULDC1($f8, %[src], 0x0a) MMI_ULDC1($f0, %[src], 0x06) "paddh $f2, $f2, $f0 \n\t" MMI_ULDC1($f0, %[src], 0x0e) "paddh $f4, $f4, $f0 \n\t" MMI_ULDC1($f0, %[src], 0x04) "paddh $f6, $f6, $f0 \n\t" MMI_ULDC1($f0, %[src], 0x0b) "paddh $f8, $f8, $f0 \n\t" "pmullh $f6, $f6, $f10 \n\t" "pmullh $f8, $f8, $f10 \n\t" "psubh $f6, $f6, $f2 \n\t" "psubh $f8, $f8, $f4 \n\t" "li $8, 0x07 \n\t" "mtc1 $8, $f16 \n\t" NORMALIZE_MMI("$f16") "paddh $f6, $f6, $f12 \n\t" "paddh $f8, $f8, $f12 \n\t" TRANSFER_DO_PACK(OP) "addiu %[h], %[h], -0x01 \n\t" PTR_ADDIU "%[src], %[src], 0x18 \n\t" PTR_ADDU "%[dst], %[dst], %[stride] \n\t" "bnez %[h], 1b \n\t" : RESTRICT_ASM_ALL64 RESTRICT_ASM_ADDRT [h]"+r"(h), [src]"+r"(src), [dst]"+r"(dst) : [stride]"r"(stride), [rnd]"m"(rnd), [ff_pw_9]"m"(ff_pw_9), [ff_pw_128]"m"(ff_pw_128) : "$8", "$f0", "$f2", "$f4", "$f6", "$f8", "$f10", "$f12", "$f14", "$f16", "memory" ); }
...
#define VC1_SHIFT2(OP, OPNAME)static void OPNAME ##vc1_shift2_mmi(uint8_t *dst, const uint8_t *src, mips_reg stride, int rnd, mips_reg offset) { DECLARE_VAR_LOW32; DECLARE_VAR_ADDRT; rnd = 8 - rnd; __asm__ volatile( "xor $f0, $f0, $f0 \n\t" "li $10, 0x08 \n\t" LOAD_ROUNDER_MMI("%[rnd]") "ldc1 $f12, %[ff_pw_9] \n\t" "1: \n\t" MMI_ULWC1($f6, %[src], 0x00) MMI_ULWC1($f8, %[src], 0x04) PTR_ADDU "$9, %[src], %[offset] \n\t" MMI_ULWC1($f2, $9, 0x00) MMI_ULWC1($f4, $9, 0x04) PTR_ADDU "%[src], %[src], %[offset] \n\t" "punpcklbh $f6, $f6, $f0 \n\t" "punpcklbh $f8, $f8, $f0 \n\t" "punpcklbh $f2, $f2, $f0 \n\t" "punpcklbh $f4, $f4, $f0 \n\t" "paddh $f6, $f6, $f2 \n\t" "paddh $f8, $f8, $f4 \n\t" PTR_ADDU "$9, %[src], %[offset_x2n] \n\t" MMI_ULWC1($f2, $9, 0x00) MMI_ULWC1($f4, $9, 0x04) "pmullh $f6, $f6, $f12 \n\t" "pmullh $f8, $f8, $f12 \n\t" "punpcklbh $f2, $f2, $f0 \n\t" "punpcklbh $f4, $f4, $f0 \n\t" "psubh $f6, $f6, $f2 \n\t" "psubh $f8, $f8, $f4 \n\t" PTR_ADDU "$9, %[src], %[offset] \n\t" MMI_ULWC1($f2, $9, 0x00) MMI_ULWC1($f4, $9, 0x04) "punpcklbh $f2, $f2, $f0 \n\t" "punpcklbh $f4, $f4, $f0 \n\t" "psubh $f6, $f6, $f2 \n\t" "psubh $f8, $f8, $f4 \n\t" "li $8, 0x04 \n\t" "mtc1 $8, $f16 \n\t" NORMALIZE_MMI("$f16") "packushb $f6, $f6, $f8 \n\t" OP((%[dst]), $f6) "sdc1 $f6, 0x00(%[dst]) \n\t" "addiu $10, $10, -0x01 \n\t" PTR_ADDU "%[src], %[src], %[stride1] \n\t" PTR_ADDU "%[dst], %[dst], %[stride] \n\t" "bnez $10, 1b \n\t" : RESTRICT_ASM_LOW32 RESTRICT_ASM_ADDRT [src]"+r"(src), [dst]"+r"(dst) : [offset]"r"(offset), [offset_x2n]"r"(-2*offset), [stride]"r"(stride), [rnd]"m"(rnd), [stride1]"r"(stride-offset), [ff_pw_9]"m"(ff_pw_9) : "$8", "$9", "$10", "$f0", "$f2", "$f4", "$f6", "$f8", "$f10", "$f12", "$f14", "$f16", "memory" ); }
...
#define MSPEL_FILTER13_VER_16B(NAME, A1, A2, A3, A4) static void vc1_put_ver_16b_ ##NAME ##_mmi(int16_t *dst, const uint8_t *src, mips_reg src_stride, int rnd, int64_t shift) { int h = 8; DECLARE_VAR_LOW32; DECLARE_VAR_ADDRT; src -= src_stride; __asm__ volatile( "xor $f0, $f0, $f0 \n\t" LOAD_ROUNDER_MMI("%[rnd]") "ldc1 $f10, %[ff_pw_53] \n\t" "ldc1 $f12, %[ff_pw_18] \n\t" ".p2align 3 \n\t" "1: \n\t" MSPEL_FILTER13_CORE(DO_UNPACK, MMI_ULWC1, 1, A1, A2, A3, A4) NORMALIZE_MMI("%[shift]") TRANSFER_DONT_PACK(OP_PUT) PTR_ADDU "$9, %[src], "#A1" \n\t" MMI_ULWC1($f2, $9, 0x08) DO_UNPACK("$f2") "mov.d $f6, $f2 \n\t" "paddh $f2, $f2, $f2 \n\t" "paddh $f2, $f2, $f6 \n\t" PTR_ADDU "$9, %[src], "#A2" \n\t" MMI_ULWC1($f6, $9, 0x08) DO_UNPACK("$f6") "pmullh $f6, $f6, $f12 \n\t" "psubh $f6, $f6, $f2 \n\t" PTR_ADDU "$9, %[src], "#A3" \n\t" MMI_ULWC1($f2, $9, 0x08) DO_UNPACK("$f2") "pmullh $f2, $f2, $f10 \n\t" "paddh $f6, $f6, $f2 \n\t" PTR_ADDU "$9, %[src], "#A4" \n\t" MMI_ULWC1($f2, $9, 0x08) DO_UNPACK("$f2") "li $8, 0x02 \n\t" "mtc1 $8, $f16 \n\t" "psllh $f2, $f2, $f16 \n\t" "psubh $f6, $f6, $f2 \n\t" "paddh $f6, $f6, $f14 \n\t" "li $8, 0x06 \n\t" "mtc1 $8, $f16 \n\t" "psrah $f6, $f6, $f16 \n\t" "sdc1 $f6, 0x10(%[dst]) \n\t" "addiu %[h], %[h], -0x01 \n\t" PTR_ADDU "%[src], %[src], %[stride_x1] \n\t" PTR_ADDIU "%[dst], %[dst], 0x18 \n\t" "bnez %[h], 1b \n\t" : RESTRICT_ASM_LOW32 RESTRICT_ASM_ADDRT [h]"+r"(h), [src]"+r"(src), [dst]"+r"(dst) : [stride_x1]"r"(src_stride), [stride_x2]"r"(2*src_stride), [stride_x3]"r"(3*src_stride), [rnd]"m"(rnd), [shift]"f"(shift), [ff_pw_53]"m"(ff_pw_53), [ff_pw_18]"m"(ff_pw_18), [ff_pw_3]"f"(ff_pw_3) : "$8", "$9", "$f0", "$f2", "$f4", "$f6", "$f8", "$f10", "$f12", "$f14", "$f16", "memory" ); }
...
#define MSPEL_FILTER13_HOR_16B(NAME, A1, A2, A3, A4, OP, OPNAME) static void OPNAME ##vc1_hor_16b_ ##NAME ##_mmi(uint8_t *dst, mips_reg stride, const int16_t *src, int rnd) { int h = 8; DECLARE_VAR_ALL64; DECLARE_VAR_ADDRT; src -= 1; rnd -= (-4+58+13-3)*256; __asm__ volatile( "xor $f0, $f0, $f0 \n\t" LOAD_ROUNDER_MMI("%[rnd]") "ldc1 $f10, %[ff_pw_53] \n\t" "ldc1 $f12, %[ff_pw_18] \n\t" ".p2align 3 \n\t" "1: \n\t" MSPEL_FILTER13_CORE(DONT_UNPACK, MMI_ULDC1, 2, A1, A2, A3, A4) "li $8, 0x07 \n\t" "mtc1 $8, $f16 \n\t" NORMALIZE_MMI("$f16") "paddh $f6, $f6, %[ff_pw_128] \n\t" "paddh $f8, $f8, %[ff_pw_128] \n\t" TRANSFER_DO_PACK(OP) "addiu %[h], %[h], -0x01 \n\t" PTR_ADDU "%[src], %[src], 0x18 \n\t" PTR_ADDU "%[dst], %[dst], %[stride] \n\t" "bnez %[h], 1b \n\t" : RESTRICT_ASM_ALL64 RESTRICT_ASM_ADDRT [h]"+r"(h), [src]"+r"(src), [dst]"+r"(dst) : [stride]"r"(stride), [rnd]"m"(rnd), [ff_pw_53]"m"(ff_pw_53), [ff_pw_18]"m"(ff_pw_18), [ff_pw_3]"f"(ff_pw_3), [ff_pw_128]"f"(ff_pw_128) : "$8", "$9", "$f0", "$f2", "$f4", "$f6", "$f8", "$f10", "$f12", "$f14", "$f16", "memory" ); }
...
#define MSPEL_FILTER13_8B(NAME, A1, A2, A3, A4, OP, OPNAME) static void OPNAME ##vc1_##NAME ##_mmi(uint8_t *dst, const uint8_t *src, mips_reg stride, int rnd, mips_reg offset) { int h = 8; DECLARE_VAR_LOW32; DECLARE_VAR_ADDRT; src -= offset; rnd = 32-rnd; __asm__ volatile ( "xor $f0, $f0, $f0 \n\t" LOAD_ROUNDER_MMI("%[rnd]") "ldc1 $f10, %[ff_pw_53] \n\t" "ldc1 $f12, %[ff_pw_18] \n\t" ".p2align 3 \n\t" "1: \n\t" MSPEL_FILTER13_CORE(DO_UNPACK, MMI_ULWC1, 1, A1, A2, A3, A4) "li $8, 0x06 \n\t" "mtc1 $8, $f16 \n\t" NORMALIZE_MMI("$f16") TRANSFER_DO_PACK(OP) "addiu %[h], %[h], -0x01 \n\t" PTR_ADDU "%[src], %[src], %[stride] \n\t" PTR_ADDU "%[dst], %[dst], %[stride] \n\t" "bnez %[h], 1b \n\t" : RESTRICT_ASM_LOW32 RESTRICT_ASM_ADDRT [h]"+r"(h), [src]"+r"(src), [dst]"+r"(dst) : [offset_x1]"r"(offset), [offset_x2]"r"(2*offset), [offset_x3]"r"(3*offset), [stride]"r"(stride), [rnd]"m"(rnd), [ff_pw_53]"m"(ff_pw_53), [ff_pw_18]"m"(ff_pw_18), [ff_pw_3]"f"(ff_pw_3) : "$8", "$9", "$f0", "$f2", "$f4", "$f6", "$f8", "$f10", "$f12", "$f14", "$f16", "memory" ); }
