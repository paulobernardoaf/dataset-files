...
#define quantize_and_encode_band_cost( s, pb, in, out, scaled, size, scale_idx, cb, lambda, uplim, bits, energy, ROUNDING) quantize_and_encode_band_cost_arr[cb]( s, pb, in, out, scaled, size, scale_idx, cb, lambda, uplim, bits, energy, ROUNDING)
...
#define get_band_numbits( s, pb, in, scaled, size, scale_idx, cb, lambda, uplim, bits) get_band_numbits_arr[cb]( s, pb, in, scaled, size, scale_idx, cb, lambda, uplim, bits)
...
#define get_band_cost( s, pb, in, scaled, size, scale_idx, cb, lambda, uplim, bits, energy) get_band_cost_arr[cb]( s, pb, in, scaled, size, scale_idx, cb, lambda, uplim, bits, energy)
