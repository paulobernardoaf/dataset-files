...
int t4, t5, t6, t8, t7;
int const C_1 = 4229717092; 
int const C_2 = 4035949074; 
int const C_3 = 575416510; 
int const C_3A = 3719550786; 
int const C_4 = 1004831466; 
int const C_5 = 1534215534; 
int const C_7 = -1468965330; 
int const C_8 = -745813244; 
__asm__ volatile (
"lw %[t1], 17*4(%[in]) \n\t"
"lw %[t2], 16*4(%[in]) \n\t"
"lw %[t3], 15*4(%[in]) \n\t"
