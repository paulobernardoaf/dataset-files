...
#define AVC_CALC_DPADD_B_6PIX_2COEFF_SH(vec0, vec1, vec2, vec3, vec4, vec5, out1, out2) { v16i8 tmp0_m, tmp1_m; v16i8 minus5b_m = __msa_ldi_b(-5); v16i8 plus20b_m = __msa_ldi_b(20); ILVRL_B2_SB(vec5, vec0, tmp0_m, tmp1_m); HADD_SB2_SH(tmp0_m, tmp1_m, out1, out2); ILVRL_B2_SB(vec4, vec1, tmp0_m, tmp1_m); DPADD_SB2_SH(tmp0_m, tmp1_m, minus5b_m, minus5b_m, out1, out2); ILVRL_B2_SB(vec3, vec2, tmp0_m, tmp1_m); DPADD_SB2_SH(tmp0_m, tmp1_m, plus20b_m, plus20b_m, out1, out2); }
...
#define AVC_DOT_SH3_SH(in0, in1, in2, coeff0, coeff1, coeff2) ( { v8i16 out0_m; out0_m = __msa_dotp_s_h((v16i8) in0, (v16i8) coeff0); out0_m = __msa_dpadd_s_h(out0_m, (v16i8) in1, (v16i8) coeff1); out0_m = __msa_dpadd_s_h(out0_m, (v16i8) in2, (v16i8) coeff2); out0_m; } )
#define AVC_DOT_SW3_SW(in0, in1, in2, coeff0, coeff1, coeff2) ( { v4i32 out0_m; out0_m = __msa_dotp_s_w((v8i16) in0, (v8i16) coeff0); out0_m = __msa_dpadd_s_w(out0_m, (v8i16) in1, (v8i16) coeff1); out0_m = __msa_dpadd_s_w(out0_m, (v8i16) in2, (v8i16) coeff2); out0_m = __msa_srari_w(out0_m, 10); out0_m = __msa_sat_s_w(out0_m, 7); out0_m; } )
