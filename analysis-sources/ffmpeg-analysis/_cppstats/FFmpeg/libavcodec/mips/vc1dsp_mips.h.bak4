...
#if !defined(AVCODEC_MIPS_VC1DSP_MIPS_H)
...
#define FF_PUT_VC1_MSPEL_MC_MSA(hmode, vmode) void ff_put_vc1_mspel_mc ##hmode ##vmode ##_msa(uint8_t *dst, const uint8_t *src, ptrdiff_t stride, int rnd); void ff_put_vc1_mspel_mc ##hmode ##vmode ##_16_msa(uint8_t *dst, const uint8_t *src, ptrdiff_t stride, int rnd);
