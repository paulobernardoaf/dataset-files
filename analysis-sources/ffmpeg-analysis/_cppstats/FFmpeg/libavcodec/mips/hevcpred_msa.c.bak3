...
#define HEVC_PRED_PLANAR_16x2(src0_r, src0_l, tmp0, tmp1, vec0, vec1, mul_val_h0, mul_val_h1, mul_val_h2, mul_val_h3, res0, res1, mul_val_b0, mul_val_b1, round) { v8i16 res0_m, res1_m, res2_m, res3_m; MUL4(mul_val_h0, vec0, mul_val_h2, vec0, mul_val_h0, vec1, mul_val_h2, vec1, res0_m, res1_m, res2_m, res3_m); res0_m += mul_val_h1 * tmp0; res1_m += mul_val_h3 * tmp0; res2_m += mul_val_h1 * tmp0; res3_m += mul_val_h3 * tmp0; res0_m += mul_val_b0 * src0_r; res1_m += mul_val_b0 * src0_l; res2_m += (mul_val_b0 - 1) * src0_r; res3_m += (mul_val_b0 - 1) * src0_l; res0_m += mul_val_b1 * tmp1; res1_m += mul_val_b1 * tmp1; res2_m += (mul_val_b1 + 1) * tmp1; res3_m += (mul_val_b1 + 1) * tmp1; SRARI_H4_SH(res0_m, res1_m, res2_m, res3_m, round); PCKEV_B2_SH(res1_m, res0_m, res3_m, res2_m, res0, res1); }
