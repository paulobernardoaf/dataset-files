...
#define VP9_DOTP_CONST_PAIR(reg0, reg1, cnst0, cnst1, out0, out1) { v8i16 k0_m = __msa_fill_h(cnst0); v4i32 s0_m, s1_m, s2_m, s3_m; s0_m = (v4i32) __msa_fill_h(cnst1); k0_m = __msa_ilvev_h((v8i16) s0_m, k0_m); ILVRL_H2_SW((-reg1), reg0, s1_m, s0_m); ILVRL_H2_SW(reg0, reg1, s3_m, s2_m); DOTP_SH2_SW(s1_m, s0_m, k0_m, k0_m, s1_m, s0_m); SRARI_W2_SW(s1_m, s0_m, VP9_DCT_CONST_BITS); out0 = __msa_pckev_h((v8i16) s0_m, (v8i16) s1_m); DOTP_SH2_SW(s3_m, s2_m, k0_m, k0_m, s1_m, s0_m); SRARI_W2_SW(s1_m, s0_m, VP9_DCT_CONST_BITS); out1 = __msa_pckev_h((v8i16) s0_m, (v8i16) s1_m); }
#define VP9_DOT_ADD_SUB_SRARI_PCK(in0, in1, in2, in3, in4, in5, in6, in7, dst0, dst1, dst2, dst3) { v4i32 tp0_m, tp1_m, tp2_m, tp3_m, tp4_m; v4i32 tp5_m, tp6_m, tp7_m, tp8_m, tp9_m; DOTP_SH4_SW(in0, in1, in0, in1, in4, in4, in5, in5, tp0_m, tp2_m, tp3_m, tp4_m); DOTP_SH4_SW(in2, in3, in2, in3, in6, in6, in7, in7, tp5_m, tp6_m, tp7_m, tp8_m); BUTTERFLY_4(tp0_m, tp3_m, tp7_m, tp5_m, tp1_m, tp9_m, tp7_m, tp5_m); BUTTERFLY_4(tp2_m, tp4_m, tp8_m, tp6_m, tp3_m, tp0_m, tp4_m, tp2_m); SRARI_W4_SW(tp1_m, tp9_m, tp7_m, tp5_m, VP9_DCT_CONST_BITS); SRARI_W4_SW(tp3_m, tp0_m, tp4_m, tp2_m, VP9_DCT_CONST_BITS); PCKEV_H4_SH(tp1_m, tp3_m, tp9_m, tp0_m, tp7_m, tp4_m, tp5_m, tp2_m, dst0, dst1, dst2, dst3); }
#define VP9_DOT_SHIFT_RIGHT_PCK_H(in0, in1, in2) ( { v8i16 dst_m; v4i32 tp0_m, tp1_m; DOTP_SH2_SW(in0, in1, in2, in2, tp1_m, tp0_m); SRARI_W2_SW(tp1_m, tp0_m, VP9_DCT_CONST_BITS); dst_m = __msa_pckev_h((v8i16) tp1_m, (v8i16) tp0_m); dst_m; } )
