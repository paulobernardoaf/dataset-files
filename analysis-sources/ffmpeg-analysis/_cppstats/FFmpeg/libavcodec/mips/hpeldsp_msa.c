...
#define PCKEV_ST_SB4(in0, in1, in2, in3, in4, in5, in6, in7, pdst, stride) { v16i8 tmp0_m, tmp1_m, tmp2_m, tmp3_m; uint8_t *pdst_m = (uint8_t *) (pdst); PCKEV_B4_SB(in0, in1, in2, in3, in4, in5, in6, in7, tmp0_m, tmp1_m, tmp2_m, tmp3_m); ST_SB4(tmp0_m, tmp1_m, tmp2_m, tmp3_m, pdst_m, stride); }
#define PCKEV_AVG_ST8x4_UB(in1, dst0, in2, dst1, in3, dst2, in4, dst3, pdst, stride) { v16u8 tmp0_m, tmp1_m, tmp2_m, tmp3_m; uint8_t *pdst_m = (uint8_t *) (pdst); PCKEV_B2_UB(in2, in1, in4, in3, tmp0_m, tmp1_m); PCKEV_D2_UB(dst1, dst0, dst3, dst2, tmp2_m, tmp3_m); AVER_UB2_UB(tmp0_m, tmp2_m, tmp1_m, tmp3_m, tmp0_m, tmp1_m); ST_D4(tmp0_m, tmp1_m, 0, 1, 0, 1, pdst_m, stride); }
