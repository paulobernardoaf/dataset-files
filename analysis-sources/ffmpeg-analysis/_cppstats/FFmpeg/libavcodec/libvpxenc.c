...
#endif
#if defined(VPX_CTRL_VP9E_SET_ROW_MT)
[VP9E_SET_ROW_MT] = "VP9E_SET_ROW_MT",
#endif
#if defined(VPX_CTRL_VP9E_SET_TUNE_CONTENT)
[VP9E_SET_TUNE_CONTENT] = "VP9E_SET_TUNE_CONTENT",
#endif
#if defined(VPX_CTRL_VP9E_SET_TPL)
...
{
VPxContext *ctx = avctx->priv_data;
#if defined(VPX_CTRL_VP9E_SET_ROI_MAP)
