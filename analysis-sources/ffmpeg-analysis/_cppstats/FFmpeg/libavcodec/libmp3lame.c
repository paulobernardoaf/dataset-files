...
#define ENCODE_BUFFER(func, buf_type, buf_name) do { lame_result = func(s->gfp, (const buf_type *)buf_name[0], (const buf_type *)buf_name[1], frame->nb_samples, s->buffer + s->buffer_index, s->buffer_size - s->buffer_index); } while (0)
