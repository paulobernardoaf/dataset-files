...
#define REBASE_PICTURE(pic, new_ctx, old_ctx) (((pic) && (pic) >= (old_ctx)->DPB && (pic) < (old_ctx)->DPB + H264_MAX_PICTURE_COUNT) ? &(new_ctx)->DPB[(pic) - (old_ctx)->DPB] : NULL)
...
{
#define HWACCEL_MAX (CONFIG_H264_DXVA2_HWACCEL + (CONFIG_H264_D3D11VA_HWACCEL * 2) + CONFIG_H264_NVDEC_HWACCEL + CONFIG_H264_VAAPI_HWACCEL + CONFIG_H264_VIDEOTOOLBOX_HWACCEL + CONFIG_H264_VDPAU_HWACCEL)
