...
#define alloc_and_copy_or_fail(obj, size, pad) if (src->obj && size > 0) { dest->obj = av_malloc(size + pad); if (!dest->obj) goto fail; memcpy(dest->obj, src->obj, size); if (pad) memset(((uint8_t *) dest->obj) + size, 0, pad); }
