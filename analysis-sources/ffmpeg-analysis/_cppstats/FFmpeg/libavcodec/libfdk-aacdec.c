...
#include "avcodec.h"
#include "internal.h"
#if defined(AACDECODER_LIB_VL0)
#define FDKDEC_VER_AT_LEAST(vl0, vl1) ((AACDECODER_LIB_VL0 > vl0) || (AACDECODER_LIB_VL0 == vl0 && AACDECODER_LIB_VL1 >= vl1))
#else
