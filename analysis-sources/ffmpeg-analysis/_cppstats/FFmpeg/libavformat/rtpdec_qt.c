...
#define RTP_QT_HANDLER(m, n, s, t) RTPDynamicProtocolHandler ff_ ##m ##_rtp_ ##n ##_handler = { .enc_name = s, .codec_type = t, .codec_id = AV_CODEC_ID_NONE, .priv_data_size = sizeof(PayloadContext), .close = qt_rtp_close, .parse_packet = qt_rtp_parse_packet, }
