...
#define STEAL_OPTION(option, field) do { if ((entry = av_dict_get(options, option, NULL, 0))) { field = entry->value; entry->value = NULL; av_dict_set(&options, option, NULL, 0); } } while (0)
