...
#define AVI_MASTER_INDEX_SIZE_DEFAULT 256 
...
duration_est = 10 * 60 * 60; 
filesize_est = duration_est * (bitrate / 8) * 1.10; 
...
avio_wl32(pb, par->height / fields); 
avio_wl32(pb, par->width); 
avio_wl32(pb, par->height / fields); 
avio_wl32(pb, par->width); 
avio_wl32(pb, 0); 
