...
#define ASF_PACKET_ERROR_CORRECTION_FLAGS (ASF_PACKET_FLAG_ERROR_CORRECTION_PRESENT | ASF_PACKET_ERROR_CORRECTION_DATA_SIZE)
...
#endif
#define ASF_PPI_PROPERTY_FLAGS (ASF_PL_FLAG_REPLICATED_DATA_LENGTH_FIELD_IS_BYTE | ASF_PL_FLAG_OFFSET_INTO_MEDIA_OBJECT_LENGTH_FIELD_IS_DWORD | ASF_PL_FLAG_MEDIA_OBJECT_NUMBER_LENGTH_FIELD_IS_BYTE | ASF_PL_FLAG_STREAM_NUMBER_LENGTH_FIELD_IS_BYTE)
...
#endif
#if !defined(ASF_PPI_SEQUENCE_FIELD_SIZE)
...
#endif
#if !defined(ASF_PPI_PACKET_LENGTH_FIELD_SIZE)
...
#endif
#if !defined(ASF_PPI_PADDING_LENGTH_FIELD_SIZE)
...
#endif
#if !defined(ASF_PAYLOAD_REPLICATED_DATA_LENGTH_FIELD_SIZE)
...
#endif
#if !defined(ASF_PAYLOAD_OFFSET_INTO_MEDIA_OBJECT_FIELD_SIZE)
...
#endif
#if !defined(ASF_PAYLOAD_MEDIA_OBJECT_NUMBER_FIELD_SIZE)
...
#endif
#if !defined(ASF_PAYLOAD_LENGTH_FIELD_SIZE)
#define ASF_PAYLOAD_LENGTH_FIELD_SIZE 0
#endif
#define PACKET_HEADER_MIN_SIZE (ASF_PACKET_ERROR_CORRECTION_FLAGS_FIELD_SIZE + ASF_PACKET_ERROR_CORRECTION_DATA_SIZE + 1 + 1 + ASF_PPI_PACKET_LENGTH_FIELD_SIZE + ASF_PPI_SEQUENCE_FIELD_SIZE + ASF_PPI_PADDING_LENGTH_FIELD_SIZE + 4 + 2) 
#define ASF_PAYLOAD_REPLICATED_DATA_LENGTH 0x08
#define PAYLOAD_HEADER_SIZE_SINGLE_PAYLOAD (1 + ASF_PAYLOAD_MEDIA_OBJECT_NUMBER_FIELD_SIZE + ASF_PAYLOAD_OFFSET_INTO_MEDIA_OBJECT_FIELD_SIZE + ASF_PAYLOAD_REPLICATED_DATA_LENGTH_FIELD_SIZE + ASF_PAYLOAD_REPLICATED_DATA_LENGTH)
#define PAYLOAD_HEADER_SIZE_MULTIPLE_PAYLOADS (1 + ASF_PAYLOAD_MEDIA_OBJECT_NUMBER_FIELD_SIZE + ASF_PAYLOAD_OFFSET_INTO_MEDIA_OBJECT_FIELD_SIZE + ASF_PAYLOAD_REPLICATED_DATA_LENGTH_FIELD_SIZE + ASF_PAYLOAD_REPLICATED_DATA_LENGTH + ASF_PAYLOAD_LENGTH_FIELD_SIZE)
#define SINGLE_PAYLOAD_HEADERS (PACKET_HEADER_MIN_SIZE + PAYLOAD_HEADER_SIZE_SINGLE_PAYLOAD)
#define MULTI_PAYLOAD_HEADERS (PACKET_HEADER_MIN_SIZE + 1 + 2 * PAYLOAD_HEADER_SIZE_MULTIPLE_PAYLOADS)
...
avio_wl64(pb, 0); 
avio_wl64(pb, 0); 
avio_wl32(pb, s->streams[n]->codecpar->bit_rate); 
avio_wl32(pb, 5000); 
avio_wl32(pb, 0); 
avio_wl32(pb, s->streams[n]->codecpar->bit_rate); 
avio_wl32(pb, 5000); 
avio_wl32(pb, 0); 
avio_wl32(pb, 0); 
avio_wl32(pb, (!asf->is_streamed && (pb->seekable & AVIO_SEEKABLE_NORMAL)) << 1); 
avio_wl16(pb, n + 1); 
avio_wl16(pb, asf->streams[n].stream_language_index); 
avio_wl64(pb, 0); 
avio_wl16(pb, 0); 
avio_wl16(pb, 0); 
