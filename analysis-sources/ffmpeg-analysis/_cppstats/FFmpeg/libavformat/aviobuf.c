...
#define PUT_STR16(type, big_endian) int avio_put_str16 ##type(AVIOContext *s, const char *str) { return put_str16(s, str, big_endian); }
PUT_STR16(le, 0)
PUT_STR16(be, 1)
#undef PUT_STR16
