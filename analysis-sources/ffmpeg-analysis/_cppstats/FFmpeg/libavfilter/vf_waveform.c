...
#define LOWPASS16_FUNC(name, column, mirror) static int lowpass16_##name(AVFilterContext *ctx, void *arg, int jobnr, int nb_jobs) { WaveformContext *s = ctx->priv; ThreadData *td = arg; AVFrame *in = td->in; AVFrame *out = td->out; int component = td->component; int offset_y = td->offset_y; int offset_x = td->offset_x; lowpass16(s, in, out, component, s->intensity, offset_y, offset_x, column, mirror, jobnr, nb_jobs); return 0; }
...
#define FLAT16_FUNC(name, column, mirror) static int flat16_##name(AVFilterContext *ctx, void *arg, int jobnr, int nb_jobs) { WaveformContext *s = ctx->priv; ThreadData *td = arg; AVFrame *in = td->in; AVFrame *out = td->out; int component = td->component; int offset_y = td->offset_y; int offset_x = td->offset_x; flat16(s, in, out, component, s->intensity, offset_y, offset_x, column, mirror, jobnr, nb_jobs); return 0; }
...
#define CHROMA16_FUNC(name, column, mirror) static int chroma16_##name(AVFilterContext *ctx, void *arg, int jobnr, int nb_jobs) { WaveformContext *s = ctx->priv; ThreadData *td = arg; AVFrame *in = td->in; AVFrame *out = td->out; int component = td->component; int offset_y = td->offset_y; int offset_x = td->offset_x; chroma16(s, in, out, component, s->intensity,offset_y, offset_x, column, mirror, jobnr, nb_jobs); return 0; }
...
#define CHROMA_FUNC(name, column, mirror) static int chroma_##name(AVFilterContext *ctx, void *arg, int jobnr, int nb_jobs) { WaveformContext *s = ctx->priv; ThreadData *td = arg; AVFrame *in = td->in; AVFrame *out = td->out; int component = td->component; int offset_y = td->offset_y; int offset_x = td->offset_x; chroma(s, in, out, component, s->intensity, offset_y, offset_x, column, mirror, jobnr, nb_jobs); return 0; }
...
#define COLOR16_FUNC(name, column, mirror) static int color16_##name(AVFilterContext *ctx, void *arg, int jobnr, int nb_jobs) { WaveformContext *s = ctx->priv; ThreadData *td = arg; AVFrame *in = td->in; AVFrame *out = td->out; int component = td->component; int offset_y = td->offset_y; int offset_x = td->offset_x; color16(s, in, out, component, s->intensity, offset_y, offset_x, column, mirror, jobnr, nb_jobs); return 0; }
...
#define COLOR_FUNC(name, column, mirror) static int color_##name(AVFilterContext *ctx, void *arg, int jobnr, int nb_jobs) { WaveformContext *s = ctx->priv; ThreadData *td = arg; AVFrame *in = td->in; AVFrame *out = td->out; int component = td->component; int offset_y = td->offset_y; int offset_x = td->offset_x; color(s, in, out, component, s->intensity, offset_y, offset_x, column, mirror, jobnr, nb_jobs); return 0; }
...
#define ACOLOR16_FUNC(name, column, mirror) static int acolor16_##name(AVFilterContext *ctx, void *arg, int jobnr, int nb_jobs) { WaveformContext *s = ctx->priv; ThreadData *td = arg; AVFrame *in = td->in; AVFrame *out = td->out; int component = td->component; int offset_y = td->offset_y; int offset_x = td->offset_x; acolor16(s, in, out, component, s->intensity,offset_y, offset_x, column, mirror, jobnr, nb_jobs); return 0; }
...
#define ACOLOR_FUNC(name, column, mirror) static int acolor_##name(AVFilterContext *ctx, void *arg, int jobnr, int nb_jobs) { WaveformContext *s = ctx->priv; ThreadData *td = arg; AVFrame *in = td->in; AVFrame *out = td->out; int component = td->component; int offset_y = td->offset_y; int offset_x = td->offset_x; acolor(s, in, out, component, s->intensity, offset_y, offset_x, column, mirror, jobnr, nb_jobs); return 0; }
