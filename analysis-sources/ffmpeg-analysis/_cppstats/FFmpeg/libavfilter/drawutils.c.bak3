...
#define EXPAND(compn) if (desc->comp[compn].depth > 8) color->comp[desc->comp[compn].plane].u16[desc->comp[compn].offset] = color->comp[desc->comp[compn].plane].u8[desc->comp[compn].offset] << (draw->desc->comp[compn].depth + draw->desc->comp[compn].shift - 8)
