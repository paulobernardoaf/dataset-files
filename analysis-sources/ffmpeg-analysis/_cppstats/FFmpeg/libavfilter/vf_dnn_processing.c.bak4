...
#define LOG_FORMAT_CHANNEL_MISMATCH() av_log(ctx, AV_LOG_ERROR, "the frame's format %s does not match " "the model input channel %d\n", av_get_pix_fmt_name(fmt), model_input->channels);
