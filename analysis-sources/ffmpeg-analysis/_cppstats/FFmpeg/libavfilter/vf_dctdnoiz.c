...
#define DECLARE_COLOR_FUNCS(name, r, g, b) static void color_decorrelation_##name(float **dst, int dst_linesize, const uint8_t **src, int src_linesize, int w, int h) { color_decorrelation(dst, dst_linesize, src, src_linesize, w, h, r, g, b); } static void color_correlation_##name(uint8_t **dst, int dst_linesize, float **src, int src_linesize, int w, int h) { color_correlation(dst, dst_linesize, src, src_linesize, w, h, r, g, b); }
