...
#define DECLARE_REGISTER_VOICE_FN(name) cst_voice *register_cmu_us_##name(const char *); void unregister_cmu_us_##name(cst_voice *);
...
#define MAKE_VOICE_STRUCTURE(voice_name) { .name = #voice_name, .register_fn = register_cmu_us_ ##voice_name, .unregister_fn = unregister_cmu_us_ ##voice_name, }
