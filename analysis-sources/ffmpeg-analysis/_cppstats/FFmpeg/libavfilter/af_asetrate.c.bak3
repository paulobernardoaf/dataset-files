...
#define OPT_GENERIC(name, field, def, min, max, descr, type, deffield, ...) { name, descr, offsetof(CONTEXT, field), AV_OPT_TYPE_ ##type, { .deffield = def }, min, max, FLAGS, __VA_ARGS__ }
