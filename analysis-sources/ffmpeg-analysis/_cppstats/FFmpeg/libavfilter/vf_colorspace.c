...
#define supported_format(d) ((d) != NULL && (d)->nb_components == 3 && !((d)->flags & AV_PIX_FMT_FLAG_RGB) && supported_depth((d)->comp[0].depth) && supported_subsampling((d)->log2_chroma_w, (d)->log2_chroma_h))
