...
#define FADE_TRANSITION(name, type, div) static void fade##name##_transition(AVFilterContext *ctx, const AVFrame *a, const AVFrame *b, AVFrame *out, float progress, int slice_start, int slice_end, int jobnr) { XFadeContext *s = ctx->priv; const int height = slice_end - slice_start; for (int p = 0; p < s->nb_planes; p++) { const type *xf0 = (const type *)(a->data[p] + slice_start * a->linesize[p]); const type *xf1 = (const type *)(b->data[p] + slice_start * b->linesize[p]); type *dst = (type *)(out->data[p] + slice_start * out->linesize[p]); for (int y = 0; y < height; y++) { for (int x = 0; x < out->width; x++) { dst[x] = mix(xf0[x], xf1[x], progress); } dst += out->linesize[p] / div; xf0 += a->linesize[p] / div; xf1 += b->linesize[p] / div; } } }
FADE_TRANSITION(8, uint8_t, 1)
FADE_TRANSITION(16, uint16_t, 2)
#define WIPELEFT_TRANSITION(name, type, div) static void wipeleft##name##_transition(AVFilterContext *ctx, const AVFrame *a, const AVFrame *b, AVFrame *out, float progress, int slice_start, int slice_end, int jobnr) { XFadeContext *s = ctx->priv; const int height = slice_end - slice_start; const int z = out->width * progress; for (int p = 0; p < s->nb_planes; p++) { const type *xf0 = (const type *)(a->data[p] + slice_start * a->linesize[p]); const type *xf1 = (const type *)(b->data[p] + slice_start * b->linesize[p]); type *dst = (type *)(out->data[p] + slice_start * out->linesize[p]); for (int y = 0; y < height; y++) { for (int x = 0; x < out->width; x++) { dst[x] = x > z ? xf1[x] : xf0[x]; } dst += out->linesize[p] / div; xf0 += a->linesize[p] / div; xf1 += b->linesize[p] / div; } } }
WIPELEFT_TRANSITION(8, uint8_t, 1)
WIPELEFT_TRANSITION(16, uint16_t, 2)
#define WIPERIGHT_TRANSITION(name, type, div) static void wiperight##name##_transition(AVFilterContext *ctx, const AVFrame *a, const AVFrame *b, AVFrame *out, float progress, int slice_start, int slice_end, int jobnr) { XFadeContext *s = ctx->priv; const int height = slice_end - slice_start; const int z = out->width * (1.f - progress); for (int p = 0; p < s->nb_planes; p++) { const type *xf0 = (const type *)(a->data[p] + slice_start * a->linesize[p]); const type *xf1 = (const type *)(b->data[p] + slice_start * b->linesize[p]); type *dst = (type *)(out->data[p] + slice_start * out->linesize[p]); for (int y = 0; y < height; y++) { for (int x = 0; x < out->width; x++) { dst[x] = x > z ? xf0[x] : xf1[x]; } dst += out->linesize[p] / div; xf0 += a->linesize[p] / div; xf1 += b->linesize[p] / div; } } }
WIPERIGHT_TRANSITION(8, uint8_t, 1)
WIPERIGHT_TRANSITION(16, uint16_t, 2)
#define WIPEUP_TRANSITION(name, type, div) static void wipeup##name##_transition(AVFilterContext *ctx, const AVFrame *a, const AVFrame *b, AVFrame *out, float progress, int slice_start, int slice_end, int jobnr) { XFadeContext *s = ctx->priv; const int height = slice_end - slice_start; const int z = out->height * progress; for (int p = 0; p < s->nb_planes; p++) { const type *xf0 = (const type *)(a->data[p] + slice_start * a->linesize[p]); const type *xf1 = (const type *)(b->data[p] + slice_start * b->linesize[p]); type *dst = (type *)(out->data[p] + slice_start * out->linesize[p]); for (int y = 0; y < height; y++) { for (int x = 0; x < out->width; x++) { dst[x] = slice_start + y > z ? xf1[x] : xf0[x]; } dst += out->linesize[p] / div; xf0 += a->linesize[p] / div; xf1 += b->linesize[p] / div; } } }
WIPEUP_TRANSITION(8, uint8_t, 1)
WIPEUP_TRANSITION(16, uint16_t, 2)
#define WIPEDOWN_TRANSITION(name, type, div) static void wipedown##name##_transition(AVFilterContext *ctx, const AVFrame *a, const AVFrame *b, AVFrame *out, float progress, int slice_start, int slice_end, int jobnr) { XFadeContext *s = ctx->priv; const int height = slice_end - slice_start; const int z = out->height * (1.f - progress); for (int p = 0; p < s->nb_planes; p++) { const type *xf0 = (const type *)(a->data[p] + slice_start * a->linesize[p]); const type *xf1 = (const type *)(b->data[p] + slice_start * b->linesize[p]); type *dst = (type *)(out->data[p] + slice_start * out->linesize[p]); for (int y = 0; y < height; y++) { for (int x = 0; x < out->width; x++) { dst[x] = slice_start + y > z ? xf0[x] : xf1[x]; } dst += out->linesize[p] / div; xf0 += a->linesize[p] / div; xf1 += b->linesize[p] / div; } } }
WIPEDOWN_TRANSITION(8, uint8_t, 1)
WIPEDOWN_TRANSITION(16, uint16_t, 2)
#define SLIDELEFT_TRANSITION(name, type, div) static void slideleft##name##_transition(AVFilterContext *ctx, const AVFrame *a, const AVFrame *b, AVFrame *out, float progress, int slice_start, int slice_end, int jobnr) { XFadeContext *s = ctx->priv; const int height = slice_end - slice_start; const int width = out->width; const int z = -progress * width; for (int p = 0; p < s->nb_planes; p++) { const type *xf0 = (const type *)(a->data[p] + slice_start * a->linesize[p]); const type *xf1 = (const type *)(b->data[p] + slice_start * b->linesize[p]); type *dst = (type *)(out->data[p] + slice_start * out->linesize[p]); for (int y = 0; y < height; y++) { for (int x = 0; x < width; x++) { const int zx = z + x; const int zz = zx % width + width * (zx < 0); dst[x] = (zx > 0) && (zx < width) ? xf1[zz] : xf0[zz]; } dst += out->linesize[p] / div; xf0 += a->linesize[p] / div; xf1 += b->linesize[p] / div; } } }
SLIDELEFT_TRANSITION(8, uint8_t, 1)
SLIDELEFT_TRANSITION(16, uint16_t, 2)
#define SLIDERIGHT_TRANSITION(name, type, div) static void slideright##name##_transition(AVFilterContext *ctx, const AVFrame *a, const AVFrame *b, AVFrame *out, float progress, int slice_start, int slice_end, int jobnr) { XFadeContext *s = ctx->priv; const int height = slice_end - slice_start; const int width = out->width; const int z = progress * width; for (int p = 0; p < s->nb_planes; p++) { const type *xf0 = (const type *)(a->data[p] + slice_start * a->linesize[p]); const type *xf1 = (const type *)(b->data[p] + slice_start * b->linesize[p]); type *dst = (type *)(out->data[p] + slice_start * out->linesize[p]); for (int y = 0; y < height; y++) { for (int x = 0; x < out->width; x++) { const int zx = z + x; const int zz = zx % width + width * (zx < 0); dst[x] = (zx > 0) && (zx < width) ? xf1[zz] : xf0[zz]; } dst += out->linesize[p] / div; xf0 += a->linesize[p] / div; xf1 += b->linesize[p] / div; } } }
SLIDERIGHT_TRANSITION(8, uint8_t, 1)
SLIDERIGHT_TRANSITION(16, uint16_t, 2)
#define SLIDEUP_TRANSITION(name, type, div) static void slideup##name##_transition(AVFilterContext *ctx, const AVFrame *a, const AVFrame *b, AVFrame *out, float progress, int slice_start, int slice_end, int jobnr) { XFadeContext *s = ctx->priv; const int height = out->height; const int z = -progress * height; for (int p = 0; p < s->nb_planes; p++) { type *dst = (type *)(out->data[p] + slice_start * out->linesize[p]); for (int y = slice_start; y < slice_end; y++) { const int zy = z + y; const int zz = zy % height + height * (zy < 0); const type *xf0 = (const type *)(a->data[p] + zz * a->linesize[p]); const type *xf1 = (const type *)(b->data[p] + zz * b->linesize[p]); for (int x = 0; x < out->width; x++) { dst[x] = (zy > 0) && (zy < height) ? xf1[x] : xf0[x]; } dst += out->linesize[p] / div; } } }
SLIDEUP_TRANSITION(8, uint8_t, 1)
SLIDEUP_TRANSITION(16, uint16_t, 2)
#define SLIDEDOWN_TRANSITION(name, type, div) static void slidedown##name##_transition(AVFilterContext *ctx, const AVFrame *a, const AVFrame *b, AVFrame *out, float progress, int slice_start, int slice_end, int jobnr) { XFadeContext *s = ctx->priv; const int height = out->height; const int z = progress * height; for (int p = 0; p < s->nb_planes; p++) { type *dst = (type *)(out->data[p] + slice_start * out->linesize[p]); for (int y = slice_start; y < slice_end; y++) { const int zy = z + y; const int zz = zy % height + height * (zy < 0); const type *xf0 = (const type *)(a->data[p] + zz * a->linesize[p]); const type *xf1 = (const type *)(b->data[p] + zz * b->linesize[p]); for (int x = 0; x < out->width; x++) { dst[x] = (zy > 0) && (zy < height) ? xf1[x] : xf0[x]; } dst += out->linesize[p] / div; } } }
SLIDEDOWN_TRANSITION(8, uint8_t, 1)
SLIDEDOWN_TRANSITION(16, uint16_t, 2)
#define CIRCLECROP_TRANSITION(name, type, div) static void circlecrop##name##_transition(AVFilterContext *ctx, const AVFrame *a, const AVFrame *b, AVFrame *out, float progress, int slice_start, int slice_end, int jobnr) { XFadeContext *s = ctx->priv; const int width = out->width; const int height = out->height; float z = powf(2.f * fabsf(progress - 0.5f), 3.f) * hypotf(width/2, height/2); for (int p = 0; p < s->nb_planes; p++) { const int bg = s->black[p]; type *dst = (type *)(out->data[p] + slice_start * out->linesize[p]); for (int y = slice_start; y < slice_end; y++) { const type *xf0 = (const type *)(a->data[p] + y * a->linesize[p]); const type *xf1 = (const type *)(b->data[p] + y * b->linesize[p]); for (int x = 0; x < width; x++) { float dist = hypotf(x - width / 2, y - height / 2); int val = progress < 0.5f ? xf1[x] : xf0[x]; dst[x] = (z < dist) ? bg : val; } dst += out->linesize[p] / div; } } }
CIRCLECROP_TRANSITION(8, uint8_t, 1)
CIRCLECROP_TRANSITION(16, uint16_t, 2)
#define RECTCROP_TRANSITION(name, type, div) static void rectcrop##name##_transition(AVFilterContext *ctx, const AVFrame *a, const AVFrame *b, AVFrame *out, float progress, int slice_start, int slice_end, int jobnr) { XFadeContext *s = ctx->priv; const int width = out->width; const int height = out->height; int zh = fabsf(progress - 0.5f) * height; int zw = fabsf(progress - 0.5f) * width; for (int p = 0; p < s->nb_planes; p++) { const int bg = s->black[p]; type *dst = (type *)(out->data[p] + slice_start * out->linesize[p]); for (int y = slice_start; y < slice_end; y++) { const type *xf0 = (const type *)(a->data[p] + y * a->linesize[p]); const type *xf1 = (const type *)(b->data[p] + y * b->linesize[p]); for (int x = 0; x < width; x++) { int dist = FFABS(x - width / 2) < zw && FFABS(y - height / 2) < zh; int val = progress < 0.5f ? xf1[x] : xf0[x]; dst[x] = !dist ? bg : val; } dst += out->linesize[p] / div; } } }
RECTCROP_TRANSITION(8, uint8_t, 1)
RECTCROP_TRANSITION(16, uint16_t, 2)
#define DISTANCE_TRANSITION(name, type, div) static void distance##name##_transition(AVFilterContext *ctx, const AVFrame *a, const AVFrame *b, AVFrame *out, float progress, int slice_start, int slice_end, int jobnr) { XFadeContext *s = ctx->priv; const int width = out->width; const float max = s->max_value; for (int y = slice_start; y < slice_end; y++) { for (int x = 0; x < width; x++) { float dist = 0.f; for (int p = 0; p < s->nb_planes; p++) { const type *xf0 = (const type *)(a->data[p] + y * a->linesize[p]); const type *xf1 = (const type *)(b->data[p] + y * b->linesize[p]); dist += (xf0[x] / max - xf1[x] / max) * (xf0[x] / max - xf1[x] / max); } dist = sqrtf(dist) <= progress; for (int p = 0; p < s->nb_planes; p++) { const type *xf0 = (const type *)(a->data[p] + y * a->linesize[p]); const type *xf1 = (const type *)(b->data[p] + y * b->linesize[p]); type *dst = (type *)(out->data[p] + y * out->linesize[p]); dst[x] = mix(mix(xf0[x], xf1[x], dist), xf1[x], progress); } } } }
DISTANCE_TRANSITION(8, uint8_t, 1)
DISTANCE_TRANSITION(16, uint16_t, 2)
#define FADEBLACK_TRANSITION(name, type, div) static void fadeblack##name##_transition(AVFilterContext *ctx, const AVFrame *a, const AVFrame *b, AVFrame *out, float progress, int slice_start, int slice_end, int jobnr) { XFadeContext *s = ctx->priv; const int height = slice_end - slice_start; const float phase = 0.2f; for (int p = 0; p < s->nb_planes; p++) { const type *xf0 = (const type *)(a->data[p] + slice_start * a->linesize[p]); const type *xf1 = (const type *)(b->data[p] + slice_start * b->linesize[p]); type *dst = (type *)(out->data[p] + slice_start * out->linesize[p]); const int bg = s->black[p]; for (int y = 0; y < height; y++) { for (int x = 0; x < out->width; x++) { dst[x] = mix(mix(xf0[x], bg, smoothstep(1.f-phase, 1.f, progress)), mix(bg, xf1[x], smoothstep(phase, 1.f, progress)), progress); } dst += out->linesize[p] / div; xf0 += a->linesize[p] / div; xf1 += b->linesize[p] / div; } } }
FADEBLACK_TRANSITION(8, uint8_t, 1)
FADEBLACK_TRANSITION(16, uint16_t, 2)
#define FADEWHITE_TRANSITION(name, type, div) static void fadewhite##name##_transition(AVFilterContext *ctx, const AVFrame *a, const AVFrame *b, AVFrame *out, float progress, int slice_start, int slice_end, int jobnr) { XFadeContext *s = ctx->priv; const int height = slice_end - slice_start; const float phase = 0.2f; for (int p = 0; p < s->nb_planes; p++) { const type *xf0 = (const type *)(a->data[p] + slice_start * a->linesize[p]); const type *xf1 = (const type *)(b->data[p] + slice_start * b->linesize[p]); type *dst = (type *)(out->data[p] + slice_start * out->linesize[p]); const int bg = s->white[p]; for (int y = 0; y < height; y++) { for (int x = 0; x < out->width; x++) { dst[x] = mix(mix(xf0[x], bg, smoothstep(1.f-phase, 1.f, progress)), mix(bg, xf1[x], smoothstep(phase, 1.f, progress)), progress); } dst += out->linesize[p] / div; xf0 += a->linesize[p] / div; xf1 += b->linesize[p] / div; } } }
FADEWHITE_TRANSITION(8, uint8_t, 1)
FADEWHITE_TRANSITION(16, uint16_t, 2)
#define RADIAL_TRANSITION(name, type, div) static void radial##name##_transition(AVFilterContext *ctx, const AVFrame *a, const AVFrame *b, AVFrame *out, float progress, int slice_start, int slice_end, int jobnr) { XFadeContext *s = ctx->priv; const int width = out->width; const int height = out->height; for (int y = slice_start; y < slice_end; y++) { for (int x = 0; x < width; x++) { const float smooth = atan2f(x - width / 2, y - height / 2) - (progress - 0.5f) * (M_PI * 2.5f); for (int p = 0; p < s->nb_planes; p++) { const type *xf0 = (const type *)(a->data[p] + y * a->linesize[p]); const type *xf1 = (const type *)(b->data[p] + y * b->linesize[p]); type *dst = (type *)(out->data[p] + y * out->linesize[p]); dst[x] = mix(xf1[x], xf0[x], smoothstep(0.f, 1.f, smooth)); } } } }
RADIAL_TRANSITION(8, uint8_t, 1)
RADIAL_TRANSITION(16, uint16_t, 2)
#define SMOOTHLEFT_TRANSITION(name, type, div) static void smoothleft##name##_transition(AVFilterContext *ctx, const AVFrame *a, const AVFrame *b, AVFrame *out, float progress, int slice_start, int slice_end, int jobnr) { XFadeContext *s = ctx->priv; const int width = out->width; const float w = width; for (int y = slice_start; y < slice_end; y++) { for (int x = 0; x < width; x++) { const float smooth = 1.f + x / w - progress * 2.f; for (int p = 0; p < s->nb_planes; p++) { const type *xf0 = (const type *)(a->data[p] + y * a->linesize[p]); const type *xf1 = (const type *)(b->data[p] + y * b->linesize[p]); type *dst = (type *)(out->data[p] + y * out->linesize[p]); dst[x] = mix(xf1[x], xf0[x], smoothstep(0.f, 1.f, smooth)); } } } }
SMOOTHLEFT_TRANSITION(8, uint8_t, 1)
SMOOTHLEFT_TRANSITION(16, uint16_t, 2)
#define SMOOTHRIGHT_TRANSITION(name, type, div) static void smoothright##name##_transition(AVFilterContext *ctx, const AVFrame *a, const AVFrame *b, AVFrame *out, float progress, int slice_start, int slice_end, int jobnr) { XFadeContext *s = ctx->priv; const int width = out->width; const float w = width; for (int y = slice_start; y < slice_end; y++) { for (int x = 0; x < width; x++) { const float smooth = 1.f + (w - 1 - x) / w - progress * 2.f; for (int p = 0; p < s->nb_planes; p++) { const type *xf0 = (const type *)(a->data[p] + y * a->linesize[p]); const type *xf1 = (const type *)(b->data[p] + y * b->linesize[p]); type *dst = (type *)(out->data[p] + y * out->linesize[p]); dst[x] = mix(xf1[x], xf0[x], smoothstep(0.f, 1.f, smooth)); } } } }
SMOOTHRIGHT_TRANSITION(8, uint8_t, 1)
SMOOTHRIGHT_TRANSITION(16, uint16_t, 2)
#define SMOOTHUP_TRANSITION(name, type, div) static void smoothup##name##_transition(AVFilterContext *ctx, const AVFrame *a, const AVFrame *b, AVFrame *out, float progress, int slice_start, int slice_end, int jobnr) { XFadeContext *s = ctx->priv; const int width = out->width; const float h = out->height; for (int y = slice_start; y < slice_end; y++) { const float smooth = 1.f + y / h - progress * 2.f; for (int x = 0; x < width; x++) { for (int p = 0; p < s->nb_planes; p++) { const type *xf0 = (const type *)(a->data[p] + y * a->linesize[p]); const type *xf1 = (const type *)(b->data[p] + y * b->linesize[p]); type *dst = (type *)(out->data[p] + y * out->linesize[p]); dst[x] = mix(xf1[x], xf0[x], smoothstep(0.f, 1.f, smooth)); } } } }
SMOOTHUP_TRANSITION(8, uint8_t, 1)
SMOOTHUP_TRANSITION(16, uint16_t, 2)
#define SMOOTHDOWN_TRANSITION(name, type, div) static void smoothdown##name##_transition(AVFilterContext *ctx, const AVFrame *a, const AVFrame *b, AVFrame *out, float progress, int slice_start, int slice_end, int jobnr) { XFadeContext *s = ctx->priv; const int width = out->width; const float h = out->height; for (int y = slice_start; y < slice_end; y++) { const float smooth = 1.f + (h - 1 - y) / h - progress * 2.f; for (int x = 0; x < width; x++) { for (int p = 0; p < s->nb_planes; p++) { const type *xf0 = (const type *)(a->data[p] + y * a->linesize[p]); const type *xf1 = (const type *)(b->data[p] + y * b->linesize[p]); type *dst = (type *)(out->data[p] + y * out->linesize[p]); dst[x] = mix(xf1[x], xf0[x], smoothstep(0.f, 1.f, smooth)); } } } }
SMOOTHDOWN_TRANSITION(8, uint8_t, 1)
SMOOTHDOWN_TRANSITION(16, uint16_t, 2)
#define CIRCLEOPEN_TRANSITION(name, type, div) static void circleopen##name##_transition(AVFilterContext *ctx, const AVFrame *a, const AVFrame *b, AVFrame *out, float progress, int slice_start, int slice_end, int jobnr) { XFadeContext *s = ctx->priv; const int width = out->width; const int height = out->height; const float z = hypotf(width / 2, height / 2); const float p = (progress - 0.5f) * 3.f; for (int y = slice_start; y < slice_end; y++) { for (int x = 0; x < width; x++) { const float smooth = hypotf(x - width / 2, y - height / 2) / z + p; for (int p = 0; p < s->nb_planes; p++) { const type *xf0 = (const type *)(a->data[p] + y * a->linesize[p]); const type *xf1 = (const type *)(b->data[p] + y * b->linesize[p]); type *dst = (type *)(out->data[p] + y * out->linesize[p]); dst[x] = mix(xf0[x], xf1[x], smoothstep(0.f, 1.f, smooth)); } } } }
CIRCLEOPEN_TRANSITION(8, uint8_t, 1)
CIRCLEOPEN_TRANSITION(16, uint16_t, 2)
#define CIRCLECLOSE_TRANSITION(name, type, div) static void circleclose##name##_transition(AVFilterContext *ctx, const AVFrame *a, const AVFrame *b, AVFrame *out, float progress, int slice_start, int slice_end, int jobnr) { XFadeContext *s = ctx->priv; const int width = out->width; const int height = out->height; const float z = hypotf(width / 2, height / 2); const float p = (1.f - progress - 0.5f) * 3.f; for (int y = slice_start; y < slice_end; y++) { for (int x = 0; x < width; x++) { const float smooth = hypotf(x - width / 2, y - height / 2) / z + p; for (int p = 0; p < s->nb_planes; p++) { const type *xf0 = (const type *)(a->data[p] + y * a->linesize[p]); const type *xf1 = (const type *)(b->data[p] + y * b->linesize[p]); type *dst = (type *)(out->data[p] + y * out->linesize[p]); dst[x] = mix(xf1[x], xf0[x], smoothstep(0.f, 1.f, smooth)); } } } }
CIRCLECLOSE_TRANSITION(8, uint8_t, 1)
CIRCLECLOSE_TRANSITION(16, uint16_t, 2)
#define VERTOPEN_TRANSITION(name, type, div) static void vertopen##name##_transition(AVFilterContext *ctx, const AVFrame *a, const AVFrame *b, AVFrame *out, float progress, int slice_start, int slice_end, int jobnr) { XFadeContext *s = ctx->priv; const int width = out->width; const float w2 = out->width / 2; for (int y = slice_start; y < slice_end; y++) { for (int x = 0; x < width; x++) { const float smooth = 2.f - fabsf((x - w2) / w2) - progress * 2.f; for (int p = 0; p < s->nb_planes; p++) { const type *xf0 = (const type *)(a->data[p] + y * a->linesize[p]); const type *xf1 = (const type *)(b->data[p] + y * b->linesize[p]); type *dst = (type *)(out->data[p] + y * out->linesize[p]); dst[x] = mix(xf1[x], xf0[x], smoothstep(0.f, 1.f, smooth)); } } } }
VERTOPEN_TRANSITION(8, uint8_t, 1)
VERTOPEN_TRANSITION(16, uint16_t, 2)
#define VERTCLOSE_TRANSITION(name, type, div) static void vertclose##name##_transition(AVFilterContext *ctx, const AVFrame *a, const AVFrame *b, AVFrame *out, float progress, int slice_start, int slice_end, int jobnr) { XFadeContext *s = ctx->priv; const int width = out->width; const float w2 = out->width / 2; for (int y = slice_start; y < slice_end; y++) { for (int x = 0; x < width; x++) { const float smooth = 1.f + fabsf((x - w2) / w2) - progress * 2.f; for (int p = 0; p < s->nb_planes; p++) { const type *xf0 = (const type *)(a->data[p] + y * a->linesize[p]); const type *xf1 = (const type *)(b->data[p] + y * b->linesize[p]); type *dst = (type *)(out->data[p] + y * out->linesize[p]); dst[x] = mix(xf1[x], xf0[x], smoothstep(0.f, 1.f, smooth)); } } } }
VERTCLOSE_TRANSITION(8, uint8_t, 1)
VERTCLOSE_TRANSITION(16, uint16_t, 2)
#define HORZOPEN_TRANSITION(name, type, div) static void horzopen##name##_transition(AVFilterContext *ctx, const AVFrame *a, const AVFrame *b, AVFrame *out, float progress, int slice_start, int slice_end, int jobnr) { XFadeContext *s = ctx->priv; const int width = out->width; const float h2 = out->height / 2; for (int y = slice_start; y < slice_end; y++) { const float smooth = 2.f - fabsf((y - h2) / h2) - progress * 2.f; for (int x = 0; x < width; x++) { for (int p = 0; p < s->nb_planes; p++) { const type *xf0 = (const type *)(a->data[p] + y * a->linesize[p]); const type *xf1 = (const type *)(b->data[p] + y * b->linesize[p]); type *dst = (type *)(out->data[p] + y * out->linesize[p]); dst[x] = mix(xf1[x], xf0[x], smoothstep(0.f, 1.f, smooth)); } } } }
HORZOPEN_TRANSITION(8, uint8_t, 1)
HORZOPEN_TRANSITION(16, uint16_t, 2)
#define HORZCLOSE_TRANSITION(name, type, div) static void horzclose##name##_transition(AVFilterContext *ctx, const AVFrame *a, const AVFrame *b, AVFrame *out, float progress, int slice_start, int slice_end, int jobnr) { XFadeContext *s = ctx->priv; const int width = out->width; const float h2 = out->height / 2; for (int y = slice_start; y < slice_end; y++) { const float smooth = 1.f + fabsf((y - h2) / h2) - progress * 2.f; for (int x = 0; x < width; x++) { for (int p = 0; p < s->nb_planes; p++) { const type *xf0 = (const type *)(a->data[p] + y * a->linesize[p]); const type *xf1 = (const type *)(b->data[p] + y * b->linesize[p]); type *dst = (type *)(out->data[p] + y * out->linesize[p]); dst[x] = mix(xf1[x], xf0[x], smoothstep(0.f, 1.f, smooth)); } } } }
...
#define DISSOLVE_TRANSITION(name, type, div) static void dissolve##name##_transition(AVFilterContext *ctx, const AVFrame *a, const AVFrame *b, AVFrame *out, float progress, int slice_start, int slice_end, int jobnr) { XFadeContext *s = ctx->priv; const int width = out->width; for (int y = slice_start; y < slice_end; y++) { for (int x = 0; x < width; x++) { const float smooth = frand(x, y) * 2.f + progress * 2.f - 1.5f; for (int p = 0; p < s->nb_planes; p++) { const type *xf0 = (const type *)(a->data[p] + y * a->linesize[p]); const type *xf1 = (const type *)(b->data[p] + y * b->linesize[p]); type *dst = (type *)(out->data[p] + y * out->linesize[p]); dst[x] = smooth >= 0.5f ? xf0[x] : xf1[x]; } } } }
DISSOLVE_TRANSITION(8, uint8_t, 1)
DISSOLVE_TRANSITION(16, uint16_t, 2)
#define PIXELIZE_TRANSITION(name, type, div) static void pixelize##name##_transition(AVFilterContext *ctx, const AVFrame *a, const AVFrame *b, AVFrame *out, float progress, int slice_start, int slice_end, int jobnr) { XFadeContext *s = ctx->priv; const int w = out->width; const int h = out->height; const float d = fminf(progress, 1.f - progress); const float dist = ceilf(d * 50.f) / 50.f; const float sqx = 2.f * dist * FFMIN(w, h) / 20.f; const float sqy = 2.f * dist * FFMIN(w, h) / 20.f; for (int y = slice_start; y < slice_end; y++) { for (int x = 0; x < w; x++) { int sx = dist > 0.f ? FFMIN((floorf(x / sqx) + .5f) * sqx, w - 1) : x; int sy = dist > 0.f ? FFMIN((floorf(y / sqy) + .5f) * sqy, h - 1) : y; for (int p = 0; p < s->nb_planes; p++) { const type *xf0 = (const type *)(a->data[p] + sy * a->linesize[p]); const type *xf1 = (const type *)(b->data[p] + sy * b->linesize[p]); type *dst = (type *)(out->data[p] + y * out->linesize[p]); dst[x] = mix(xf0[sx], xf1[sx], progress); } } } }
PIXELIZE_TRANSITION(8, uint8_t, 1)
PIXELIZE_TRANSITION(16, uint16_t, 2)
#define DIAGTL_TRANSITION(name, type, div) static void diagtl##name##_transition(AVFilterContext *ctx, const AVFrame *a, const AVFrame *b, AVFrame *out, float progress, int slice_start, int slice_end, int jobnr) { XFadeContext *s = ctx->priv; const int width = out->width; const float w = width; const float h = out->height; for (int y = slice_start; y < slice_end; y++) { for (int x = 0; x < width; x++) { const float smooth = 1.f + x / w * y / h - progress * 2.f; for (int p = 0; p < s->nb_planes; p++) { const type *xf0 = (const type *)(a->data[p] + y * a->linesize[p]); const type *xf1 = (const type *)(b->data[p] + y * b->linesize[p]); type *dst = (type *)(out->data[p] + y * out->linesize[p]); dst[x] = mix(xf1[x], xf0[x], smoothstep(0.f, 1.f, smooth)); } } } }
DIAGTL_TRANSITION(8, uint8_t, 1)
DIAGTL_TRANSITION(16, uint16_t, 2)
#define DIAGTR_TRANSITION(name, type, div) static void diagtr##name##_transition(AVFilterContext *ctx, const AVFrame *a, const AVFrame *b, AVFrame *out, float progress, int slice_start, int slice_end, int jobnr) { XFadeContext *s = ctx->priv; const int width = out->width; const float w = width; const float h = out->height; for (int y = slice_start; y < slice_end; y++) { for (int x = 0; x < width; x++) { const float smooth = 1.f + (w - 1 - x) / w * y / h - progress * 2.f; for (int p = 0; p < s->nb_planes; p++) { const type *xf0 = (const type *)(a->data[p] + y * a->linesize[p]); const type *xf1 = (const type *)(b->data[p] + y * b->linesize[p]); type *dst = (type *)(out->data[p] + y * out->linesize[p]); dst[x] = mix(xf1[x], xf0[x], smoothstep(0.f, 1.f, smooth)); } } } }
DIAGTR_TRANSITION(8, uint8_t, 1)
DIAGTR_TRANSITION(16, uint16_t, 2)
#define DIAGBL_TRANSITION(name, type, div) static void diagbl##name##_transition(AVFilterContext *ctx, const AVFrame *a, const AVFrame *b, AVFrame *out, float progress, int slice_start, int slice_end, int jobnr) { XFadeContext *s = ctx->priv; const int width = out->width; const float w = width; const float h = out->height; for (int y = slice_start; y < slice_end; y++) { for (int x = 0; x < width; x++) { const float smooth = 1.f + x / w * (h - 1 - y) / h - progress * 2.f; for (int p = 0; p < s->nb_planes; p++) { const type *xf0 = (const type *)(a->data[p] + y * a->linesize[p]); const type *xf1 = (const type *)(b->data[p] + y * b->linesize[p]); type *dst = (type *)(out->data[p] + y * out->linesize[p]); dst[x] = mix(xf1[x], xf0[x], smoothstep(0.f, 1.f, smooth)); } } } }
DIAGBL_TRANSITION(8, uint8_t, 1)
DIAGBL_TRANSITION(16, uint16_t, 2)
#define DIAGBR_TRANSITION(name, type, div) static void diagbr##name##_transition(AVFilterContext *ctx, const AVFrame *a, const AVFrame *b, AVFrame *out, float progress, int slice_start, int slice_end, int jobnr) { XFadeContext *s = ctx->priv; const int width = out->width; const float w = width; const float h = out->height; for (int y = slice_start; y < slice_end; y++) { for (int x = 0; x < width; x++) { const float smooth = 1.f + (w - 1 - x) / w * (h - 1 - y) / h - progress * 2.f; for (int p = 0; p < s->nb_planes; p++) { const type *xf0 = (const type *)(a->data[p] + y * a->linesize[p]); const type *xf1 = (const type *)(b->data[p] + y * b->linesize[p]); type *dst = (type *)(out->data[p] + y * out->linesize[p]); dst[x] = mix(xf1[x], xf0[x], smoothstep(0.f, 1.f, smooth)); } } } }
