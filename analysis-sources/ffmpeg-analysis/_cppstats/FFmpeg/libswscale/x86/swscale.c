...
#endif
#endif 
#define SCALE_FUNC(filter_n, from_bpc, to_bpc, opt) void ff_hscale ##from_bpc ##to ##to_bpc ##_ ##filter_n ##_ ##opt( SwsContext *c, int16_t *data, int dstW, const uint8_t *src, const int16_t *filter, const int32_t *filterPos, int filterSize)
...
#define SCALE_FUNCS_MMX(opt) SCALE_FUNCS(4, opt); SCALE_FUNCS(8, opt); SCALE_FUNCS(X, opt)
#define SCALE_FUNCS_SSE(opt) SCALE_FUNCS(4, opt); SCALE_FUNCS(8, opt); SCALE_FUNCS(X4, opt); SCALE_FUNCS(X8, opt)
#if ARCH_X86_32
SCALE_FUNCS_MMX(mmx);
#endif
...
#define VSCALEX_FUNC(size, opt) void ff_yuv2planeX_ ##size ##_ ##opt(const int16_t *filter, int filterSize, const int16_t **src, uint8_t *dest, int dstW, const uint8_t *dither, int offset)
#define VSCALEX_FUNCS(opt) VSCALEX_FUNC(8, opt); VSCALEX_FUNC(9, opt); VSCALEX_FUNC(10, opt)
#if ARCH_X86_32
...
VSCALEX_FUNCS(avx);
#define VSCALE_FUNC(size, opt) void ff_yuv2plane1_ ##size ##_ ##opt(const int16_t *src, uint8_t *dst, int dstW, const uint8_t *dither, int offset)
#define VSCALE_FUNCS(opt1, opt2) VSCALE_FUNC(8, opt1); VSCALE_FUNC(9, opt2); VSCALE_FUNC(10, opt2); VSCALE_FUNC(16, opt1)
#if ARCH_X86_32
...
#define INPUT_Y_FUNC(fmt, opt) void ff_ ##fmt ##ToY_ ##opt(uint8_t *dst, const uint8_t *src, const uint8_t *unused1, const uint8_t *unused2, int w, uint32_t *unused)
#define INPUT_UV_FUNC(fmt, opt) void ff_ ##fmt ##ToUV_ ##opt(uint8_t *dstU, uint8_t *dstV, const uint8_t *unused0, const uint8_t *src1, const uint8_t *src2, int w, uint32_t *unused)
#define INPUT_FUNC(fmt, opt) INPUT_Y_FUNC(fmt, opt); INPUT_UV_FUNC(fmt, opt)
#define INPUT_FUNCS(opt) INPUT_FUNC(uyvy, opt); INPUT_FUNC(yuyv, opt); INPUT_UV_FUNC(nv12, opt); INPUT_UV_FUNC(nv21, opt); INPUT_FUNC(rgba, opt); INPUT_FUNC(bgra, opt); INPUT_FUNC(argb, opt); INPUT_FUNC(abgr, opt); INPUT_FUNC(rgb24, opt); INPUT_FUNC(bgr24, opt)
#if ARCH_X86_32
INPUT_FUNCS(mmx);
#endif
INPUT_FUNCS(sse2);
...
#endif 
#define ASSIGN_SSE_SCALE_FUNC(hscalefn, filtersize, opt1, opt2) switch (filtersize) { case 4: ASSIGN_SCALE_FUNC2(hscalefn, 4, opt1, opt2); break; case 8: ASSIGN_SCALE_FUNC2(hscalefn, 8, opt1, opt2); break; default: if (filtersize & 4) ASSIGN_SCALE_FUNC2(hscalefn, X4, opt1, opt2); else ASSIGN_SCALE_FUNC2(hscalefn, X8, opt1, opt2); break; }
