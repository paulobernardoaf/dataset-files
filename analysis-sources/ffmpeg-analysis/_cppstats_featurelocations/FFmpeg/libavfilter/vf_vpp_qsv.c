...
{
#define PASS_EXPR(e, s) {ret = av_expr_parse(&e, s, var_names, NULL, NULL, NULL, NULL, 0, ctx); if (ret < 0) {av_log(ctx, AV_LOG_ERROR, "Error when passing '%s'.\n", s);goto release;}}
...
#define CALC_EXPR(e, v, i) {i = v = av_expr_eval(e, var_values, NULL); }
