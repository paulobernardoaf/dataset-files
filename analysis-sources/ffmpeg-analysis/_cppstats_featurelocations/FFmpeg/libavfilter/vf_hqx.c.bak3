...
#define INTERP_BOOTSTRAP(rot) const int k_shuffled = SHF(k,rot,0) | SHF(k,rot,1) | SHF(k,rot,2) | SHF(k,rot,3) | 0 | SHF(k,rot,5) | SHF(k,rot,6) | SHF(k,rot,7) | SHF(k,rot,8); const uint32_t w0 = w[p0], w1 = w[p1], w3 = w[p3], w4 = w[p4], w5 = w[p5], w7 = w[p7]
...
#define HQX_FUNC(size) static int hq##size##x(AVFilterContext *ctx, void *arg, int jobnr, int nb_jobs) { hqx_filter(arg, jobnr, nb_jobs, size); return 0; }
