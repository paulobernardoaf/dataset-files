...
#define LOAD_AVS_FUNC(name, continue_on_fail) avs_library.name = (name ##_func) dlsym(avs_library.library, #name); if (!continue_on_fail && !avs_library.name) goto fail;
