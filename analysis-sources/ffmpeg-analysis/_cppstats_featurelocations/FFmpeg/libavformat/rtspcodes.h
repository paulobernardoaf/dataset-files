...
#if !defined(AVFORMAT_RTSPCODES_H)
...
#define RTSP_STATUS_CODE2STRING(x) (x >= 100 && x < FF_ARRAY_ELEMS(rtsp_status_strings) && rtsp_status_strings[x] )? rtsp_status_strings[x] : NULL
