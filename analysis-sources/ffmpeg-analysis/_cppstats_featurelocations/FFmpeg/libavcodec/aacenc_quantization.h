...
#if !defined(AVCODEC_AACENC_QUANTIZATION_H)
...
#define QUANTIZE_AND_ENCODE_BAND_COST_FUNC(NAME, BT_ZERO, BT_UNSIGNED, BT_PAIR, BT_ESC, BT_NOISE, BT_STEREO, ROUNDING) static float quantize_and_encode_band_cost_ ##NAME( struct AACEncContext *s, PutBitContext *pb, const float *in, float *quant, const float *scaled, int size, int scale_idx, int cb, const float lambda, const float uplim, int *bits, float *energy) { return quantize_and_encode_band_cost_template( s, pb, in, quant, scaled, size, scale_idx, BT_ESC ? ESC_BT : cb, lambda, uplim, bits, energy, BT_ZERO, BT_UNSIGNED, BT_PAIR, BT_ESC, BT_NOISE, BT_STEREO, ROUNDING); }
...
#define quantize_and_encode_band_cost( s, pb, in, quant, scaled, size, scale_idx, cb, lambda, uplim, bits, energy, rtz) ((rtz) ? quantize_and_encode_band_cost_rtz_arr : quantize_and_encode_band_cost_arr)[cb]( s, pb, in, quant, scaled, size, scale_idx, cb, lambda, uplim, bits, energy)
