...
static void vp3_idct_put_c(uint8_t *dest , ptrdiff_t stride,
int16_t *block )
{
...
static void vp3_idct_add_c(uint8_t *dest , ptrdiff_t stride,
int16_t *block )
{
...
static void vp3_idct_dc_add_c(uint8_t *dest , ptrdiff_t stride,
int16_t *block )
{
...
#define LOOP_FILTER(prefix, suffix, dim, count) void prefix##_##dim##_loop_filter_##count##suffix(uint8_t *first_pixel, ptrdiff_t stride, int *bounding_values) { vp3_##dim##_loop_filter_c(first_pixel, stride, bounding_values, count); }
