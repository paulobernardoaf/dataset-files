...
#define AAC_INIT_VLC_STATIC(num, size) INIT_VLC_STATIC(&vlc_spectral[num], 8, ff_aac_spectral_sizes[num], ff_aac_spectral_bits[num], sizeof(ff_aac_spectral_bits[num][0]), sizeof(ff_aac_spectral_bits[num][0]), ff_aac_spectral_codes[num], sizeof(ff_aac_spectral_codes[num][0]), sizeof(ff_aac_spectral_codes[num][0]), size);
