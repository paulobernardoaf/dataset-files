...
#if defined(VDP_DECODER_PROFILE_H264_CONSTRAINED_BASELINE)
...
{
#define PROFILE(prof) do { *profile = VDP_DECODER_PROFILE_##prof; return 0; } while (0)
...
#if defined(VDP_DECODER_PROFILE_H264_EXTENDED)
