...
#define PARSE_BLOCK_SIZE(w, h) do { block_bits = get_bits(&s->gb, 3) + 2; blocks_w = FFALIGN((w), 1 << block_bits) >> block_bits; blocks_h = FFALIGN((h), 1 << block_bits) >> block_bits; } while (0)
