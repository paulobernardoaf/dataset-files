...
#define IS_CBR(rc) (rc == NV_ENC_PARAMS_RC_CBR || rc == NV_ENC_PARAMS_RC_CBR_LOWDELAY_HQ || rc == NV_ENC_PARAMS_RC_CBR_HQ)
...
#define IS_10BIT(pix_fmt) (pix_fmt == AV_PIX_FMT_P010 || pix_fmt == AV_PIX_FMT_P016 || pix_fmt == AV_PIX_FMT_YUV444P16)



#define IS_YUV444(pix_fmt) (pix_fmt == AV_PIX_FMT_YUV444P || pix_fmt == AV_PIX_FMT_YUV444P16)
...
#if defined(NVENC_HAVE_GETLASTERRORSTRING)
...
#if defined(NVENC_HAVE_BFRAME_REF_MODE)
...
#if defined(NVENC_HAVE_MULTIPLE_REF_FRAMES)
...
#if defined(NVENC_HAVE_HEVC_BFRAME_REF_MODE)
...
#if defined(NVENC_HAVE_CUSTREAM_PTR)
if (ctx->cu_context) {
