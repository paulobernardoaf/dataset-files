...
#define PACK_CHANNELS(macro,order,channels) macro(order,channels,0) macro(order,channels,1) macro(order,channels,2) macro(order,channels,3) macro(order,channels,4) macro(order,channels,5) macro(order,channels,mixed)
...
#define PACK_ORDER(macro,order) PACK_CHANNELS(macro,order,2) PACK_CHANNELS(macro,order,6) PACK_CHANNELS(macro,order,8)



#define PACK_ALL(macro) PACK_ORDER(macro,outof) PACK_ORDER(macro,in)
