...
#if !defined(AVCODEC_ALPHA_ASM_H)
...
#if defined(__GNUC__)
#define ldq(p) (((const union { uint64_t __l; __typeof__(*(p)) __s[sizeof (uint64_t) / sizeof *(p)]; } *) (p))->__l)




#define ldl(p) (((const union { int32_t __l; __typeof__(*(p)) __s[sizeof (int32_t) / sizeof *(p)]; } *) (p))->__l)




#define stq(l, p) do { (((union { uint64_t __l; __typeof__(*(p)) __s[sizeof (uint64_t) / sizeof *(p)]; } *) (p))->__l) = l; } while (0)
...
#define stl(l, p) do { (((union { int32_t __l; __typeof__(*(p)) __s[sizeof (int32_t) / sizeof *(p)]; } *) (p))->__l) = l; } while (0)
