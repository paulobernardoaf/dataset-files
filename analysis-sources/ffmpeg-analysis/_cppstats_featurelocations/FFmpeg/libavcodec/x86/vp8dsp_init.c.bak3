...
#define TAP_W16(OPT, FILTERTYPE, TAPTYPE) static void ff_put_vp8_ ##FILTERTYPE ##16_ ##TAPTYPE ##_ ##OPT( uint8_t *dst, ptrdiff_t dststride, uint8_t *src, ptrdiff_t srcstride, int height, int mx, int my) { ff_put_vp8_ ##FILTERTYPE ##8_ ##TAPTYPE ##_ ##OPT( dst, dststride, src, srcstride, height, mx, my); ff_put_vp8_ ##FILTERTYPE ##8_ ##TAPTYPE ##_ ##OPT( dst + 8, dststride, src + 8, srcstride, height, mx, my); }
...
#define TAP_W8(OPT, FILTERTYPE, TAPTYPE) static void ff_put_vp8_ ##FILTERTYPE ##8_ ##TAPTYPE ##_ ##OPT( uint8_t *dst, ptrdiff_t dststride, uint8_t *src, ptrdiff_t srcstride, int height, int mx, int my) { ff_put_vp8_ ##FILTERTYPE ##4_ ##TAPTYPE ##_ ##OPT( dst, dststride, src, srcstride, height, mx, my); ff_put_vp8_ ##FILTERTYPE ##4_ ##TAPTYPE ##_ ##OPT( dst + 4, dststride, src + 4, srcstride, height, mx, my); }
...
#if ARCH_X86_32
#define HVTAPMMX(x, y) HVTAP(mmxext, 8, x, y, 4, 8) HVTAP(mmxext, 8, x, y, 8, 16)



HVTAP(mmxext, 8, 6, 6, 16, 16)
#else
#define HVTAPMMX(x, y) HVTAP(mmxext, 8, x, y, 4, 8)
...
#define HVTAPSSE2(x, y, w) HVTAP(sse2, 16, x, y, w, 16) HVTAP(ssse3, 16, x, y, w, 16)
...
#define VP8_LUMA_MC_FUNC(IDX, SIZE, OPT) c->put_vp8_epel_pixels_tab[IDX][0][2] = ff_put_vp8_epel ##SIZE ##_h6_ ##OPT; c->put_vp8_epel_pixels_tab[IDX][2][0] = ff_put_vp8_epel ##SIZE ##_v6_ ##OPT; c->put_vp8_epel_pixels_tab[IDX][2][2] = ff_put_vp8_epel ##SIZE ##_h6v6_ ##OPT




#define VP8_MC_FUNC(IDX, SIZE, OPT) c->put_vp8_epel_pixels_tab[IDX][0][1] = ff_put_vp8_epel ##SIZE ##_h4_ ##OPT; c->put_vp8_epel_pixels_tab[IDX][1][0] = ff_put_vp8_epel ##SIZE ##_v4_ ##OPT; c->put_vp8_epel_pixels_tab[IDX][1][1] = ff_put_vp8_epel ##SIZE ##_h4v4_ ##OPT; c->put_vp8_epel_pixels_tab[IDX][1][2] = ff_put_vp8_epel ##SIZE ##_h6v4_ ##OPT; c->put_vp8_epel_pixels_tab[IDX][2][1] = ff_put_vp8_epel ##SIZE ##_h4v6_ ##OPT; VP8_LUMA_MC_FUNC(IDX, SIZE, OPT)
