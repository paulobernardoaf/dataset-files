...
#else 
#define QPEL_H264_H16_XMM(OPNAME, OP, MMX)static av_always_inline void ff_ ##OPNAME ##h264_qpel16_h_lowpass_l2_ ##MMX(uint8_t *dst, const uint8_t *src, const uint8_t *src2, int dstStride, int src2Stride){ff_ ##OPNAME ##h264_qpel8_h_lowpass_l2_ ##MMX(dst , src , src2 , dstStride, src2Stride);ff_ ##OPNAME ##h264_qpel8_h_lowpass_l2_ ##MMX(dst+8, src+8, src2+8, dstStride, src2Stride);src += 8*dstStride;dst += 8*dstStride;src2 += 8*src2Stride;ff_ ##OPNAME ##h264_qpel8_h_lowpass_l2_ ##MMX(dst , src , src2 , dstStride, src2Stride);ff_ ##OPNAME ##h264_qpel8_h_lowpass_l2_ ##MMX(dst+8, src+8, src2+8, dstStride, src2Stride);}
...
#define QPEL_H264_H_XMM(OPNAME, OP, MMX)QPEL_H264_H16_XMM(OPNAME, OP, MMX)static av_always_inline void ff_ ##OPNAME ##h264_qpel16_h_lowpass_ ##MMX(uint8_t *dst, const uint8_t *src, int dstStride, int srcStride){ff_ ##OPNAME ##h264_qpel8_h_lowpass_ ##MMX(dst , src , dstStride, srcStride);ff_ ##OPNAME ##h264_qpel8_h_lowpass_ ##MMX(dst+8, src+8, dstStride, srcStride);src += 8*srcStride;dst += 8*dstStride;ff_ ##OPNAME ##h264_qpel8_h_lowpass_ ##MMX(dst , src , dstStride, srcStride);ff_ ##OPNAME ##h264_qpel8_h_lowpass_ ##MMX(dst+8, src+8, dstStride, srcStride);}
...
#define QPEL_H264_V_XMM(OPNAME, OP, MMX)static av_always_inline void ff_ ##OPNAME ##h264_qpel8_v_lowpass_ ##MMX(uint8_t *dst, const uint8_t *src, int dstStride, int srcStride){ff_ ##OPNAME ##h264_qpel8or16_v_lowpass_ ##MMX(dst , src , dstStride, srcStride, 8);}static av_always_inline void ff_ ##OPNAME ##h264_qpel16_v_lowpass_ ##MMX(uint8_t *dst, const uint8_t *src, int dstStride, int srcStride){ff_ ##OPNAME ##h264_qpel8or16_v_lowpass_ ##MMX(dst , src , dstStride, srcStride, 16);ff_ ##OPNAME ##h264_qpel8or16_v_lowpass_ ##MMX(dst+8, src+8, dstStride, srcStride, 16);}
...
#define QPEL_H264_HV_XMM(OPNAME, OP, MMX)static av_always_inline void ff_ ##OPNAME ##h264_qpel8or16_hv_lowpass_ ##MMX(uint8_t *dst, int16_t *tmp, const uint8_t *src, int dstStride, int tmpStride, int srcStride, int size){put_h264_qpel8or16_hv1_lowpass_sse2(tmp, src, tmpStride, srcStride, size);ff_ ##OPNAME ##h264_qpel8or16_hv2_lowpass_ ##MMX(dst, tmp, dstStride, tmpStride, size);}static av_always_inline void ff_ ##OPNAME ##h264_qpel8_hv_lowpass_ ##MMX(uint8_t *dst, int16_t *tmp, const uint8_t *src, int dstStride, int tmpStride, int srcStride){ff_ ##OPNAME ##h264_qpel8or16_hv_lowpass_ ##MMX(dst, tmp, src, dstStride, tmpStride, srcStride, 8);}static av_always_inline void ff_ ##OPNAME ##h264_qpel16_hv_lowpass_ ##MMX(uint8_t *dst, int16_t *tmp, const uint8_t *src, int dstStride, int tmpStride, int srcStride){ff_ ##OPNAME ##h264_qpel8or16_hv_lowpass_ ##MMX(dst, tmp, src, dstStride, tmpStride, srcStride, 16);}
...
#define H264_MC(OPNAME, SIZE, MMX, ALIGN) H264_MC_C(OPNAME, SIZE, MMX, ALIGN)H264_MC_V(OPNAME, SIZE, MMX, ALIGN)H264_MC_H(OPNAME, SIZE, MMX, ALIGN)H264_MC_HV(OPNAME, SIZE, MMX, ALIGN)
...
#define H264_MC_C(OPNAME, SIZE, MMX, ALIGN) static void OPNAME ##h264_qpel ##SIZE ##_mc00_ ##MMX (uint8_t *dst, const uint8_t *src, ptrdiff_t stride){ff_ ##OPNAME ##pixels ##SIZE ##_ ##MMX(dst, src, stride, SIZE);}





#define H264_MC_H(OPNAME, SIZE, MMX, ALIGN) static void OPNAME ##h264_qpel ##SIZE ##_mc10_ ##MMX(uint8_t *dst, const uint8_t *src, ptrdiff_t stride){ff_ ##OPNAME ##h264_qpel ##SIZE ##_h_lowpass_l2_ ##MMX(dst, src, src, stride, stride);}static void OPNAME ##h264_qpel ##SIZE ##_mc20_ ##MMX(uint8_t *dst, const uint8_t *src, ptrdiff_t stride){ff_ ##OPNAME ##h264_qpel ##SIZE ##_h_lowpass_ ##MMX(dst, src, stride, stride);}static void OPNAME ##h264_qpel ##SIZE ##_mc30_ ##MMX(uint8_t *dst, const uint8_t *src, ptrdiff_t stride){ff_ ##OPNAME ##h264_qpel ##SIZE ##_h_lowpass_l2_ ##MMX(dst, src, src+1, stride, stride);}
...
#define H264_MC_4816(MMX)H264_MC(put_, 4, MMX, 8)H264_MC(put_, 8, MMX, 8)H264_MC(put_, 16,MMX, 8)H264_MC(avg_, 4, MMX, 8)H264_MC(avg_, 8, MMX, 8)H264_MC(avg_, 16,MMX, 8)
...
#define H264_MC_816(QPEL, XMM)QPEL(put_, 8, XMM, 16)QPEL(put_, 16,XMM, 16)QPEL(avg_, 8, XMM, 16)QPEL(avg_, 16,XMM, 16)
...
#define LUMA_MC_OP(OP, NUM, DEPTH, TYPE, OPT) void ff_ ##OP ##_h264_qpel ##NUM ##_ ##TYPE ##_ ##DEPTH ##_ ##OPT (uint8_t *dst, const uint8_t *src, ptrdiff_t stride);



#define LUMA_MC_ALL(DEPTH, TYPE, OPT) LUMA_MC_OP(put, 4, DEPTH, TYPE, OPT) LUMA_MC_OP(avg, 4, DEPTH, TYPE, OPT) LUMA_MC_OP(put, 8, DEPTH, TYPE, OPT) LUMA_MC_OP(avg, 8, DEPTH, TYPE, OPT) LUMA_MC_OP(put, 16, DEPTH, TYPE, OPT) LUMA_MC_OP(avg, 16, DEPTH, TYPE, OPT)
...
#define LUMA_MC_816(DEPTH, TYPE, OPT) LUMA_MC_OP(put, 8, DEPTH, TYPE, OPT) LUMA_MC_OP(avg, 8, DEPTH, TYPE, OPT) LUMA_MC_OP(put, 16, DEPTH, TYPE, OPT) LUMA_MC_OP(avg, 16, DEPTH, TYPE, OPT)
...
#define H264_QPEL_FUNCS(x, y, CPU) do { c->put_h264_qpel_pixels_tab[0][x + y * 4] = put_h264_qpel16_mc ##x ##y ##_ ##CPU; c->put_h264_qpel_pixels_tab[1][x + y * 4] = put_h264_qpel8_mc ##x ##y ##_ ##CPU; c->avg_h264_qpel_pixels_tab[0][x + y * 4] = avg_h264_qpel16_mc ##x ##y ##_ ##CPU; c->avg_h264_qpel_pixels_tab[1][x + y * 4] = avg_h264_qpel8_mc ##x ##y ##_ ##CPU; } while (0)
...
#define H264_QPEL_FUNCS_10(x, y, CPU) do { c->put_h264_qpel_pixels_tab[0][x + y * 4] = ff_put_h264_qpel16_mc ##x ##y ##_10_ ##CPU; c->put_h264_qpel_pixels_tab[1][x + y * 4] = ff_put_h264_qpel8_mc ##x ##y ##_10_ ##CPU; c->avg_h264_qpel_pixels_tab[0][x + y * 4] = ff_avg_h264_qpel16_mc ##x ##y ##_10_ ##CPU; c->avg_h264_qpel_pixels_tab[1][x + y * 4] = ff_avg_h264_qpel8_mc ##x ##y ##_10_ ##CPU; } while (0)
