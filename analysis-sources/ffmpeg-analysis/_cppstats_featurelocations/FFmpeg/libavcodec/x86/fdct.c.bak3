...
#define TABLE_SSE2 C4, C4, C1, C3, -C6, -C2, -C1, -C5, C4, C4, C5, C7, C2, C6, C3, -C7, -C4, C4, C7, C3, C6, -C2, C7, -C5, C4, -C4, C5, -C1, C2, -C6, C3, -C1,
