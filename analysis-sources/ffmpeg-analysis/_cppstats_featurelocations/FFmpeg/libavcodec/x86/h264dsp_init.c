...
#define IDCT_ADD_REP_FUNC(NUM, REP, DEPTH, OPT) void ff_h264_idct ##NUM ##_add ##REP ##_ ##DEPTH ##_ ##OPT (uint8_t *dst, const int *block_offset, int16_t *block, int stride, const uint8_t nnzc[6 * 8]);
...
#define IDCT_ADD_REP_FUNC2(NUM, REP, DEPTH, OPT) void ff_h264_idct ##NUM ##_add ##REP ##_ ##DEPTH ##_ ##OPT (uint8_t **dst, const int *block_offset, int16_t *block, int stride, const uint8_t nnzc[6 * 8]);
...
#define H264_WEIGHT(W, OPT) void ff_h264_weight_ ##W ##_ ##OPT(uint8_t *dst, ptrdiff_t stride, int height, int log2_denom, int weight, int offset);




#define H264_BIWEIGHT(W, OPT) void ff_h264_biweight_ ##W ##_ ##OPT(uint8_t *dst, uint8_t *src, ptrdiff_t stride, int height, int log2_denom, int weightd, int weights, int offset);





#define H264_BIWEIGHT_MMX(W) H264_WEIGHT(W, mmxext) H264_BIWEIGHT(W, mmxext)



#define H264_BIWEIGHT_MMX_SSE(W) H264_BIWEIGHT_MMX(W) H264_WEIGHT(W, sse2) H264_BIWEIGHT(W, sse2) H264_BIWEIGHT(W, ssse3)
...
#define H264_WEIGHT_10(W, DEPTH, OPT) void ff_h264_weight_ ##W ##_ ##DEPTH ##_ ##OPT(uint8_t *dst, ptrdiff_t stride, int height, int log2_denom, int weight, int offset);
...
#define H264_BIWEIGHT_10(W, DEPTH, OPT) void ff_h264_biweight_ ##W ##_ ##DEPTH ##_ ##OPT(uint8_t *dst, uint8_t *src, ptrdiff_t stride, int height, int log2_denom, int weightd, int weights, int offset);
...
#define H264_BIWEIGHT_10_SSE(W, DEPTH) H264_WEIGHT_10(W, DEPTH, sse2) H264_WEIGHT_10(W, DEPTH, sse4) H264_BIWEIGHT_10(W, DEPTH, sse2) H264_BIWEIGHT_10(W, DEPTH, sse4)
