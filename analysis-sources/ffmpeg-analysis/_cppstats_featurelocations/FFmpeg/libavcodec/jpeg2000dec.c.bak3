...
if (yc % (1LL << (rlevel->log2_prec_height + reducedresno)) && y != tile->coord[1][0]) 
continue;

if (xc % (1LL << (rlevel->log2_prec_width + reducedresno)) && x != tile->coord[0][0]) 
continue;
...
if (codsty->cblk_style & JPEG2000_CBLK_RESET) 
