...
#if !defined(AVCODEC_MIPS_VP9DSP_MIPS_H)
...
#define VP9_COPY_AVG_MIPS_MSA_FUNC(SIZE) void ff_copy##SIZE##_msa(uint8_t *dst, ptrdiff_t dststride, const uint8_t *src, ptrdiff_t srcstride, int h, int mx, int my); void ff_avg##SIZE##_msa(uint8_t *dst, ptrdiff_t dststride, const uint8_t *src, ptrdiff_t srcstride, int h, int mx, int my);
