...
#define VP8_SIMPLE_MASK(p1, p0, q0, q1, b_limit, mask) { v16u8 p1_a_sub_q1, p0_a_sub_q0; p0_a_sub_q0 = __msa_asub_u_b(p0, q0); p1_a_sub_q1 = __msa_asub_u_b(p1, q1); p1_a_sub_q1 = (v16u8) __msa_srli_b((v16i8) p1_a_sub_q1, 1); p0_a_sub_q0 = __msa_adds_u_b(p0_a_sub_q0, p0_a_sub_q0); mask = __msa_adds_u_b(p0_a_sub_q0, p1_a_sub_q1); mask = ((v16u8) mask <= b_limit); }
...
#define VP8_ST6x1_UB(in0, in0_idx, in1, in1_idx, pdst, stride) { uint16_t tmp0_h; uint32_t tmp0_w; tmp0_w = __msa_copy_u_w((v4i32) in0, in0_idx); tmp0_h = __msa_copy_u_h((v8i16) in1, in1_idx); SW(tmp0_w, pdst); SH(tmp0_h, pdst + stride); }
