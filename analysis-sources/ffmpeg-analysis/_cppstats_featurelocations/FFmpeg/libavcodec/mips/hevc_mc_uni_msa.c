...
#define HORIZ_8TAP_4WID_4VECS_FILT(src0, src1, src2, src3, mask0, mask1, mask2, mask3, filt0, filt1, filt2, filt3, out0, out1) { v16i8 vec0_m, vec1_m, vec2_m, vec3_m, vec4_m, vec5_m, vec6_m, vec7_m; VSHF_B2_SB(src0, src1, src2, src3, mask0, mask0, vec0_m, vec1_m); DOTP_SB2_SH(vec0_m, vec1_m, filt0, filt0, out0, out1); VSHF_B2_SB(src0, src1, src2, src3, mask1, mask1, vec2_m, vec3_m); DPADD_SB2_SH(vec2_m, vec3_m, filt1, filt1, out0, out1); VSHF_B2_SB(src0, src1, src2, src3, mask2, mask2, vec4_m, vec5_m); DPADD_SB2_SH(vec4_m, vec5_m, filt2, filt2, out0, out1); VSHF_B2_SB(src0, src1, src2, src3, mask3, mask3, vec6_m, vec7_m); DPADD_SB2_SH(vec6_m, vec7_m, filt3, filt3, out0, out1); }
...
#define HORIZ_8TAP_8WID_4VECS_FILT(src0, src1, src2, src3, mask0, mask1, mask2, mask3, filt0, filt1, filt2, filt3, out0, out1, out2, out3) { v16i8 vec0_m, vec1_m, vec2_m, vec3_m, vec4_m, vec5_m, vec6_m, vec7_m; VSHF_B2_SB(src0, src0, src1, src1, mask0, mask0, vec0_m, vec1_m); VSHF_B2_SB(src2, src2, src3, src3, mask0, mask0, vec2_m, vec3_m); DOTP_SB4_SH(vec0_m, vec1_m, vec2_m, vec3_m, filt0, filt0, filt0, filt0, out0, out1, out2, out3); VSHF_B2_SB(src0, src0, src1, src1, mask2, mask2, vec0_m, vec1_m); VSHF_B2_SB(src2, src2, src3, src3, mask2, mask2, vec2_m, vec3_m); DPADD_SB4_SH(vec0_m, vec1_m, vec2_m, vec3_m, filt2, filt2, filt2, filt2, out0, out1, out2, out3); VSHF_B2_SB(src0, src0, src1, src1, mask1, mask1, vec4_m, vec5_m); VSHF_B2_SB(src2, src2, src3, src3, mask1, mask1, vec6_m, vec7_m); DPADD_SB4_SH(vec4_m, vec5_m, vec6_m, vec7_m, filt1, filt1, filt1, filt1, out0, out1, out2, out3); VSHF_B2_SB(src0, src0, src1, src1, mask3, mask3, vec4_m, vec5_m); VSHF_B2_SB(src2, src2, src3, src3, mask3, mask3, vec6_m, vec7_m); DPADD_SB4_SH(vec4_m, vec5_m, vec6_m, vec7_m, filt3, filt3, filt3, filt3, out0, out1, out2, out3); }
...
#define HORIZ_4TAP_4WID_4VECS_FILT(src0, src1, src2, src3, mask0, mask1, filt0, filt1, out0, out1) { v16i8 vec0_m, vec1_m, vec2_m, vec3_m; VSHF_B2_SB(src0, src1, src2, src3, mask0, mask0, vec0_m, vec1_m); DOTP_SB2_SH(vec0_m, vec1_m, filt0, filt0, out0, out1); VSHF_B2_SB(src0, src1, src2, src3, mask1, mask1, vec2_m, vec3_m); DPADD_SB2_SH(vec2_m, vec3_m, filt1, filt1, out0, out1); }
...
#define HORIZ_4TAP_8WID_4VECS_FILT(src0, src1, src2, src3, mask0, mask1, filt0, filt1, out0, out1, out2, out3) { v16i8 vec0_m, vec1_m, vec2_m, vec3_m; VSHF_B2_SB(src0, src0, src1, src1, mask0, mask0, vec0_m, vec1_m); VSHF_B2_SB(src2, src2, src3, src3, mask0, mask0, vec2_m, vec3_m); DOTP_SB4_SH(vec0_m, vec1_m, vec2_m, vec3_m, filt0, filt0, filt0, filt0, out0, out1, out2, out3); VSHF_B2_SB(src0, src0, src1, src1, mask1, mask1, vec0_m, vec1_m); VSHF_B2_SB(src2, src2, src3, src3, mask1, mask1, vec2_m, vec3_m); DPADD_SB4_SH(vec0_m, vec1_m, vec2_m, vec3_m, filt1, filt1, filt1, filt1, out0, out1, out2, out3); }
...
#define UNI_MC_COPY(WIDTH) void ff_hevc_put_hevc_uni_pel_pixels##WIDTH##_8_msa(uint8_t *dst, ptrdiff_t dst_stride, uint8_t *src, ptrdiff_t src_stride, int height, intptr_t mx, intptr_t my, int width) { copy_width##WIDTH##_msa(src, src_stride, dst, dst_stride, height); }
...
#define UNI_MC(PEL, DIR, WIDTH, TAP, DIR1, FILT_DIR) void ff_hevc_put_hevc_uni_##PEL##_##DIR##WIDTH##_8_msa(uint8_t *dst, ptrdiff_t dst_stride, uint8_t *src, ptrdiff_t src_stride, int height, intptr_t mx, intptr_t my, int width) { const int8_t *filter = ff_hevc_##PEL##_filters[FILT_DIR - 1]; common_##DIR1##_##TAP##t_##WIDTH##w_msa(src, src_stride, dst, dst_stride, filter, height); }
