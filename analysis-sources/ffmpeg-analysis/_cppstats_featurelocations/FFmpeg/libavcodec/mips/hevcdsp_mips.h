...
#if !defined(AVCODEC_MIPS_HEVCDSP_MIPS_H)
#define AVCODEC_MIPS_HEVCDSP_MIPS_H

#include "libavcodec/hevcdsp.h"

#define MC(PEL, DIR, WIDTH) void ff_hevc_put_hevc_##PEL##_##DIR##WIDTH##_8_msa(int16_t *dst, uint8_t *src, ptrdiff_t src_stride, int height, intptr_t mx, intptr_t my, int width)
...
#define UNI_MC(PEL, DIR, WIDTH) void ff_hevc_put_hevc_uni_##PEL##_##DIR##WIDTH##_8_msa(uint8_t *dst, ptrdiff_t dst_stride, uint8_t *src, ptrdiff_t src_stride, int height, intptr_t mx, intptr_t my, int width)
...
#define UNI_W_MC(PEL, DIR, WIDTH) void ff_hevc_put_hevc_uni_w_##PEL##_##DIR##WIDTH##_8_msa(uint8_t *dst, ptrdiff_t dst_stride, uint8_t *src, ptrdiff_t src_stride, int height, int denom, int weight, int offset, intptr_t mx, intptr_t my, int width)
...
#define BI_MC(PEL, DIR, WIDTH) void ff_hevc_put_hevc_bi_##PEL##_##DIR##WIDTH##_8_msa(uint8_t *dst, ptrdiff_t dst_stride, uint8_t *src, ptrdiff_t src_stride, int16_t *src_16bit, int height, intptr_t mx, intptr_t my, int width)
...
#define BI_W_MC(PEL, DIR, WIDTH) void ff_hevc_put_hevc_bi_w_##PEL##_##DIR##WIDTH##_8_msa(uint8_t *dst, ptrdiff_t dst_stride, uint8_t *src, ptrdiff_t src_stride, int16_t *src_16bit, int height, int denom, int weight0, int weight1, int offset0, int offset1, intptr_t mx, intptr_t my, int width)
...
#define L_MC(PEL, DIR, WIDTH, TYPE) void ff_hevc_put_hevc_##PEL##_##DIR##WIDTH##_8_##TYPE(int16_t *dst, uint8_t *src, ptrdiff_t src_stride, int height, intptr_t mx, intptr_t my, int width)
...
#define L_BI_MC(PEL, DIR, WIDTH, TYPE) void ff_hevc_put_hevc_##PEL##_bi_##DIR##WIDTH##_8_##TYPE(uint8_t *dst, ptrdiff_t dst_stride, uint8_t *src, ptrdiff_t src_stride, int16_t *src2, int height, intptr_t mx, intptr_t my, int width)
...
#define L_UNI_MC(PEL, DIR, WIDTH, TYPE) void ff_hevc_put_hevc_##PEL##_uni_##DIR##WIDTH##_8_##TYPE(uint8_t *dst, ptrdiff_t dst_stride, uint8_t *src, ptrdiff_t src_stride, int height, intptr_t mx, intptr_t my, int width)
