...
#define MAP(va, rt, av, swap_uv) { VA_FOURCC_ ##va, VA_RT_FORMAT_ ##rt, AV_PIX_FMT_ ##av, swap_uv, }
...
#define DRM_MAP(va, layers, ...) { VA_FOURCC_ ##va, layers, { __VA_ARGS__ } }
