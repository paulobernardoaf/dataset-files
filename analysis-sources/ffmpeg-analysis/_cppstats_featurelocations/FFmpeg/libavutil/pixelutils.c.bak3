...
#define DECLARE_BLOCK_FUNCTIONS(size) static int block_sad_##size##x##size##_c(const uint8_t *src1, ptrdiff_t stride1, const uint8_t *src2, ptrdiff_t stride2) { return sad_wxh(src1, stride1, src2, stride2, size, size); }
