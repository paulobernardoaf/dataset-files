...
#define BAYER8_DESC_COMMON .nb_components= 3, .log2_chroma_w= 0, .log2_chroma_h= 0, .comp = { {0,1,0,0,2,0,1,1},{0,1,0,0,4,0,3,1},{0,1,0,0,2,0,1,1},}, 
...
#define BAYER16_DESC_COMMON .nb_components= 3, .log2_chroma_w= 0, .log2_chroma_h= 0, .comp = { {0,2,0,0,4,1,3,1},{0,2,0,0,8,1,7,1},{0,2,0,0,4,1,3,1},}, 
