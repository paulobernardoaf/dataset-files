...
#define BE_32(x) (((uint32_t)(((uint8_t*)(x))[0]) << 24) | (((uint8_t*)(x))[1] << 16) | (((uint8_t*)(x))[2] << 8) | ((uint8_t*)(x))[3])




#define BE_64(x) (((uint64_t)(((uint8_t*)(x))[0]) << 56) | ((uint64_t)(((uint8_t*)(x))[1]) << 48) | ((uint64_t)(((uint8_t*)(x))[2]) << 40) | ((uint64_t)(((uint8_t*)(x))[3]) << 32) | ((uint64_t)(((uint8_t*)(x))[4]) << 24) | ((uint64_t)(((uint8_t*)(x))[5]) << 16) | ((uint64_t)(((uint8_t*)(x))[6]) << 8) | ((uint64_t)( (uint8_t*)(x))[7]))
...
#define AV_WB32(p, val) { ((uint8_t*)(p))[0] = ((val) >> 24) & 0xff; ((uint8_t*)(p))[1] = ((val) >> 16) & 0xff; ((uint8_t*)(p))[2] = ((val) >> 8) & 0xff; ((uint8_t*)(p))[3] = (val) & 0xff; }
...
#define AV_WB64(p, val) { AV_WB32(p, (val) >> 32) AV_WB32(p + 4, val) }




#define BE_FOURCC(ch0, ch1, ch2, ch3) ( (uint32_t)(unsigned char)(ch3) | ((uint32_t)(unsigned char)(ch2) << 8) | ((uint32_t)(unsigned char)(ch1) << 16) | ((uint32_t)(unsigned char)(ch0) << 24) )
