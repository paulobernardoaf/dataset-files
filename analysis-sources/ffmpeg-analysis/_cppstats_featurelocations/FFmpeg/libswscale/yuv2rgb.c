...
#define LOADCHROMA(i) U = pu[i]; V = pv[i]; r = (void *)c->table_rV[V+YUVRGB_TABLE_HEADROOM]; g = (void *)(c->table_gU[U+YUVRGB_TABLE_HEADROOM] + c->table_gV[V+YUVRGB_TABLE_HEADROOM]); b = (void *)c->table_bU[U+YUVRGB_TABLE_HEADROOM];
...
#define PUTRGB(dst, src, i) Y = src[2 * i]; dst[2 * i] = r[Y] + g[Y] + b[Y]; Y = src[2 * i + 1]; dst[2 * i + 1] = r[Y] + g[Y] + b[Y];





#define PUTRGB24(dst, src, i) Y = src[2 * i]; dst[6 * i + 0] = r[Y]; dst[6 * i + 1] = g[Y]; dst[6 * i + 2] = b[Y]; Y = src[2 * i + 1]; dst[6 * i + 3] = r[Y]; dst[6 * i + 4] = g[Y]; dst[6 * i + 5] = b[Y];
...
#define PUTBGR24(dst, src, i) Y = src[2 * i]; dst[6 * i + 0] = b[Y]; dst[6 * i + 1] = g[Y]; dst[6 * i + 2] = r[Y]; Y = src[2 * i + 1]; dst[6 * i + 3] = b[Y]; dst[6 * i + 4] = g[Y]; dst[6 * i + 5] = r[Y];
...
#define PUTRGBA(dst, ysrc, asrc, i, s) Y = ysrc[2 * i]; dst[2 * i] = r[Y] + g[Y] + b[Y] + (asrc[2 * i] << s); Y = ysrc[2 * i + 1]; dst[2 * i + 1] = r[Y] + g[Y] + b[Y] + (asrc[2 * i + 1] << s);





#define PUTRGB48(dst, src, i) Y = src[ 2 * i]; dst[12 * i + 0] = dst[12 * i + 1] = r[Y]; dst[12 * i + 2] = dst[12 * i + 3] = g[Y]; dst[12 * i + 4] = dst[12 * i + 5] = b[Y]; Y = src[ 2 * i + 1]; dst[12 * i + 6] = dst[12 * i + 7] = r[Y]; dst[12 * i + 8] = dst[12 * i + 9] = g[Y]; dst[12 * i + 10] = dst[12 * i + 11] = b[Y];
...
#define PUTBGR48(dst, src, i) Y = src[2 * i]; dst[12 * i + 0] = dst[12 * i + 1] = b[Y]; dst[12 * i + 2] = dst[12 * i + 3] = g[Y]; dst[12 * i + 4] = dst[12 * i + 5] = r[Y]; Y = src[2 * i + 1]; dst[12 * i + 6] = dst[12 * i + 7] = b[Y]; dst[12 * i + 8] = dst[12 * i + 9] = g[Y]; dst[12 * i + 10] = dst[12 * i + 11] = r[Y];
...
#define ENDYUV2RGBLINE(dst_delta, ss) pu += 4 >> ss; pv += 4 >> ss; py_1 += 8 >> ss; py_2 += 8 >> ss; dst_1 += dst_delta >> ss; dst_2 += dst_delta >> ss; } if (c->dstW & (4 >> ss)) { int av_unused Y, U, V; 
...
#define ENDYUV2RGBFUNC() } } return srcSliceH; }





#define CLOSEYUV2RGBFUNC(dst_delta) ENDYUV2RGBLINE(dst_delta, 0) ENDYUV2RGBFUNC()
...
#define PUTRGB16(dst, src, i, o) Y = src[2 * i]; dst[2 * i] = r[Y + d16[0 + o]] + g[Y + e16[0 + o]] + b[Y + f16[0 + o]]; Y = src[2 * i + 1]; dst[2 * i + 1] = r[Y + d16[1 + o]] + g[Y + e16[1 + o]] + b[Y + f16[1 + o]];
...
#define PUTRGB15(dst, src, i, o) Y = src[2 * i]; dst[2 * i] = r[Y + d16[0 + o]] + g[Y + d16[1 + o]] + b[Y + e16[0 + o]]; Y = src[2 * i + 1]; dst[2 * i + 1] = r[Y + d16[1 + o]] + g[Y + d16[0 + o]] + b[Y + e16[1 + o]];
...
#define PUTRGB12(dst, src, i, o) Y = src[2 * i]; dst[2 * i] = r[Y + d16[0 + o]] + g[Y + d16[0 + o]] + b[Y + d16[0 + o]]; Y = src[2 * i + 1]; dst[2 * i + 1] = r[Y + d16[1 + o]] + g[Y + d16[1 + o]] + b[Y + d16[1 + o]];
...
#define PUTRGB8(dst, src, i, o) Y = src[2 * i]; dst[2 * i] = r[Y + d32[0 + o]] + g[Y + d32[0 + o]] + b[Y + d64[0 + o]]; Y = src[2 * i + 1]; dst[2 * i + 1] = r[Y + d32[1 + o]] + g[Y + d32[1 + o]] + b[Y + d64[1 + o]];
...
#define PUTRGB4D(dst, src, i, o) Y = src[2 * i]; acc = r[Y + d128[0 + o]] + g[Y + d64[0 + o]] + b[Y + d128[0 + o]]; Y = src[2 * i + 1]; acc |= (r[Y + d128[1 + o]] + g[Y + d64[1 + o]] + b[Y + d128[1 + o]]) << 4; dst[i] = acc;
...
#define PUTRGB4DB(dst, src, i, o) Y = src[2 * i]; dst[2 * i] = r[Y + d128[0 + o]] + g[Y + d64[0 + o]] + b[Y + d128[0 + o]]; Y = src[2 * i + 1]; dst[2 * i + 1] = r[Y + d128[1 + o]] + g[Y + d64[1 + o]] + b[Y + d128[1 + o]];
...
#define PUTRGB1(out, src, i, o) Y = src[2 * i]; out += out + g[Y + d128[0 + o]]; Y = src[2 * i + 1]; out += out + g[Y + d128[1 + o]];
...
#define ALLOC_YUV_TABLE(x) c->yuvTable = av_malloc(x); if (!c->yuvTable) return AVERROR(ENOMEM);
