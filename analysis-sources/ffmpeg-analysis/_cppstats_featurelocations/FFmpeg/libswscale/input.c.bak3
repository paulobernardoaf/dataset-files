...
#define input_pixel(i) ((origin == AV_PIX_FMT_RGBA || origin == AV_PIX_FMT_BGRA || origin == AV_PIX_FMT_ARGB || origin == AV_PIX_FMT_ABGR) ? AV_RN32A(&src[(i) * 4]) : (isBE(origin) ? AV_RB16(&src[(i) * 2]) : AV_RL16(&src[(i) * 2])))
...
#define rgb16_32_wrapper(fmt, name, shr, shg, shb, shp, maskr, maskg, maskb, rsh, gsh, bsh, S) static void name ##ToY_c(uint8_t *dst, const uint8_t *src, const uint8_t *unused1, const uint8_t *unused2, int width, uint32_t *tab) { rgb16_32ToY_c_template((int16_t*)dst, src, width, fmt, shr, shg, shb, shp, maskr, maskg, maskb, rsh, gsh, bsh, S, tab); } static void name ##ToUV_c(uint8_t *dstU, uint8_t *dstV, const uint8_t *unused0, const uint8_t *src, const uint8_t *dummy, int width, uint32_t *tab) { rgb16_32ToUV_c_template((int16_t*)dstU, (int16_t*)dstV, src, width, fmt, shr, shg, shb, shp, maskr, maskg, maskb, rsh, gsh, bsh, S, tab);} static void name ##ToUV_half_c(uint8_t *dstU, uint8_t *dstV, const uint8_t *unused0, const uint8_t *src, const uint8_t *dummy, int width, uint32_t *tab) { rgb16_32ToUV_half_c_template((int16_t*)dstU, (int16_t*)dstV, src, width, fmt, shr, shg, shb, shp, maskr, maskg, maskb, rsh, gsh, bsh, S, tab); }
...
#define rgb9plus_planar_funcs_endian(nbits, endian_name, endian) static void planar_rgb##nbits##endian_name##_to_y(uint8_t *dst, const uint8_t *src[4], int w, int32_t *rgb2yuv) { planar_rgb16_to_y(dst, src, w, nbits, endian, rgb2yuv); } static void planar_rgb##nbits##endian_name##_to_uv(uint8_t *dstU, uint8_t *dstV, const uint8_t *src[4], int w, int32_t *rgb2yuv) { planar_rgb16_to_uv(dstU, dstV, src, w, nbits, endian, rgb2yuv); } 
...
#define rgb9plus_planar_funcs(nbits) rgb9plus_planar_funcs_endian(nbits, le, 0) rgb9plus_planar_funcs_endian(nbits, be, 1)
