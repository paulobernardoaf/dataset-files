...
#define YSCALEYUV2PACKEDX YSCALEYUV2PACKEDX_UV YSCALEYUV2PACKEDX_YA(LUM_MMX_FILTER_OFFSET,%%mm0,%%mm2,%%mm5,%%mm1,%%mm7) 



#define YSCALEYUV2PACKEDX_END :: "r" (&c->redDither), "m" (dummy), "m" (dummy), "m" (dummy),"r" (dest), "m" (dstW_reg), "m"(uv_off) NAMED_CONSTRAINTS_ADD(bF8,bFC) : "%"FF_REG_a, "%"FF_REG_d, "%"FF_REG_S );
...
#define YSCALEYUV2PACKEDX_ACCURATE YSCALEYUV2PACKEDX_ACCURATE_UV YSCALEYUV2PACKEDX_ACCURATE_YA(LUM_MMX_FILTER_OFFSET)
