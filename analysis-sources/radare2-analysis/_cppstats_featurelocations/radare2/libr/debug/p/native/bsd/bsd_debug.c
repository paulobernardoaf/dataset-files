...
#define KVM_GETPROCS(kd, opt, arg, cntptr) kvm_getproc2 (kd, opt, arg, sizeof(struct kinfo_proc2), cntptr)
...
#define KVM_OPEN_FLAG KVM_NO_FILES
#define KVM_GETPROCS(kd, opt, arg, cntptr) kvm_getprocs (kd, opt, arg, sizeof(struct kinfo_proc), cntptr)
...
#define KVM_GETPROCS(kd, opt, arg, cntptr) kvm_getprocs (kd, opt, arg, cntptr)
