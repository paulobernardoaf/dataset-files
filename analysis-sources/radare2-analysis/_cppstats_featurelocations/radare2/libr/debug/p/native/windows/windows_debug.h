...
#if !defined(XSTATE_GSSE)
#define XSTATE_GSSE 2
#endif

#if !defined(XSTATE_LEGACY_SSE)
...
DWORD (WINAPI *w32_GetThreadId)(HANDLE); 
DWORD (WINAPI *w32_GetProcessId)(HANDLE); 
