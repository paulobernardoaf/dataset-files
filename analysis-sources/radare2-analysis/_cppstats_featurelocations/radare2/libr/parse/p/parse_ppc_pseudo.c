...
if (!strcmp (w1, w2)) {
char a[64], b[64];
#define REPLACE(x,y) do { int snprintf_len1_ = snprintf (a, 64, x, w1, w1); int snprintf_len2_ = snprintf (b, 64, y, w1); if (snprintf_len1_ < 64 && snprintf_len2_ < 64) { p = r_str_replace (p, a, b, 0); } } while (0)
