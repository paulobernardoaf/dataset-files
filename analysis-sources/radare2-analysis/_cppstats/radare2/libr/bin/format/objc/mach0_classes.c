...
mach0_ut ivarLayout; 
mach0_ut name; 
mach0_ut baseMethods; 
mach0_ut baseProtocols; 
mach0_ut ivars; 
mach0_ut weakIvarLayout; 
mach0_ut baseProperties; 
};
...
mach0_ut optionalInstanceMethods; 
mach0_ut optionalClassMethods; 
mach0_ut instanceProperties; 
};
