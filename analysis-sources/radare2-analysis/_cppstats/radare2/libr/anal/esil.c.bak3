...
#define cpuflag(x, y)if (esil) {if (y) { R_BIT_SET (&esil->flags, FLG (x));} else { R_BIT_UNSET (&esil->flags, FLG (x));} }
...
static bool esil_smaller(RAnalEsil *esil) { 
ut64 num, num2;
bool ret = false;
char *dst = r_anal_esil_pop (esil);
char *src = r_anal_esil_pop (esil);
...
static bool esil_bigger(RAnalEsil *esil) { 
ut64 num, num2;
bool ret = false;
char *dst = r_anal_esil_pop (esil);
char *src = r_anal_esil_pop (esil);
...
static bool esil_bigger_equal(RAnalEsil *esil) { 
ut64 num, num2;
bool ret = false;
char *dst = r_anal_esil_pop (esil);
char *src = r_anal_esil_pop (esil);
