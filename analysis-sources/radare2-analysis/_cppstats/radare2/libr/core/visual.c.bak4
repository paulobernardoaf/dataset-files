...
"Z", "shift-tab rotate print modes", 
...
#endif
case R_CORE_VISUAL_MODE_PX: 
if (currentFormat == 3 || currentFormat == 9 || currentFormat == 5) { 
r_core_block_size (core, (int)(core->cons->rows * hexcols * 4));
} else if ((R_ABS (hexMode) % 3) == 0) { 
r_core_block_size (core, (int)(core->cons->rows * hexcols));
} else {
...
if (core->printidx == R_CORE_VISUAL_MODE_DB) {
const int pxa = r_config_get_i (core->config, "stack.anotated"); 
