...
#define HEXAGON_MAP_SIGN(TAG) static void HEXAGON_MAP_FNAME (TAG) (char *i, size_t n, const hexagon_operand_arg args [])

#define MAP_FUNCTION(TAG) HEXAGON_MAP_SIGN (TAG); HEXAGON_MAP_SIGN (TAG)


#define DEST i, n
#define GET_OP_VAL(N) ((int) args [N].value)
#define GET_OP_STR(N) (args [N].string [0] == '#' ? args [N].string + 1 : args [N].string)
