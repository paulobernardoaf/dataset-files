...
#define NIOS2_NUM_REGS ((sizeof nios2_builtin_regs) / (sizeof (nios2_builtin_regs[0])))
...
#define NIOS2_NUM_OPCODES ((sizeof nios2_builtin_opcodes) / (sizeof (nios2_builtin_opcodes[0])))
