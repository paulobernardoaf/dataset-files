...
#define R2R_CMD_TEST_FOREACH_RECORD(macro_str, macro_bool) macro_str ("NAME", name) macro_str ("FILE", file) macro_str ("ARGS", args) macro_str ("SOURCE", source) macro_str ("CMDS", cmds) macro_str ("EXPECT", expect) macro_str ("EXPECT_ERR", expect_err) macro_bool ("BROKEN", broken)
