...
#define init_test_vector(v, len, padding, free, free_user) { bool _r = _init_test_vector((v), (len), (padding), (free), (free_user)); mu_assert ("init_test_vector", _r); }
...
#define init_test_pvector(v, len, padding) { bool _r = _init_test_pvector((v), (len), (padding)); mu_assert ("init_test_pvector", _r); }
...
#define init_test_pvector2(v, len, padding) { bool _r = _init_test_pvector2((v), (len), (padding)); mu_assert ("init_test_pvector2", _r); }
