...
#define __ASN1_ERR(l) fprintf(stderr, __ASN1_FMTSTRING_FMT "\n", __ASN1_FMTSTRING_VAL(l)); exit(EXIT_FAILURE)
#define __CHECK_ASN1_HAS(l, w) do { if ((l)->w == NULL) { __ASN1_ERR(l);} } while(0)
#define __CHECK_ASN1_HAS_NO(l, w) do { if ((l)->w != NULL) { __ASN1_ERR(l);} } while(0)
#define CHECK_ASN1_TYPE(l, t) do { if ((l)->type != (t)) { __ASN1_ERR(l);} } while(0)
...
#if defined(LTC_DER_TESTS_PRINT_FLEXI)
...
#define typeof(x) x
#endif
#define DER_XCODE_X(n, b, x) { (_der_Xcode)der_encode_ ##n, (_der_Xcode)der_decode_ ##n, b, sizeof(b), x, sizeof(typeof(b[0])),#n }
...
static const unsigned char issue_507[] = "\x30\x04" 
"\x0c\x02\xbf\xbf" 
"\xaa" 
"\x04\x82\xff\xff"; 
unsigned long len;
...
0x30,0x19, 
0x30,0x0a, 
0x04,0x05, 0x2b,0x0e,0x03,0x02,0x1a,
0x05,0x00, 
0x04,0x0c, 0xf7,0xff,0x9e,0x8b,0x7b,0xb2,0xe0,0x9b,0x70,0x93,0x5a,0x5d,
};
static const unsigned char invalid2[] = {
0x30,0x0d, 
0x02,0x05, 0x00,0xb7,0xba,0xba,0xe9,
0x02,0x04, 0x74,0x72,0x91,0xdd,
0x00,0x00 
};
