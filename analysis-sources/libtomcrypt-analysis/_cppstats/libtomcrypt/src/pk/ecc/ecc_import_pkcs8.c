...
#define LTC_SET_DER_FLEXI_CHECK(list, index, Type, P) do { int LTC_SDFC_temp##__LINE__ = (index); list[LTC_SDFC_temp##__LINE__].t = Type; list[LTC_SDFC_temp##__LINE__].pp = P; } while (0)
