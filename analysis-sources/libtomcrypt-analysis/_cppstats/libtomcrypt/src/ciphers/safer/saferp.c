...
#define ROUND(b, i) do { b[0] = (safer_ebox[(b[0] ^ skey->saferp.K[i][0]) & 255] + skey->saferp.K[i+1][0]) & 255; b[1] = safer_lbox[(b[1] + skey->saferp.K[i][1]) & 255] ^ skey->saferp.K[i+1][1]; b[2] = safer_lbox[(b[2] + skey->saferp.K[i][2]) & 255] ^ skey->saferp.K[i+1][2]; b[3] = (safer_ebox[(b[3] ^ skey->saferp.K[i][3]) & 255] + skey->saferp.K[i+1][3]) & 255; b[4] = (safer_ebox[(b[4] ^ skey->saferp.K[i][4]) & 255] + skey->saferp.K[i+1][4]) & 255; b[5] = safer_lbox[(b[5] + skey->saferp.K[i][5]) & 255] ^ skey->saferp.K[i+1][5]; b[6] = safer_lbox[(b[6] + skey->saferp.K[i][6]) & 255] ^ skey->saferp.K[i+1][6]; b[7] = (safer_ebox[(b[7] ^ skey->saferp.K[i][7]) & 255] + skey->saferp.K[i+1][7]) & 255; b[8] = (safer_ebox[(b[8] ^ skey->saferp.K[i][8]) & 255] + skey->saferp.K[i+1][8]) & 255; b[9] = safer_lbox[(b[9] + skey->saferp.K[i][9]) & 255] ^ skey->saferp.K[i+1][9]; b[10] = safer_lbox[(b[10] + skey->saferp.K[i][10]) & 255] ^ skey->saferp.K[i+1][10]; b[11] = (safer_ebox[(b[11] ^ skey->saferp.K[i][11]) & 255] + skey->saferp.K[i+1][11]) & 255; b[12] = (safer_ebox[(b[12] ^ skey->saferp.K[i][12]) & 255] + skey->saferp.K[i+1][12]) & 255; b[13] = safer_lbox[(b[13] + skey->saferp.K[i][13]) & 255] ^ skey->saferp.K[i+1][13]; b[14] = safer_lbox[(b[14] + skey->saferp.K[i][14]) & 255] ^ skey->saferp.K[i+1][14]; b[15] = (safer_ebox[(b[15] ^ skey->saferp.K[i][15]) & 255] + skey->saferp.K[i+1][15]) & 255; } while (0)
#define iROUND(b, i) do { b[0] = safer_lbox[(b[0] - skey->saferp.K[i+1][0]) & 255] ^ skey->saferp.K[i][0]; b[1] = (safer_ebox[(b[1] ^ skey->saferp.K[i+1][1]) & 255] - skey->saferp.K[i][1]) & 255; b[2] = (safer_ebox[(b[2] ^ skey->saferp.K[i+1][2]) & 255] - skey->saferp.K[i][2]) & 255; b[3] = safer_lbox[(b[3] - skey->saferp.K[i+1][3]) & 255] ^ skey->saferp.K[i][3]; b[4] = safer_lbox[(b[4] - skey->saferp.K[i+1][4]) & 255] ^ skey->saferp.K[i][4]; b[5] = (safer_ebox[(b[5] ^ skey->saferp.K[i+1][5]) & 255] - skey->saferp.K[i][5]) & 255; b[6] = (safer_ebox[(b[6] ^ skey->saferp.K[i+1][6]) & 255] - skey->saferp.K[i][6]) & 255; b[7] = safer_lbox[(b[7] - skey->saferp.K[i+1][7]) & 255] ^ skey->saferp.K[i][7]; b[8] = safer_lbox[(b[8] - skey->saferp.K[i+1][8]) & 255] ^ skey->saferp.K[i][8]; b[9] = (safer_ebox[(b[9] ^ skey->saferp.K[i+1][9]) & 255] - skey->saferp.K[i][9]) & 255; b[10] = (safer_ebox[(b[10] ^ skey->saferp.K[i+1][10]) & 255] - skey->saferp.K[i][10]) & 255; b[11] = safer_lbox[(b[11] - skey->saferp.K[i+1][11]) & 255] ^ skey->saferp.K[i][11]; b[12] = safer_lbox[(b[12] - skey->saferp.K[i+1][12]) & 255] ^ skey->saferp.K[i][12]; b[13] = (safer_ebox[(b[13] ^ skey->saferp.K[i+1][13]) & 255] - skey->saferp.K[i][13]) & 255; b[14] = (safer_ebox[(b[14] ^ skey->saferp.K[i+1][14]) & 255] - skey->saferp.K[i][14]) & 255; b[15] = safer_lbox[(b[15] - skey->saferp.K[i+1][15]) & 255] ^ skey->saferp.K[i][15]; } while (0)
#define PHT(b) do { b[0] = (b[0] + (b[1] = (b[0] + b[1]) & 255)) & 255; b[2] = (b[2] + (b[3] = (b[3] + b[2]) & 255)) & 255; b[4] = (b[4] + (b[5] = (b[5] + b[4]) & 255)) & 255; b[6] = (b[6] + (b[7] = (b[7] + b[6]) & 255)) & 255; b[8] = (b[8] + (b[9] = (b[9] + b[8]) & 255)) & 255; b[10] = (b[10] + (b[11] = (b[11] + b[10]) & 255)) & 255; b[12] = (b[12] + (b[13] = (b[13] + b[12]) & 255)) & 255; b[14] = (b[14] + (b[15] = (b[15] + b[14]) & 255)) & 255; } while (0)
#define iPHT(b) do { b[15] = (b[15] - (b[14] = (b[14] - b[15]) & 255)) & 255; b[13] = (b[13] - (b[12] = (b[12] - b[13]) & 255)) & 255; b[11] = (b[11] - (b[10] = (b[10] - b[11]) & 255)) & 255; b[9] = (b[9] - (b[8] = (b[8] - b[9]) & 255)) & 255; b[7] = (b[7] - (b[6] = (b[6] - b[7]) & 255)) & 255; b[5] = (b[5] - (b[4] = (b[4] - b[5]) & 255)) & 255; b[3] = (b[3] - (b[2] = (b[2] - b[3]) & 255)) & 255; b[1] = (b[1] - (b[0] = (b[0] - b[1]) & 255)) & 255; } while (0)
#define SHUF(b, b2) do { b2[0] = b[8]; b2[1] = b[11]; b2[2] = b[12]; b2[3] = b[15]; b2[4] = b[2]; b2[5] = b[1]; b2[6] = b[6]; b2[7] = b[5]; b2[8] = b[10]; b2[9] = b[9]; b2[10] = b[14]; b2[11] = b[13]; b2[12] = b[0]; b2[13] = b[7]; b2[14] = b[4]; b2[15] = b[3]; } while (0)
#define iSHUF(b, b2) do { b2[0] = b[12]; b2[1] = b[5]; b2[2] = b[4]; b2[3] = b[15]; b2[4] = b[14]; b2[5] = b[7]; b2[6] = b[6]; b2[7] = b[13]; b2[8] = b[0]; b2[9] = b[9]; b2[10] = b[8]; b2[11] = b[1]; b2[12] = b[2]; b2[13] = b[11]; b2[14] = b[10]; b2[15] = b[3]; } while (0)
#define LT(b, b2) do { PHT(b); SHUF(b, b2); PHT(b2); SHUF(b2, b); PHT(b); SHUF(b, b2); PHT(b2); } while (0)
#define iLT(b, b2) do { iPHT(b); iSHUF(b, b2); iPHT(b2); iSHUF(b2, b); iPHT(b); iSHUF(b, b2); iPHT(b2); } while (0)
