...
#define S0(r0, r1, r2, r3, r4) do { r3 ^= r0; r4 = r1; r1 &= r3; r4 ^= r2; r1 ^= r0; r0 |= r3; r0 ^= r4; r4 ^= r3; r3 ^= r2; r2 |= r1; r2 ^= r4; r4 = ~r4; r4 |= r1; r1 ^= r3; r1 ^= r4; r3 |= r0; r1 ^= r3; r4 ^= r3; } while (0)
#define S1(r0, r1, r2, r3, r4) do { r0 = ~r0; r2 = ~r2; r4 = r0; r0 &= r1; r2 ^= r0; r0 |= r3; r3 ^= r2; r1 ^= r0; r0 ^= r4; r4 |= r1; r1 ^= r3; r2 |= r0; r2 &= r4; r0 ^= r1; r1 &= r2; r1 ^= r0; r0 &= r2; r0 ^= r4; } while (0)
#define S2(r0, r1, r2, r3, r4) do { r4 = r0; r0 &= r2; r0 ^= r3; r2 ^= r1; r2 ^= r0; r3 |= r4; r3 ^= r1; r4 ^= r2; r1 = r3; r3 |= r4; r3 ^= r0; r0 &= r1; r4 ^= r0; r1 ^= r3; r1 ^= r4; r4 = ~r4; } while (0)
#define S3(r0, r1, r2, r3, r4) do { r4 = r0; r0 |= r3; r3 ^= r1; r1 &= r4; r4 ^= r2; r2 ^= r3; r3 &= r0; r4 |= r1; r3 ^= r4; r0 ^= r1; r4 &= r0; r1 ^= r3; r4 ^= r2; r1 |= r0; r1 ^= r2; r0 ^= r3; r2 = r1; r1 |= r3; r1 ^= r0; } while (0)
#define S4(r0, r1, r2, r3, r4) do { r1 ^= r3; r3 = ~r3; r2 ^= r3; r3 ^= r0; r4 = r1; r1 &= r3; r1 ^= r2; r4 ^= r3; r0 ^= r4; r2 &= r4; r2 ^= r0; r0 &= r1; r3 ^= r0; r4 |= r1; r4 ^= r0; r0 |= r3; r0 ^= r2; r2 &= r3; r0 = ~r0; r4 ^= r2; } while (0)
#define S5(r0, r1, r2, r3, r4) do { r0 ^= r1; r1 ^= r3; r3 = ~r3; r4 = r1; r1 &= r0; r2 ^= r3; r1 ^= r2; r2 |= r4; r4 ^= r3; r3 &= r1; r3 ^= r0; r4 ^= r1; r4 ^= r2; r2 ^= r0; r0 &= r3; r2 = ~r2; r0 ^= r4; r4 |= r3; r2 ^= r4; } while (0)
#define S6(r0, r1, r2, r3, r4) do { r2 = ~r2; r4 = r3; r3 &= r0; r0 ^= r4; r3 ^= r2; r2 |= r4; r1 ^= r3; r2 ^= r0; r0 |= r1; r2 ^= r1; r4 ^= r0; r0 |= r3; r0 ^= r2; r4 ^= r3; r4 ^= r0; r3 = ~r3; r2 &= r4; r2 ^= r3; } while (0)
#define S7(r0, r1, r2, r3, r4) do { r4 = r1; r1 |= r2; r1 ^= r3; r4 ^= r2; r2 ^= r1; r3 |= r4; r3 &= r0; r4 ^= r2; r3 ^= r1; r1 |= r4; r1 ^= r0; r0 |= r4; r0 ^= r2; r1 ^= r4; r2 ^= r1; r1 &= r0; r1 ^= r4; r2 = ~r2; r2 |= r0; r4 ^= r2; } while (0)
#define SERPENT_LT(x0, x1, x2, x3) do { x0 = ROLc(x0, 13); x2 = ROLc(x2, 3); x1 = x1 ^ x0 ^ x2; x3 = x3 ^ x2 ^ T32(x0 << 3); x1 = ROLc(x1, 1); x3 = ROLc(x3, 7); x0 = x0 ^ x1 ^ x3; x2 = x2 ^ x3 ^ T32(x1 << 7); x0 = ROLc(x0, 5); x2 = ROLc(x2, 22); } while (0)
int sosemanuk_setup(sosemanuk_state *st, const unsigned char *key, unsigned long keylen)
{
#define SKS(S, o0, o1, o2, o3, d0, d1, d2, d3) do { ulong32 r0, r1, r2, r3, r4; r0 = w ##o0; r1 = w ##o1; r2 = w ##o2; r3 = w ##o3; S(r0, r1, r2, r3, r4); st->kc[i ++] = r ##d0; st->kc[i ++] = r ##d1; st->kc[i ++] = r ##d2; st->kc[i ++] = r ##d3; } while (0)
...
#define WUP(wi, wi5, wi3, wi1, cc) do { ulong32 tt = (wi) ^ (wi5) ^ (wi3) ^ (wi1) ^ (0x9E3779B9 ^ (ulong32)(cc)); (wi) = ROLc(tt, 11); } while (0)
#define WUP0(cc) do { WUP(w0, w3, w5, w7, cc); WUP(w1, w4, w6, w0, cc + 1); WUP(w2, w5, w7, w1, cc + 2); WUP(w3, w6, w0, w2, cc + 3); } while (0)
#define WUP1(cc) do { WUP(w4, w7, w1, w3, cc); WUP(w5, w0, w2, w4, cc + 1); WUP(w6, w1, w3, w5, cc + 2); WUP(w7, w2, w4, w6, cc + 3); } while (0)
...
{
#define KA(zc, x0, x1, x2, x3) do { x0 ^= st->kc[(zc)]; x1 ^= st->kc[(zc) + 1]; x2 ^= st->kc[(zc) + 2]; x3 ^= st->kc[(zc) + 3]; } while (0)
#define FSS(zc, S, i0, i1, i2, i3, i4, o0, o1, o2, o3) do { KA(zc, r ##i0, r ##i1, r ##i2, r ##i3); S(r ##i0, r ##i1, r ##i2, r ##i3, r ##i4); SERPENT_LT(r ##o0, r ##o1, r ##o2, r ##o3); } while (0)
#define FSF(zc, S, i0, i1, i2, i3, i4, o0, o1, o2, o3) do { KA(zc, r ##i0, r ##i1, r ##i2, r ##i3); S(r ##i0, r ##i1, r ##i2, r ##i3, r ##i4); SERPENT_LT(r ##o0, r ##o1, r ##o2, r ##o3); KA(zc + 4, r ##o0, r ##o1, r ##o2, r ##o3); } while (0)
...
#endif
#define FSM(x0, x1, x2, x3, x4, x5, x6, x7, x8, x9) do { ulong32 tt, or1; tt = XMUX(r1, s ##x1, s ##x8); or1 = r1; r1 = T32(r2 + tt); tt = T32(or1 * 0x54655307); r2 = ROLc(tt, 7); } while (0)
#define LRU(x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, dd) do { dd = s ##x0; s ##x0 = MUL_A(s ##x0) ^ MUL_G(s ##x3) ^ s ##x9; } while (0)
#define CC1(x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, ee) do { ee = T32(s ##x9 + r1) ^ r2; } while (0)
#define STEP(x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, dd, ee) do { FSM(x0, x1, x2, x3, x4, x5, x6, x7, x8, x9); LRU(x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, dd); CC1(x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, ee); } while (0)
#define SRD(S, x0, x1, x2, x3, ooff) do { S(u0, u1, u2, u3, u4); STORE32L(u ##x0 ^ v0, st->buf + ooff); STORE32L(u ##x1 ^ v1, st->buf + ooff + 4); STORE32L(u ##x2 ^ v2, st->buf + ooff + 8); STORE32L(u ##x3 ^ v3, st->buf + ooff + 12); } while (0)
ulong32 s00 = st->s00;
ulong32 s01 = st->s01;
ulong32 s02 = st->s02;
ulong32 s03 = st->s03;
