...
#if !defined(LTC_EXPORT)
#define LTC_EXPORT
#endif


#if !defined(LTC_NO_PROTOTYPES)
...
#if defined(_BYTE_ORDER) && _BYTE_ORDER == _BIG_ENDIAN || defined(__BYTE_ORDER) && __BYTE_ORDER == __BIG_ENDIAN || defined(__BYTE_ORDER__) && __BYTE_ORDER__ == __ORDER_BIG_ENDIAN__ || defined(__BIG_ENDIAN__) || defined(__ARMEB__) || defined(__THUMBEB__) || defined(__AARCH64EB__) || defined(_MIPSEB) || defined(__MIPSEB) || defined(__MIPSEB__)
...
#endif
#if !defined(LTC_NO_BSWAP) && defined(__GNUC__) && ((__GNUC__ * 100 + __GNUC_MINOR__ >= 403) || (__has_builtin(__builtin_bswap32) && __has_builtin(__builtin_bswap64)))
