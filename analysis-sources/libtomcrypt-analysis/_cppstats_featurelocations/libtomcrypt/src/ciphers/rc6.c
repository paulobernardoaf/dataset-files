...
#define RND(a,b,c,d) t = (b * (b + b + 1)); t = ROLc(t, 5); u = (d * (d + d + 1)); u = ROLc(u, 5); a = ROL(a^t,u) + K[0]; c = ROL(c^u,t) + K[1]; K += 2;
...
#define RND(a,b,c,d) t = (b * (b + b + 1)); t = ROLc(t, 5); u = (d * (d + d + 1)); u = ROLc(u, 5); c = ROR(c - K[1], t) ^ u; a = ROR(a - K[0], u) ^ t; K -= 2;
