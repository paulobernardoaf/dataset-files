...
FUNC_ATTR_NONNULL_ALL
{
#define PRINT_ERROR(msg) do { errmsg = msg; errmsg_len = sizeof(msg) - 1; goto nlua_print_error; } while (0)
...
*p = prog;
lua_getfield(lstate, LUA_REGISTRYINDEX, "nvim_regex"); 
lua_setmetatable(lstate, -2); 
return 1;
}
