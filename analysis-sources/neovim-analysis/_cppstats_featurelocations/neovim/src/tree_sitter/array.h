#if !defined(TREE_SITTER_ARRAY_H_)
...
#define array_push(self, element) (array__grow((VoidArray *)(self), 1, array__elem_size(self)), (self)->contents[(self)->size++] = (element))



#define array_grow_by(self, count) (array__grow((VoidArray *)(self), count, array__elem_size(self)), memset((self)->contents + (self)->size, 0, (count) * array__elem_size(self)), (self)->size += (count))
...
#define array_splice(self, index, old_count, new_count, new_contents) array__splice((VoidArray *)(self), array__elem_size(self), index, old_count, new_count, new_contents)
