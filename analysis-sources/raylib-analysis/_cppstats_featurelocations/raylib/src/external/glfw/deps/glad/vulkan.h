...
#if !defined(GLAD_PLATFORM_H_)
#define GLAD_PLATFORM_H_

#if !defined(GLAD_PLATFORM_WIN32)
...
#if !defined(GLAD_PLATFORM_APPLE)
...
#if !defined(GLAD_PLATFORM_EMSCRIPTEN)
