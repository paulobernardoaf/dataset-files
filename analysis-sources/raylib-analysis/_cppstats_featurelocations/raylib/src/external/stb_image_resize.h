...
#if !defined(STBIR_INCLUDE_STB_IMAGE_RESIZE_H)
...
#if !defined(STBIRDEF)
#if defined(STB_IMAGE_RESIZE_STATIC)
...
#if !defined(STBIR_DEFAULT_FILTER_UPSAMPLE)
#define STBIR_DEFAULT_FILTER_UPSAMPLE STBIR_FILTER_CATMULLROM
#endif

#if !defined(STBIR_DEFAULT_FILTER_DOWNSAMPLE)
#define STBIR_DEFAULT_FILTER_DOWNSAMPLE STBIR_FILTER_MITCHELL
#endif

#if !defined(STBIR_PROGRESS_REPORT)
#define STBIR_PROGRESS_REPORT(float_0_to_1)
#endif

#if !defined(STBIR_MAX_CHANNELS)
...
#if !defined(STBIR_ALPHA_EPSILON)
...
#if !defined(STBIR_NON_IEEE_FLOAT)
...
STBIR_ASSERT(in_last_pixel - in_first_pixel <= (int)ceil(stbir__filter_info_table[filter].support(1/scale) * 2)); 
...
STBIR_ASSERT(total_filter < 1.1f); 
...
STBIR_ASSERT(out_last_pixel - out_first_pixel <= (int)ceil(stbir__filter_info_table[filter].support(scale_ratio) * 2)); 
...
#if !defined(STBIR_NO_ALPHA_EPSILON)
...
#if defined(STBIR__SATURATE_INT)
...
#if defined(STBIR_DEBUG_OVERWRITE_TEST)
