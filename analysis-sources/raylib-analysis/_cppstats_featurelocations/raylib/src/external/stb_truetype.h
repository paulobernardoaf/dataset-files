...
#if !defined(STBTT_ifloor)
#include <math.h>
#define STBTT_ifloor(x) ((int) floor(x))
#define STBTT_iceil(x) ((int) ceil(x))
#endif

#if !defined(STBTT_sqrt)
#include <math.h>
#define STBTT_sqrt(x) sqrt(x)
#define STBTT_pow(x,y) pow(x,y)
#endif

#if !defined(STBTT_fmod)
#include <math.h>
#define STBTT_fmod(x,y) fmod(x,y)
#endif

#if !defined(STBTT_cos)
#include <math.h>
#define STBTT_cos(x) cos(x)
#define STBTT_acos(x) acos(x)
#endif

#if !defined(STBTT_fabs)
#include <math.h>
...
#if !defined(STBTT_assert)
#include <assert.h>
#define STBTT_assert(x) assert(x)
#endif

#if !defined(STBTT_strlen)
#include <string.h>
#define STBTT_strlen(x) strlen(x)
#endif

#if !defined(STBTT_memcpy)
#include <string.h>
...
#if !defined(STB_RECT_PACK_VERSION)
...
#if !defined(STBTT_MAX_OVERSAMPLE)
...
#if !defined(STBTT_RASTERIZER_VERSION)
