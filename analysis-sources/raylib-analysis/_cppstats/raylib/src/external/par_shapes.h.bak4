...
#if defined(PAR_SHAPES_IMPLEMENTATION)
#include <stdlib.h>
#include <stdio.h>
#include <assert.h>
#include <float.h>
...
#define STRETCH_CONSTANT_4D (-0.138196601125011) 
#define SQUISH_CONSTANT_4D (0.309016994374947) 
