...
#if !defined(DR_MP3_DEFAULT_CHANNELS)
#define DR_MP3_DEFAULT_CHANNELS 2
#endif
#if !defined(DR_MP3_DEFAULT_SAMPLE_RATE)
...
#if !defined(DRMP3_MAX_FRAME_SYNC_MATCHES)
...
#if !defined(DR_MP3_NONSTANDARD_BUT_LOGICAL)
if (nch == 1)
{
for (i = 0; i < 15*64; i += 2)
{
...
pcmFramesRead = drmp3dec_decode_frame(&pMP3->decoder, pMP3->pData, (int)pMP3->dataSize, pPCMFrames, &info); 
...
drmp3dec_f32_to_s16(tempF32, pBufferOut, (int)(pcmFramesJustRead * pMP3->channels)); 
...
pMP3->src.algo.linear.alpha = (drmp3_int64)pMP3->currentPCMFrame * ((double)pMP3->src.config.sampleRateIn / pMP3->src.config.sampleRateOut); 
...
totalPCMFrameCountFractionalPart = 0; 
for (;;) {
