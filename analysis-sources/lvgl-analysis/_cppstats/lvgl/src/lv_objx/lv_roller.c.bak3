...
lv_page_set_scrl_fit2(new_roller, LV_FIT_TIGHT, LV_FIT_NONE); 
...
size_t opt_len = strlen(options) + 1; 
...
lv_roller_set_selected(roller, ((LV_ROLLER_INF_PAGES / 2) + 1) * real_id_cnt, false); 
}
}
...
half_roller.x1 -= roller->ext_draw_pad; 
