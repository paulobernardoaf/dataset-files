...
lmeter_bg.body.padding.left = LV_DPI / 8; 
lmeter_bg.body.padding.right = LV_DPI / 8; 
...
gauge_bg.body.padding.left = LV_DPI / 16; 
gauge_bg.body.padding.right = LV_DPI / 16; 
gauge_bg.body.padding.top = LV_DPI / 10; 
gauge_bg.body.padding.bottom = LV_DPI / 10; 
gauge_bg.body.padding.inner = LV_DPI / 12; 
...
tab_indic.body.padding.inner = LV_DPI / 10; 
