...
{
#if LV_IMG_CF_ALPHA
const lv_opa_t alpha1_opa_table[2] = {0, 255}; 
const lv_opa_t alpha2_opa_table[4] = {0, 85, 170, 255}; 
const lv_opa_t alpha4_opa_table[16] = {0, 17, 34, 51, 
