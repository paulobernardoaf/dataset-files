...
int randbyte_offset;
int update_offset;
char_u cfb_buffer[BF_MAX_CFB_LEN]; 
int cfb_len; 
} bf_state_T;
...
#define htonl2(x) x = ((((x) & 0xffL) << 24) | (((x) & 0xff00L) << 8) | (((x) & 0xff0000L) >> 8) | (((x) & 0xff000000L) >> 24))
#else
#define htonl2(x)
#endif
static void
...
"salt",
"plaintxt",
"\xad\x3d\xfa\x7f\xe8\xea\x40\xf6", 
"\x72\x50\x3b\x38\x10\x60\x22\xa7", 
0x56701b5du 
},
};
static int
