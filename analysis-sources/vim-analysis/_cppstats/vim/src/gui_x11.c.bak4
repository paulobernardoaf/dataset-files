...
#define DELETE_WINDOW_IDX 0 
#define SAVE_YOURSELF_IDX 1 
...
#define XDrawString(dpy, win, gc, x, y, str, n) do { if (current_fontset != NULL) XmbDrawString(dpy, win, current_fontset, gc, x, y, str, n); else XDrawString(dpy, win, gc, x, y, str, n); } while (0)
...
#define XDrawString16(dpy, win, gc, x, y, str, n) do { if (current_fontset != NULL) XwcDrawString(dpy, win, current_fontset, gc, x, y, (wchar_t *)str, n); else XDrawString16(dpy, win, gc, x, y, (XChar2b *)str, n); } while (0)
...
#define XDrawImageString16(dpy, win, gc, x, y, str, n) do { if (current_fontset != NULL) XwcDrawImageString(dpy, win, current_fontset, gc, x, y, (wchar_t *)str, n); else XDrawImageString16(dpy, win, gc, x, y, (XChar2b *)str, n); } while (0)
...
#if (defined(FONTSET_ALWAYS) && defined(FEAT_GUI_ATHENA) && defined(FEAT_MENU)) || defined(PROTO)
