...
#endif
#define PyString_FromString(repr) PyUnicode_Decode(repr, STRLEN(repr), ENC_OPT, NULL)
...
#if !defined(PyBytes_AsStringAndSize)
...
#if !defined(PyUnicode_FromFormat)
...
#if defined(Py_DEBUG) && !defined(Py_DEBUG_NO_PYMALLOC)
#undef PyObject_NEW
#define PyObject_NEW(type, typeobj) ( (type *) PyObject_Init( (PyObject *) _PyObject_DebugMalloc( _PyObject_SIZE(typeobj) ), (typeobj)) )
#endif
...
#if !defined(Py_UNICODE_USE_UCS_FUNCTIONS)
...
#define GET_ATTR_STRING(name, nameobj) char *name = ""; if (PyUnicode_Check(nameobj)) name = (char *)_PyUnicode_AsString(nameobj)
...
(lenfunc) BufferLength, 
(binaryfunc) 0, 
(ssizeargfunc) 0, 
(ssizeargfunc) BufferItem, 
0, 
0, 
0, 
0, 
...
(binaryfunc) 0, 
(ssizeargfunc) 0, 
(ssizeargfunc) RangeItem, 
0, 
(ssizeobjargproc) RangeAsItem, 
0, 
0, 
0, 
0, 
...
(lenfunc)RangeLength,
(binaryfunc)RangeSubscript,
(objobjargproc)RangeAsSubscript,
};
static PyObject *
...
(lenfunc) TabListLength, 
(binaryfunc) 0, 
(ssizeargfunc) 0, 
(ssizeargfunc) TabListItem, 
0, 
(ssizeobjargproc)0, 
0, 
0, 
...
(lenfunc) WinListLength, 
(binaryfunc) 0, 
(ssizeargfunc) 0, 
(ssizeargfunc) WinListItem, 
0, 
(ssizeobjargproc)0, 
0, 
0, 
