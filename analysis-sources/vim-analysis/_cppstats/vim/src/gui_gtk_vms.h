...
#if !defined(VMS_X11R6)
#define _XtRegisterWindow _XTREGISTERWINDOW
#define _XtUnregisterWindow _XTUNREGISTERWINDOW
#if 0
#define XtRegisterDrawable(display,drawable,widget) { extern void _XtRegisterWindow(Window,Widget); _XtRegisterWindow(drawable,widget); }
#define XtUnregisterDrawable(display,drawable) { extern void _XtUnregisterWindow(Window,Widget); _XtUnregisterWindow(drawable,XtWindowToWidget(display,drawable)); }
#endif
#else
