...
#endif
static HINSTANCE hinstPython = 0; 
...
#endif
#endif
#if defined(PY_VERSION_HEX) && PY_VERSION_HEX >= 0x02050000 && SIZEOF_SIZE_T != VIM_SIZEOF_INT
#if defined(Py_DEBUG)
...
#endif
#if !defined(Py_CLEAR)
#define Py_CLEAR(obj) { Py_XDECREF(obj); obj = NULL; }
#endif
...
(PyInquiry) BufferLength, 
(binaryfunc) 0, 
(PyIntArgFunc) 0, 
(PyIntArgFunc) BufferItem, 
(PyIntIntArgFunc) BufferSlice, 
(PyIntObjArgProc) BufferAssItem, 
(PyIntIntObjArgProc) BufferAssSlice, 
(objobjproc) 0,
(binaryfunc) 0,
0,
};
...
(PyInquiry) RangeLength, 
(binaryfunc) 0, 
(PyIntArgFunc) 0, 
(PyIntArgFunc) RangeItem, 
(PyIntIntArgFunc) RangeSlice, 
(PyIntObjArgProc) RangeAssItem, 
(PyIntIntObjArgProc) RangeAssSlice, 
(objobjproc) 0,
...
(PyInquiry) TabListLength, 
(binaryfunc) 0, 
(PyIntArgFunc) 0, 
(PyIntArgFunc) TabListItem, 
(PyIntIntArgFunc) 0, 
(PyIntObjArgProc) 0, 
...
(PyInquiry) WinListLength, 
(binaryfunc) 0, 
(PyIntArgFunc) 0, 
(PyIntArgFunc) WinListItem, 
(PyIntIntArgFunc) 0, 
(PyIntObjArgProc) 0, 
(PyIntIntObjArgProc) 0, 
(objobjproc) 0,
...
#if PYTHON_API_VERSION < 1007 && !defined(PROTO)
char *
