...
#if defined(DYNAMIC_RUBY) && RUBY_VERSION >= 19 && VIM_SIZEOF_INT < VIM_SIZEOF_LONG
...
#if defined(need_rb_str_new_cstr)
...
static HINSTANCE hinstRuby = NULL; 
