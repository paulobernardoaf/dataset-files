...
#if !defined(DYNAMIC_TCL_DLL)
#define DYNAMIC_TCL_DLL "tcl83.dll"
#endif
#if !defined(DYNAMIC_TCL_VER)
...
NULL, 
NULL, 
#if defined(TCL_CHANNEL_VERSION_2)
NULL, 
NULL, 
#endif


#if defined(TCL_CHANNEL_VERSION_3)
NULL, 
#endif
#if defined(TCL_CHANNEL_VERSION_4)
NULL, 
#endif
#if defined(TCL_CHANNEL_VERSION_5)
NULL 
#endif
};
