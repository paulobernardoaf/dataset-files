...
#define GRAPH_SIGNATURE 0x43475048 
#define GRAPH_CHUNKID_OIDFANOUT 0x4f494446 
#define GRAPH_CHUNKID_OIDLOOKUP 0x4f49444c 
#define GRAPH_CHUNKID_DATA 0x43444154 
#define GRAPH_CHUNKID_EXTRAEDGES 0x45444745 
#define GRAPH_CHUNKID_BASE 0x42415345 
...
#define GRAPH_MIN_SIZE (GRAPH_HEADER_SIZE + 4 * GRAPH_CHUNKLOOKUP_WIDTH + GRAPH_FANOUT_SIZE + the_hash_algo->rawsz)
