...
#define SUBMODULE_ALTERNATE_SETUP_INIT { NULL, SUBMODULE_ALTERNATE_ERROR_IGNORE, NULL }
...
#define SUBMODULE_UPDATE_CLONE_INIT { .list = MODULE_LIST_INIT, .update = SUBMODULE_UPDATE_STRATEGY_INIT, .recommend_shallow = -1, .references = STRING_LIST_INIT_DUP, .single_branch = -1, .max_jobs = 1, }
