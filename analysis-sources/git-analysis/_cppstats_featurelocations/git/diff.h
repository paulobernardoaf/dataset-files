...
#define diff_get_color_opt(o, ix) diff_get_color((o)->use_color, ix)
...
#define combine_diff_path_size(n, l) st_add4(sizeof(struct combine_diff_path), (l), 1, st_mult(sizeof(struct combine_diff_parent), (n)))
...
#define DIFF_PICKAXE_KIND_OBJFIND 16 

#define DIFF_PICKAXE_KINDS_MASK (DIFF_PICKAXE_KIND_S | DIFF_PICKAXE_KIND_G | DIFF_PICKAXE_KIND_OBJFIND)
