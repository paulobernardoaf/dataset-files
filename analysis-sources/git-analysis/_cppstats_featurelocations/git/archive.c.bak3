...
#define OPT__COMPR(s, v, h, p) OPT_SET_INT_F(s, NULL, v, h, p, PARSE_OPT_NONEG)

#define OPT__COMPR_HIDDEN(s, v, p) OPT_SET_INT_F(s, NULL, v, "", p, PARSE_OPT_NONEG | PARSE_OPT_HIDDEN)
