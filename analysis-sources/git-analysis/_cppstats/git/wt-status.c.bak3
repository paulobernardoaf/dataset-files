...
wt_longstatus_print_submodule_summary(s, 0); 
wt_longstatus_print_submodule_summary(s, 1); 
}
if (s->show_untracked_files) {
...
stages[2].mode, 
d->mode_worktree,
oid_to_hex(&stages[0].oid), 
oid_to_hex(&stages[1].oid), 
oid_to_hex(&stages[2].oid), 
path_index,
eol_char);
