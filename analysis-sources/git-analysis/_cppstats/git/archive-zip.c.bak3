...
#define ZIP_EXTRA_MTIME_PAYLOAD_SIZE (ZIP_EXTRA_MTIME_SIZE - offsetof(struct zip_extra_mtime, flags))

#define ZIP64_EXTRA_SIZE offsetof(struct zip64_extra, _end)
#define ZIP64_EXTRA_PAYLOAD_SIZE (ZIP64_EXTRA_SIZE - offsetof(struct zip64_extra, size))

#define ZIP64_DIR_TRAILER_SIZE offsetof(struct zip64_dir_trailer, _end)
#define ZIP64_DIR_TRAILER_RECORD_SIZE (ZIP64_DIR_TRAILER_SIZE - offsetof(struct zip64_dir_trailer, creator_version))


#define ZIP64_DIR_TRAILER_LOCATOR_SIZE offsetof(struct zip64_dir_trailer_locator, _end)
