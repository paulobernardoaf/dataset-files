...
#define REBASE_OPTIONS_INIT { .type = REBASE_UNSPECIFIED, .empty = EMPTY_UNSPECIFIED, .default_backend = "merge", .flags = REBASE_NO_QUIET, .git_am_opts = ARGV_ARRAY_INIT, .git_format_patch_opt = STRBUF_INIT }
