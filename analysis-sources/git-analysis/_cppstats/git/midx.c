...
#define MIDX_CHUNKID_PACKNAMES 0x504e414d 
#define MIDX_CHUNKID_OIDFANOUT 0x4f494446 
#define MIDX_CHUNKID_OIDLOOKUP 0x4f49444c 
#define MIDX_CHUNKID_OBJECTOFFSETS 0x4f4f4646 
#define MIDX_CHUNKID_LARGEOFFSETS 0x4c4f4646 
...
#define midx_display_sparse_progress(progress, n) do { uint64_t _n = (n); if ((_n & (SPARSE_PROGRESS_INTERVAL - 1)) == 0) display_progress(progress, _n); } while (0)
